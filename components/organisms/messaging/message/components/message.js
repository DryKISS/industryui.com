...
export const Message = ({ content, pictureId, prevType, statusText, time, type }) => {
    ...
    <Column sm={11}>
      <StyledCard context={context} type={type}>
        ...
        <Row>
          ...
          <Column sm={pictureId ? 8 : !type ? 11 : 12}>{content}</Column>
...
const StyledCard = styled(Card)`
  ...
  ${props => (props.type === 'in' ? 'border-top-left-radius: 0' : 'border-top-right-radius: 0')};
