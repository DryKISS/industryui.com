...
var renderMessage = function renderMessage(_ref, messages, cache) {
  var index = _ref.index,
      ...
      key = _ref.key,
      style = _ref.style;
  return __jsx$2J(reactVirtualized.CellMeasurer, {
    cache: cache,
    key: index,
    parent: parent,
    columnIndex: 0,
...
var MessageList = /*#__PURE__*/React.memo(function (_ref2) {
  ...
  return __jsx$2J(reactVirtualized.AutoSizer, null, function (_ref3) {
    ...
    return __jsx$2J(reactVirtualized.List, {
      style: {
        padding: '0.5rem 0'
      },
...
var MessagingSend = function MessagingSend(_ref) {
  ...
  return __jsx$2M(React__default['default'].Fragment, null, __jsx$2M(StyledContainer$8, {
    audience: audience
