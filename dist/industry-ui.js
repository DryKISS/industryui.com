...
var StyledTime = styled__default['default'].time.withConfig({
  ...
  var size = _ref2.size,
      theme = _ref2.theme;
  return styled.css(["font-size:", ";line-height:", ";color:", ";"], (_theme$TEXT_STYLE$FON = theme.TEXT_STYLE.FONT_SIZE[size]) !== null && _theme$TEXT_STYLE$FON !== void 0 ? _theme$TEXT_STYLE$FON : '1rem', (_theme$TEXT_STYLE$LIN = theme.TEXT_STYLE.LINE_HEIGHT[size]) !== null && _theme$TEXT_STYLE$LIN !== void 0 ? _theme$TEXT_STYLE$LIN : '1rem', theme.COLOUR.black);
});
Date$1.propTypes = {
...
var StyledText$1 = styled__default['default'].p.withConfig({
  ...
  var size = _ref4.size,
      theme = _ref4.theme;
  return styled.css(["font-size:", ";line-height:", ";"], (_theme$TEXT_STYLE$FON = theme.TEXT_STYLE.FONT_SIZE[size]) !== null && _theme$TEXT_STYLE$FON !== void 0 ? _theme$TEXT_STYLE$FON : '1rem', (_theme$TEXT_STYLE$LIN = theme.TEXT_STYLE.LINE_HEIGHT[size]) !== null && _theme$TEXT_STYLE$LIN !== void 0 ? _theme$TEXT_STYLE$LIN : '1rem');
}, function (_ref5) {
  var size = _ref5.size;
...
var Copyright = /*#__PURE__*/React.memo(function (_ref) {
...
var StyledRow$1 = styled__default['default'](Row).withConfig({
...
var StyledColumn$3 = styled__default['default'](Column).withConfig({
...
var __jsx$1Z = React__default['default'].createElement;
var PaginationItem = /*#__PURE__*/React.memo(function (_ref) {
  var active = _ref.active,
      context = _ref.context,
      disabled = _ref.disabled,
      label = _ref.label,
 ...
 */
var TableCaption = /*#__PURE__*/React.memo(styled__default['default'].caption.withConfig({
...
var TableColumns = /*#__PURE__*/React.memo(function (_ref3) {
  var align = _ref3.align,
 ...
 * Components - Molecules - Table - Data
 */
var TableData = /*#__PURE__*/React.memo(styled__default['default'].td.withConfig({
 ...
 */
var TableHead = /*#__PURE__*/React.memo(styled__default['default'].th.withConfig({
...
var TableLoading = /*#__PURE__*/React.memo(function (_ref) {
...
var TablePagination = /*#__PURE__*/React.memo(function (_ref) {
 ...
 */
var TableRow = /*#__PURE__*/React.memo(styled__default['default'].tr.withConfig({
...
var TableRows = /*#__PURE__*/React.memo(function (_ref) {
  var align = _ref.align,
      columns = _ref.columns,
      hover = _ref.hover,
...
var Table = /*#__PURE__*/React.memo(function (_ref) {
  var align = _ref.align,
      caption = _ref.caption,
      className = _ref.className,
      columns = _ref.columns,
...
var StyledResponsive = styled__default['default'].div.withConfig({
  ...
  return responsive && styled.css(["background-color:#fff;display:block;overflow-x:auto;width:100%;"]);
});
Table.propTypes = {
  align: propTypes.bool,
  caption: propTypes.string,
...
var Bar$1 = function Bar(_ref) {
  ...
  return __jsx$2g(React__default['default'].Fragment, null, __jsx$2g(StyledBarWrapper, {
    background: background,
    flat: flat,
    open: IsOpen,
    placement: placement,
...
var BigCalendar = function BigCalendar() {
  ...
  return __jsx$2h("div", null, __jsx$2h(reactBigCalendar.Calendar, {
    localizer: localizer,
...
var ColorPicker = function ColorPicker(_ref) {
  ...
  switch (type) {
    case 'circle':
      return __jsx$2k(reactColor.CirclePicker, _extends({
        onChangeComplete: onChangeComplete
      }, props));

    case 'sketch':
      return __jsx$2k(reactColor.SketchPicker, _extends({
        onChangeComplete: onChangeComplete
      }, props));

    case 'github':
      return __jsx$2k(reactColor.GithubPicker, _extends({
        onChangeComplete: onChangeComplete
      }, props));

    case 'twitter':
      return __jsx$2k(reactColor.TwitterPicker, _extends({
        onChangeComplete: onChangeComplete
      }, props));
 ...
 */
var EmailChangeSchema = yup$1.object().shape({
  email: yup$1.string().email().required()
});
...
var DraftJs = function DraftJs(_ref) {
  ...
  return __jsx$2m(React__default['default'].Fragment, null, __jsx$2m("input", {
    type: "button",
    value: "B",
    "data-style": "BOLD",
    ...
    onMouseDown: toggleInlineStyle
  }), __jsx$2m(reactHookForm.Controller, {
    name: name,
    control: control,
    render: function render(props) {
      return __jsx$2m(draftJs.Editor, {
        editorState: editorState,
...
var Login = function Login(_ref) {
  ...
  return __jsx$2q(React__default['default'].Fragment, null, __jsx$2q(PageHeading, {
    center: true,
    heading: heading,
    divider: false
    ...
    to: pathForgot
  }, "Forgot password?")))), pathSignUp && __jsx$2q(React__default['default'].Fragment, null, __jsx$2q("p", {
    className: "text-center"
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              setEditorState(draftJs.EditorState.createWithContent(draftJs.ContentState.createFromText(response)));
              setShowingTranslation(true);
              _context.next = 12;
              break;

            case 10:
              setEditorState(draftJs.EditorState.createWithContent(content.blocks ? draftJs.convertFromRaw(content) : draftJs.ContentState.createFromText(content)));
...
var TranslatorWrapper = styled__default['default'].div.withConfig({
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return axios__default['default'].post('https://microsoft-translator-text.p.rapidapi.com/translate', [{
              Text: text
            }], {
              params: {
                to: to,
...
var renderMessage = function renderMessage(_ref, messages, cache) {
  var index = _ref.index,
      ...
      key = _ref.key,
      style = _ref.style;
  return __jsx$2K(reactVirtualized.CellMeasurer, {
    cache: cache,
    key: index,
    parent: parent,
    columnIndex: 0,
...
var MessageList = /*#__PURE__*/React.memo(function (_ref2) {
  ...
  return __jsx$2K(reactVirtualized.AutoSizer, null, function (_ref3) {
    ...
    return __jsx$2K(reactVirtualized.List, {
      style: {
        padding: '0.5rem 0'
      },
...
var MessagingSend = function MessagingSend(_ref) {
  ...
  return __jsx$2N(React__default['default'].Fragment, null, __jsx$2N(StyledContainer$8, {
    audience: audience
...
var VoiceRecorder = function VoiceRecorder(props) {
  ...
  var showRecorder = function showRecorder(props) {
    ...
    return __jsx$2P(React__default['default'].Fragment, null, __jsx$2P(OverLay, {
      isRecording: isRecording
    }, __jsx$2P(Text, {
      content: "Recording... ",
      context: "blackText"
 ...
 */
var PasswordChangeSchema = yup$1.object().shape({
  passwordOld: yup$1.string().required('Please Enter a password').min(8, 'Password is too short - should be 8 chars minimum.').matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*])(?=.{8,})/, 'Must Contain 8 Characters, One Uppercase, One Lowercase, One Number and one special case Character'),
  password: yup$1.string().required('Please Enter a password').min(8, 'Password is too short - should be 8 chars minimum.').matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*])(?=.{8,})/, 'Must Contain 8 Characters, One Uppercase, One Lowercase, One Number and one special case Character'),
  passwordConfirm: yup$1.string().required().oneOf([yup$1.ref('password'), null], 'Passwords must match')
});
...
var Pricing = function Pricing(_ref) {
  ...
  }), __jsx$2X(PricesWrapper, null, __jsx$2X(React__default['default'].Fragment, null, Layout.includes(LAYOUTS.DESKTOP) ? pricingInfo.map(function (item, index) {
...
var Register = function Register(_ref) {
  ...
  var renderBirthday = function renderBirthday() {
    return __jsx$2$(React__default['default'].Fragment, null, __jsx$2$(DatePickerInput, {
      day: dayBirthday,
      id: "Birthday",
      label: "Birthdate",
      month: monthBirthday,
...
var Bootstrap = function Bootstrap(_ref) {
  ...
  return __jsx$31(React__default['default'].Fragment, null, __jsx$31(Navigation, null), children, footer && __jsx$31(Footer, {
    columns: footer,
    fixed: fixed
...
var Dashboard = function Dashboard(_ref) {
  ...
  return __jsx$32(React__default['default'].Fragment, null, __jsx$32(React.Suspense, {
  ...
  }, View || children, message && __jsx$32(React__default['default'].Fragment, null, __jsx$32(Space, null), __jsx$32(Alert, {
    content: message,
    context: context
  })))));
};
...
var FacebookPagePlugin = function FacebookPagePlugin(_ref) {
  var appId = _ref.appId,
      ...
      to = _ref.to,
      width = _ref.width;
  return __jsx$35(React__default['default'].Fragment, null, iFrame && __jsx$35("iframe", {
...
var FacebookShareButton = function FacebookShareButton(_ref) {
  var appId = _ref.appId,
      ...
      size = _ref.size,
      to = _ref.to;
  return __jsx$36(React__default['default'].Fragment, null, iFrame && __jsx$36("iframe", {
    allow: "encrypted-media",
    frameBorder: "0",
    height: "29",
    scrolling: "no",
...
var BlogCard = function BlogCard(_ref) {
  ...
  }, excerpt)), type === 'normal' && __jsx$3a(React__default['default'].Fragment, null, article.tags && __jsx$3a(TagsContainer, null, __jsx$3a(BlogTags, {
    tags: article.tags
  })), __jsx$3a(Divider, {
    size: "sm"
...
var BlogCategories = function BlogCategories(_ref) {
  ...
  return __jsx$3b("section", null, _find().map(function (articles, index) {
    return __jsx$3b(React.Fragment, {
      key: index
    }, __jsx$3b(Link, {
      to: {
...
var BlogList = function BlogList(_ref) {
  ...
  return __jsx$3h(StyledDl, null, list.map(function (_ref2, index) {
    var badge = _ref2.badge,
        ...
        name = _ref2.name,
        to = _ref2.to;
    return __jsx$3h(React.Fragment, {
      key: index
...
var BlogSection = function BlogSection(_ref) {
  var children = _ref.children,
      heading = _ref.heading;
  return __jsx$3i(StyledSection, null, heading && __jsx$3i(React__default['default'].Fragment, null, __jsx$3i(StyledHeading$7, {
    content: heading,
    context: "primary",
    noMargin: true,
    tag: "h3"
...
var BlogSocial = function BlogSocial(_ref) {
  ...
  return __jsx$3q(React__default['default'].Fragment, null, facebook && __jsx$3q(BlogSection, {
    heading: "Facebook"
...
var __jsx$3s = React__default['default'].createElement;
...
var __jsx$3t = React__default['default'].createElement;
...
var MyApp = /*#__PURE__*/function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function elements() {
      ...
      return __jsx$3t(React__default['default'].Fragment, null, __jsx$3t(ThemeStyle, null), user && __jsx$3t(UserProvider, null, __jsx$3t(AuthorizationProvider, null, __jsx$3t(InternationalisationProvider, null, __jsx$3t(NotificationsProvider, null, offCanvas ? __jsx$3t(OffCanvasProvider, null, this.layout()) : this.layout())))), !user && this.layout());
    }
  }, {
    key: "data",
    value: function data() {
      ...
      return __jsx$3t(React__default['default'].Fragment, null, __jsx$3t(ConfigProvider, {
        config: config
      }, apolloClient ? __jsx$3t(client.ApolloProvider, {
        client: apolloClient
    ...
    key: "render",
    value: function render() {
      return __jsx$3t(styled.ThemeProvider, {
