...
var IUIMessagingAudioPlayer = dynamic__default['default'](function () {
...
var MessagingAudioPlayer = function MessagingAudioPlayer(_ref) {
  ...
  return __jsx$2p(AudioPlayer__default['default'], {
    src: src,
    customProgressBarSection: inMessage ? [AudioPlayer.RHAP_UI.MAIN_CONTROLS, AudioPlayer.RHAP_UI.PROGRESS_BAR, AudioPlayer.RHAP_UI.VOLUME, __jsx$2p(Spacer, {
      key: "rh1",
      style: {
        margin: '0 5px',
        width: '5px'
      }
    }), AudioPlayer.RHAP_UI.CURRENT_TIME, __jsx$2p(Slash, {
      key: "rh2"
...
var renderMessage = function renderMessage(_ref, messages, cache) {
  var index = _ref.index,
      ...
      key = _ref.key,
      style = _ref.style;
  return __jsx$2H(reactVirtualized.CellMeasurer, {
    cache: cache,
    key: index,
    parent: parent,
    columnIndex: 0,
...
var MessageList = /*#__PURE__*/React.memo(function (_ref2) {
  ...
  return __jsx$2H(reactVirtualized.AutoSizer, null, function (_ref3) {
    ...
    return __jsx$2H(reactVirtualized.List, {
      style: {
        padding: '0.5rem 0'
      },
...
var MessagingSend = function MessagingSend(_ref) {
  ...
  return __jsx$2K(React__default['default'].Fragment, null, __jsx$2K(StyledContainer$8, {
    audience: audience
...
var IUIVoiceRecorder = dynamic__default['default'](function () {
...
var VoiceRecorder = function VoiceRecorder(props) {
  ...
  return __jsx$2M(React__default['default'].Fragment, null, __jsx$2M(OverLay, {
    isRecording: isRecording
  }, __jsx$2M(Text, {
    content: "Recording... ",
    context: "blackText"
...
var Pricing = function Pricing(_ref) {
  ...
  }), __jsx$2U(PricesWrapper, null, __jsx$2U(React__default['default'].Fragment, null, Layout.includes(LAYOUTS.DESKTOP) ? pricingInfo.map(function (item, index) {
...
var Bootstrap = function Bootstrap(_ref) {
  ...
  return __jsx$2_(React__default['default'].Fragment, null, __jsx$2_(Navigation, null), children, footer && __jsx$2_(Footer, {
    columns: footer,
    fixed: fixed
...
var Dashboard = function Dashboard(_ref) {
  ...
  return __jsx$2$(React__default['default'].Fragment, null, __jsx$2$(React.Suspense, {
    fallback: __jsx$2$(PageLoading, {
      indicator: __jsx$2$(LdsSpinner, null)
    })
  }, __jsx$2$(React__default['default'].Fragment, null, __jsx$2$(Page, {
...
var FacebookPagePlugin = function FacebookPagePlugin(_ref) {
  var appId = _ref.appId,
      ...
      to = _ref.to,
      width = _ref.width;
  return __jsx$32(React__default['default'].Fragment, null, iFrame && __jsx$32("iframe", {
...
var BlogCard = function BlogCard(_ref) {
  ...
  }, excerpt)), type === 'normal' && __jsx$37(React__default['default'].Fragment, null, article.tags && __jsx$37(TagsContainer, null, __jsx$37(BlogTags, {
    tags: article.tags
  })), __jsx$37(Divider, {
    size: "sm"
...
var BlogCategories = function BlogCategories(_ref) {
  ...
  return __jsx$38("section", null, _find().map(function (articles, index) {
    return __jsx$38(React.Fragment, {
      key: index
    }, __jsx$38(Link, {
      to: {
...
var BlogList = function BlogList(_ref) {
  ...
  return __jsx$3e(StyledDl, null, list.map(function (_ref2, index) {
    var badge = _ref2.badge,
        ...
        name = _ref2.name,
        to = _ref2.to;
    return __jsx$3e(React.Fragment, {
      key: index
...
var BlogSection = function BlogSection(_ref) {
  var children = _ref.children,
      heading = _ref.heading;
  return __jsx$3f(StyledSection, null, heading && __jsx$3f(React__default['default'].Fragment, null, __jsx$3f(StyledHeading$7, {
    content: heading,
    context: "primary",
    noMargin: true,
    tag: "h3"
...
var BlogSocial = function BlogSocial(_ref) {
  ...
  return __jsx$3n(React__default['default'].Fragment, null, facebook && __jsx$3n(BlogSection, {
    heading: "Facebook"
...
var MyApp = /*#__PURE__*/function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function elements() {
      ...
      return __jsx$3q(React__default['default'].Fragment, null, __jsx$3q(ThemeStyle, null), user && __jsx$3q(UserProvider, null, __jsx$3q(AuthorizationProvider, null, __jsx$3q(InternationalisationProvider, null, __jsx$3q(NotificationsProvider, null, offCanvas ? __jsx$3q(OffCanvasProvider, null, this.layout()) : this.layout())))), !user && this.layout());
    }
  }, {
    key: "data",
    value: function data() {
      ...
      return __jsx$3q(React__default['default'].Fragment, null, __jsx$3q(ConfigProvider, {
        config: config
      }, apolloClient ? __jsx$3q(client.ApolloProvider, {
        client: apolloClient
    ...
    key: "render",
    value: function render() {
      return __jsx$3q(styled.ThemeProvider, {
