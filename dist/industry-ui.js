...
var IUIAudioPlayer = dynamic__default['default'](function () {
...
var VoiceRecorder = dynamic__default['default'](function () {
...
var PasswordChange = function PasswordChange(_ref) {
  ...
  return __jsx$2S(React__default['default'].Fragment, null, __jsx$2S(PageHeading, {
    center: true,
...
var Pricing = function Pricing(_ref) {
  ...
  }), __jsx$2T(PricesWrapper, null, __jsx$2T(React__default['default'].Fragment, null, Layout.includes(LAYOUTS.DESKTOP) ? pricingInfo.map(function (item, index) {
...
var Wrapper$8 = styled__default['default'](ClickAwayListener).withConfig({
...
var Dashboard = function Dashboard(_ref) {
  ...
  return __jsx$2_(React__default['default'].Fragment, null, __jsx$2_(React.Suspense, {
    fallback: __jsx$2_(PageLoading, {
      indicator: __jsx$2_(LdsSpinner, null)
    })
  }, __jsx$2_(React__default['default'].Fragment, null, __jsx$2_(Page, {
...
var FacebookPagePlugin = function FacebookPagePlugin(_ref) {
  var appId = _ref.appId,
      ...
      to = _ref.to,
      width = _ref.width;
  return __jsx$31(React__default['default'].Fragment, null, iFrame && __jsx$31("iframe", {
...
var BlogCard = function BlogCard(_ref) {
  ...
  }, excerpt)), type === 'normal' && __jsx$36(React__default['default'].Fragment, null, article.tags && __jsx$36(TagsContainer, null, __jsx$36(BlogTags, {
    tags: article.tags
  })), __jsx$36(Divider, {
    size: "sm"
...
var BlogCategories = function BlogCategories(_ref) {
  ...
  return __jsx$37("section", null, _find().map(function (articles, index) {
    return __jsx$37(React.Fragment, {
      key: index
    }, __jsx$37(Link, {
      to: {
...
var BlogList = function BlogList(_ref) {
  ...
  return __jsx$3d(StyledDl, null, list.map(function (_ref2, index) {
    var badge = _ref2.badge,
        ...
        name = _ref2.name,
        to = _ref2.to;
    return __jsx$3d(React.Fragment, {
      key: index
...
var BlogSection = function BlogSection(_ref) {
  var children = _ref.children,
      heading = _ref.heading;
  return __jsx$3e(StyledSection, null, heading && __jsx$3e(React__default['default'].Fragment, null, __jsx$3e(StyledHeading$7, {
    content: heading,
    context: "primary",
    noMargin: true,
    tag: "h3"
...
var BlogSocial = function BlogSocial(_ref) {
  ...
  return __jsx$3m(React__default['default'].Fragment, null, facebook && __jsx$3m(BlogSection, {
    heading: "Facebook"
...
var MyApp = /*#__PURE__*/function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function elements() {
      ...
      return __jsx$3p(React__default['default'].Fragment, null, __jsx$3p(ThemeStyle, null), user && __jsx$3p(UserProvider, null, __jsx$3p(AuthorizationProvider, null, __jsx$3p(InternationalisationProvider, null, __jsx$3p(NotificationsProvider, null, offCanvas ? __jsx$3p(OffCanvasProvider, null, this.layout()) : this.layout())))), !user && this.layout());
    }
  }, {
    key: "data",
    value: function data() {
      ...
      return __jsx$3p(React__default['default'].Fragment, null, __jsx$3p(ConfigProvider, {
        config: config
      }, apolloClient ? __jsx$3p(client.ApolloProvider, {
        client: apolloClient
    ...
    key: "render",
    value: function render() {
      return __jsx$3p(styled.ThemeProvider, {
...
var VoiceRecorder$1 = function VoiceRecorder(props) {
  ...
  return __jsx$3r(React__default['default'].Fragment, null, __jsx$3r(OverLay, {
    isRecording: isRecording
  }, __jsx$3r(Text, {
    content: "Recording... ",
    context: "blackText"
...
exports.IUIAudioPlayer = IUIAudioPlayer;
...
exports.MessageAudioPlayer = MessageAudioPlayer;
