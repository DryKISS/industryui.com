...
var IUIVoiceRecorder = function IUIVoiceRecorder(props) {
  ...
  React.useEffect(function () {
    mpegEncoder = dynamic__default['default'](function () {
    ...
    AudioRecorder = dynamic__default['default'](function () {
      return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('audio-recorder-polyfill')); }).then(function (mod) {
...
var Wrapper$a = styled__default['default'](ClickAwayListener).withConfig({
