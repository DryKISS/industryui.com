import React, { useContext, useState, useEffect, useRef, createElement, memo, forwardRef, Children, cloneElement, Component, Fragment as Fragment$1, createContext, Suspense as Suspense$1 } from 'react';
...
var MESSAGING = {
  HEADER_BACKGROUND_COLOUR: 'drykiss_lightBlue'
};
...
var StyledButton = styled.button.withConfig({
  ...
  return noPadding ? '0' : theme.SPACING(3, 6);
}, function (_ref7) {
...
var Text = function Text(_ref) {
  ...
  return __jsx$s(StyledText$1, _extends({
    align: align,
    className: className,
    colour: colour,
    context: context,
...
var Switch = function Switch(_ref) {
  ...
  return __jsx$t(StyledSwitchContainer, {
    context: context,
    disabled: disabled,
    onClick: handleToggle,
    size: size,
    toggled: toggled
  }, __jsx$t(StyledSwitch, {
    size: size,
    toggled: toggled
  }));
};
...
var Toggle = function Toggle(_ref) {
  ...
  return __jsx$u(StyledToggle, null, __jsx$u(Switch, {
    context: context,
    disabled: disabled,
...
var Tooltip = function Tooltip(_ref) {
  ...
  return __jsx$v(StyledTippy, _extends({
    content: content
  }, props), children);
};
...
var CheckboxComponent = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return __jsx$w(StyledCheckbox, _extends({
    disabled: disabled,
    ref: ref,
    type: "checkbox"
  }, props));
...
var CheckboxField = function CheckboxField(_ref) {
  ...
  return __jsx$x(StyledFieldset, {
    error: errors[props.name]
  }, legend && __jsx$x("legend", null, legend), data.map(function (_ref2) {
    var disabled = _ref2.disabled,
        label = _ref2.label,
        data = _objectWithoutProperties(_ref2, ["disabled", "label"]);

    return __jsx$x(StyledLabel, {
      htmlFor: data.id,
      key: data.id,
      stacked: stacked
    }, __jsx$x(FieldHOC, _extends({
...
var DatePickerCalendar = function DatePickerCalendar(_ref) {
  ...
  return __jsx$y(Controller$1, {
    render: function render(props) {
      return __jsx$y(ReactDatePicker, _extends({
        customInput: __jsx$y(StyledInput, {
          errors: errors[name]
        }),
...
var DatePickerInput = function DatePickerInput(_ref) {
  ...
  return __jsx$z(React.Fragment, null, __jsx$z(Space, {
    marginBottom: "0.5rem"
  }, label), __jsx$z(Row, null, showDay && __jsx$z(Column, {
    md: 4
  }, __jsx$z(SelectField, _extends({}, defaultOptions, {
    data: {
      'data-index': index,
      'data-name': 'day'
    },
...
var Accept = function Accept(_ref) {
  ...
  return __jsx$A("em", null, "(Only ", files, " will be accepted)");
};
Accept.propTypes = {
...
var DropzonePreview = function DropzonePreview(_ref) {
  var file = _ref.file,
      ...
      index = _ref.index;
  return __jsx$B(StyledPreview, null, __jsx$B(Close, {
    click: handleRemove
  }), __jsx$B(Image$1, {
...
var Dropzone = function Dropzone(_ref) {
  ...
  var thumbs = function thumbs() {
    return __jsx$C(StyledContainer, {
      fluid: true
    }, __jsx$C(Row, null, files.map(function (file) {
      return __jsx$C(Column, {
        md: 3,
        key: file.name
      }, __jsx$C(DropzonePreview, {
        file: file,
  ...
  return __jsx$C(React.Fragment, null, __jsx$C(StyledContainer, _extends({
    dragActive: isDragActive,
    dragAccept: isDragAccept,
    dragReject: isDragReject,
    disabled: disabled
  }, getRootProps()), __jsx$C("input", getInputProps()), isDragAccept && __jsx$C(Text, null, "Accepted"), isDragReject && __jsx$C(Text, null, "Rejected"), isDragActive ? __jsx$C(Text, null, "Drop here") : __jsx$C(React.Fragment, null, __jsx$C(Text, null, "Drop, or click to select"), accept && __jsx$C(Accept, {
    accept: accept
  }), multiple ? __jsx$C(Text, null, "Accepts multiple files") : __jsx$C(Text, null, "Single file only"))), files.length > 0 && thumbs());
};
...
var DropzoneField = function DropzoneField(_ref) {
  ...
  return __jsx$E(Controller$1, _extends({
    as: Dropzone,
    control: control,
    name: name
  }, props));
...
var CurrencyInput = function CurrencyInput(_ref) {
  var currencySymbol = _ref.currencySymbol,
      ...
      theme = _ref.theme,
      vat = _ref.vat;
  return __jsx$G(FormLabel, {
    show: show,
    label: label
  }, __jsx$G(InputGroup, {
    theme: theme,
    error: errors[name]
  }, __jsx$G(InputGroupAddon, {
    addonType: "prepend",
    error: errors[name],
    text: true,
    theme: theme,
    size: size
  }, currencySymbol), __jsx$G(FormField, {
    errors: errors,
    min: min,
    name: name,
    register: register,
...
var FormField = function FormField(_ref) {
  ...
  return __jsx$H(FieldHOC, _extends({
    "aria-label": name,
...
var PercentInput = function PercentInput(_ref) {
  var errors = _ref.errors,
      ...
      show = _ref.show,
      symbol = _ref.symbol;
  return __jsx$I(FormLabel, {
    show: show,
    label: label
  }, __jsx$I(InputGroup, null, __jsx$I(FormField, {
    errors: errors,
    name: name,
    register: register,
    step: "any",
    type: "number"
  }), __jsx$I(InputGroupAddon, {
    addonType: "append",
    text: true
  }, symbol)));
};
...
var FieldHOC = function FieldHOC(_ref) {
  ...
  return __jsx$K(React.Fragment, null, __jsx$K(Component, _extends({
  ...
  }, props), children), helperMessage && __jsx$K(Space, {
    marginTop: SIZE.SM,
    marginBottom: SIZE.XS
  }, __jsx$K(Text, {
    size: SIZE.XS,
    context: "default"
  }, helperMessage)), showError && __jsx$K(FormError, {
...
var Input = function Input(_ref) {
  ...
  return __jsx$L(Wrapper, {
    theme: props.theme,
    decoration: decoration,
    readOnly: props.readOnly
  }, label && __jsx$L(React.Fragment, null, __jsx$L(Space, {
    marginBottom: "xs"
  }, __jsx$L(StyledLabel$1, {
    theme: props.theme,
    content: label
  }))), __jsx$L(Space, {
    marginBottom: "xs"
  }, __jsx$L(InputWrapper, {
    size: size
  }, (adornments === null || adornments === void 0 ? void 0 : adornments.startAdornment) && __jsx$L(Adornment, {
    startAdornment: true,
    size: size
  }, adornments.startAdornment), __jsx$L(StyledInput$1, _extends({
  ...
  }, props)), (adornments === null || adornments === void 0 ? void 0 : adornments.endAdornment) && __jsx$L(Adornment, {
    size: size
  }, adornments.endAdornment))), message && __jsx$L(StyledMessage, null, message));
};
...
var InputGroupAddon = function InputGroupAddon(_ref) {
  var addonType = _ref.addonType,
      ...
      text = _ref.text,
      theme = _ref.theme;
  return __jsx$M(StyledInputGroupAddon, {
    addonType: addonType,
    className: addonType,
    children: children,
    context: context,
...
var InputGroup = function InputGroup(_ref) {
  var children = _ref.children,
      ...
      size = _ref.size,
      theme = _ref.theme;
  return __jsx$N(StyledInputGroup, {
    children: children,
    error: error,
    size: size,
    theme: theme
...
var StyleButton = function StyleButton(_ref) {
  ...
  return __jsx$O(StyledRichButton, {
    active: active,
...
var IUIRich = function IUIRich() {
  ...
  return __jsx$P("div", {
    onClick: focus
  }, __jsx$P(BlockStyleControls, {
    editorState: editorState,
    onToggle: toggleBlockType
  }), __jsx$P(InlineStyleControls, {
    editorState: editorState,
...
var RadioComponent = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return __jsx$R(StyledInput$2, _extends({
    disabled: disabled,
    type: "radio",
    ref: ref
  }, props));
...
var RadioField = function RadioField(_ref) {
  ...
  return __jsx$S(StyledFieldset$1, {
    error: errors[props.name]
  }, legend && __jsx$S(StyledLegend, {
    error: errors[props.name]
    ...
    return __jsx$S(StyledLabel$3, {
      htmlFor: data.id,
      key: data.id,
      stacked: stacked
    }, __jsx$S(FieldHOC, _extends({
...
var ReactSelectField = function ReactSelectField(_ref) {
  ...
  var Component = /*#__PURE__*/forwardRef(function (data, ref) {
    if (async) {
      return __jsx$T(AsyncSelect, _extends({
      ...
      return __jsx$T(Select, _extends({
        ref: ref
      }, data));
    }
  });
  return __jsx$T(Wrapper$1, {
    size: size,
    error: error || errors[name]
  }, __jsx$T(Controller$1, {
    render: function render(props) {
      return __jsx$T(Component, _extends({
        options: options,
...
var Breadcrumb = function Breadcrumb(_ref) {
  ...
  return __jsx$11("nav", {
    ...
    return __jsx$11(StyledLi, {
      itemProp: "itemListElement",
      itemScope: "",
      itemType: "http://schema.org/ListItem",
      key: index
    }, index + 1 !== breadcrumbs.length ? __jsx$11(Link, {
      to: item.to,
      passHref: true
    }, __jsx$11(StyledA, {
      itemProp: "item",
    ...
    }, item.icon && __jsx$11(StyledIconWrapper, {
      size: size
    }, item.icon), __jsx$11(StyledTitle, {
      size: size
    }, " ", item.title))) : __jsx$11(StyledLastTitle, {
      size: size,
      itemProp: "name"
    }, item.icon && __jsx$11(StyledIconWrapper, {
      size: size
      ...
      last: true,
      size: size
    }, item.title)), __jsx$11("meta", {
      itemProp: "position",
      content: index + 1 + ''
    }), index + 1 !== breadcrumbs.length && __jsx$11(StyledSeperator, {
      size: size
    }, customSeparator !== null && customSeparator !== void 0 ? customSeparator : separator && separator === 'chevron' ? __jsx$11(StyledIcon$3, {
      icon: "chevron-right",
      prefix: "fas"
    }) : separator && separator === 'slash' ? __jsx$11(StyledIcon$3, {
      icon: "slash",
      prefix: "fas"
    }) : separator || '\\'));
  })));
...
var Buttons = function Buttons(_ref) {
  ...
  return __jsx$12(React.Fragment, null, __jsx$12(Divider, {
    size: "sm"
  }), back && __jsx$12(Link, {
    to: pathBack
  }, __jsx$12(Button, {
...
var CardBody = function CardBody(_ref) {
  ...
  return __jsx$14(StyledBody$1, {
    className: className,
    center: center
  }, title && __jsx$14(StyledWrapper, null, __jsx$14(StyledTitle$1, {
    content: title,
    noWrap: titleNoWrap,
    tag: "h2"
...
var Carousel = function Carousel(_ref) {
  ...
  var navComponents = function navComponents() {
    ...
    if (leftNavComponent) {
      components.left = __jsx$1h(NavWrapper, {
    ...
    if (rightNavComponent) {
      components.right = __jsx$1h(NavWrapper, {
        componentPosition: navPosition,
        endNav: true,
  ...
  return __jsx$1h(React.Fragment, null, __jsx$1h(Wrapper$2, {
    width: width,
    height: height,
    fullWidth: fullWidth
  }, typeof numberOfItems !== 'number' && __jsx$1h(ResizeDetector, {
    onResize: function onResize(_ref2) {
      var width = _ref2.width;
      return resetNumberOfItems(width);
    }
  }), hasNavigation && showNavs && navComponents().left, dataSource.map(function (item, index) {
    return __jsx$1h(ItemWrapper, {
      gap: gap,
      ...
      key: 'slide' + index
    }, slides ? __jsx$1h(CarouselSampleSlide, item) : dataSource[index]);
...
var Copyright = function Copyright(_ref) {
  ...
  }, __jsx$1i(StyledBrand, null, __jsx$1i(StyledIcon$5, icon), year, " \u2014 ", brand)), links.length > 0 && __jsx$1i(Column, {
    md: 9
  }, renderLinks()))));
};
...
var GetAddress = function GetAddress(_ref) {
  ...
  return __jsx$1s(FormLabel, {
    label: label
  }, __jsx$1s(InputWrapper$1, null, __jsx$1s(FormField, {
    ...
    context: "primary",
    size: "sm"
  }))), (errors[name] || Errors[name]) && __jsx$1s(FormError, {
    message: errors[name] ? errors[name].message : Errors[name].message
  }), IsLoading && __jsx$1s(LoadingWrapper, {
    size: size
  }, __jsx$1s(Shimmer, {
    duration: 500
  })), __jsx$1s(Dropdown, {
...
var ImageMarker = function ImageMarker(_ref) {
  ...
  var coordinates = _ref.coordinates,
      styles = _ref.styles;
  return styles !== null && styles !== void 0 && styles.shape ? __jsx$1x(StyledIcon$6, {
...
var Calendar = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return __jsx$2h(Wrapper$3, null, props.hasLoading && loading && __jsx$2h(PageLoading, {
...
var IUIPlayer;
var IUIMessagingAudioPlayer = function IUIMessagingAudioPlayer(props) {
  var _useState = useState(false),
  ...
  useEffect(function () {
    IUIPlayer = dynamic({
      modules: function modules() {
        return {
          player: Promise.resolve().then(function () { return messagingAudioPlayer; }).then(function (mod) {
            return mod.MessagingAudioPlayer;
          })
        };
      },
      render: function render(props, _ref) {
        var Player = _ref.player;
        return __jsx$2p(Player, props);
      },
      ssr: false,
      loadableGenerated: {
        webpack: function webpack() {
          return [require.resolveWeak("./messagingAudioPlayer")];
        },
        modules: ["./messagingAudioPlayer"]
      }
    });
    setPlayerLoaded(true);
  }, []);

  var showPlayer = function showPlayer(props) {
    if (!playerLoaded) return __jsx$2p("div", null, "Loading ...");
    return __jsx$2p(IUIPlayer, props);
  };

  return __jsx$2p("div", null, showPlayer(props));
};
...
var messagingAudioPlayer = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
})(["cursor:pointer;padding:0.25rem 0;text-align:center;width:100%;"]);
...
var MessageBase = function MessageBase(_ref) {
  ...
  }, __jsx$2x(StyledReply, null, reply), __jsx$2x(StyledContent$4, null, voice && __jsx$2x(AudioWrapper, null, __jsx$2x(IUIMessagingAudioPlayer, {
    src: voice,
    inMessage: true
...
var StyledCard$2 = styled(Card).withConfig({
  ...
  var type = _ref2.type,
      theme = _ref2.theme;
  return type === 'in' ? theme.COLOUR.neutral : theme.COLOUR.neutral2;
}, function (_ref3) {
  var theme = _ref3.theme;
  return theme.COLOUR.grey80;
}, function (_ref4) {
  var type = _ref4.type;
...
})(["color:", ";font-size:0.75rem;"], function (_ref5) {
  var theme = _ref5.theme;
  return theme.COLOUR.primary;
});
...
var Head = styled.div.withConfig({
  ...
  var theme = _ref10.theme;
  return theme.COLOUR[theme.MESSAGING.HEADER_BACKGROUND_COLOUR];
});
...
})(["[class*='mentionSuggestions']{top:", " !important;}", " width:calc(100% - 8rem);max-height:6rem;overflow-y:auto;"], function (_ref3) {
...
var MessageList = /*#__PURE__*/memo(function (_ref2) {
  ...
  var listRef = useRef(null); // const cacheRef = useRef(null)
...
var MessagingSend = function MessagingSend(_ref) {
  ...
  return __jsx$2L(React.Fragment, null, __jsx$2L(StyledContainer$8, {
    ...
    preview: true
  }, __jsx$2L(IUIMessagingAudioPlayer, {
    ...
    type: "file"
  }), __jsx$2L(StyledElements, null, isSendDisabled() ? __jsx$2L(IUIVoiceRecorder, null) : __jsx$2L(Button, {
    context: "transparent",
...
})(["background-color:rgb(242,242,242);border-bottom:1px solid #c0c0c0;border-top:1px solid #c0c0c0;box-sizing:border-box;color:#c0c0c0;padding:", ";position:relative;.public-DraftStyleDefault-block{margin:0.5em 0;}"], function (_ref4) {
...
})(["position:absolute;left:8px;text-transform:uppercase;top:-24px;.dropdown--link{color:#000;font-size:10px;}.dropdown--toggle,svg{color:", ";font-size:10px;}"], function (_ref5) {
  var theme = _ref5.theme;
  return theme.COLOUR.info;
});
...
})(["cursor:pointer;margin-right:1rem;color:", ";&:hover{color:", ";}"], function (_ref6) {
  var theme = _ref6.theme;
  return theme.COLOUR.blackGrey;
}, function (_ref7) {
  var theme = _ref7.theme;
...
var __jsx$2M = React.createElement;
var VRecorder;
var IUIVoiceRecorder = function IUIVoiceRecorder(props) {
  var _useState = useState(false),
  ...
  useEffect(function () {
    VRecorder = dynamic({
      modules: function modules() {
        return {
          recorder: Promise.resolve().then(function () { return voiceRecorder; }).then(function (mod) {
      ...
      render: function render(props, _ref) {
        ...
        return __jsx$2M(Recorder, props);
      },
      ssr: false,
      loadableGenerated: {
        webpack: function webpack() {
  ...
  var showRecorder = function showRecorder(props) {
    if (!recorderLoaded) return __jsx$2M("div", null, "Loading ...");
    return __jsx$2M(VRecorder, props);
  };

  return __jsx$2M("div", null, showRecorder(props));
};
...
})(["background-color:rgba(220,223,232,0.4);height:", ";overflow:hidden;position:relative;.ReactVirtualized__Grid{outline:none;}.public-DraftStyleDefault-block{margin:0.25em 0;}"], function (_ref2) {
  var messagesContainerHeight = _ref2.messagesContainerHeight;
...
})(["color:rgb(30,167,253);cursor:pointer;"]);
...
var LinkPluginComponent = function LinkPluginComponent(props) {
  return __jsx$2U("a", _extends({}, props, {
    onClick: function onClick() {}
  }));
};
...
var BlogFindFood = function BlogFindFood(_ref) {
  ...
  return __jsx$3k(BlogSection, null, __jsx$3k(StyledContainer$a, {
    ...
    passHref: true,
    target: "_blank"
  }, __jsx$3k(StyledA$2, null, "Deliveroo ", __jsx$3k(Icon, {
    icon: "external-link"
  })))));
};
