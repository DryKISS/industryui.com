import React, { useContext, useState, useEffect, useRef, createElement, memo, forwardRef, Children, cloneElement, createRef, Component, Fragment as Fragment$1, createContext, Suspense as Suspense$1 } from 'react';
...
import { EditorState, Editor, RichUtils, convertFromRaw, ContentState, convertToRaw } from 'draft-js';
...
import { Page as Page$1 } from 'react-pdf';
...
var ClickAwayListener = function ClickAwayListener(_ref) {
  ...
  return /*#__PURE__*/createElement(as, _objectSpread$1({
    ref: node
  }, props));
};
...
var COMMON_INPUT_STYLES = function COMMON_INPUT_STYLES(_ref2) {
  ...
  return css(["background-clip:padding-box;background-color:", ";border:1px solid ", ";border-radius:", ";box-sizing:border-box;color:", ";display:block;", " ", " ", " outline:none;padding:0 0.725rem;transition:border-color 0.15s ease-in-out,box-shadow 0.15s ease-in-out;width:100%;&:hover{border-color:", ";}&:focus{border-color:", ";}::placeholder{color:", ";opacity:1;}", " ", ""], theme.COLOUR.white, theme.COLOUR.grey80, theme.FORM_ELEMENTS_STYLES.inputBorderRadius, theme.COLOUR.blackText, INPUT_FONT_SIZE(size), Required && css(["border-right-width:0.25rem;"]), isTyping === true && css(["box-shadow:0px 0px 4px ", ";"], theme.COLOUR.fadeBlue), !disabled && !readOnly && theme.COLOUR.lightBlue, function () {
    ...
    return theme ? theme.COLOUR.darkGrey : '#cccccc';
  }), readOnly && css(["background-color:", ";border-color:", ";border-width:1px;padding:0.5rem;"], function (_ref4) {
...
var MESSAGING = {
  ...
  fromTextColour: COLOUR$1.blackText,
  ...
  messageReplyTextColour: COLOUR$1.blackText,
  ...
  replyContainerBackground: COLOUR$1.light,
  replyContainerBackgroundInsideMessage: COLOUR$1.grey,
  replyContainerHeight: '4.15rem',
  replyTextColour: COLOUR$1.blackText,
  replyFromColour: COLOUR$1.info,
  scrollBarColour: COLOUR$1.watterBlue,
  scrollThumbColour: COLOUR$1.blackGrey,
  sentMessageBackground: COLOUR$1.neutral2,
  timerColour: COLOUR$1.info,
  translatorTextColour: COLOUR$1.primary
};
...
var MetaHead = function MetaHead(_ref) {
  ...
  var description = meta.description,
      path = meta.path,
      title = meta.title;
  return __jsx$2(Head$1, null, __jsx$2("title", null, title, " | ", brand), __jsx$2("meta", {
    name: "description",
    content: description,
    key: "description"
  }), __jsx$2("meta", {
...
var StyledButton = styled.button.withConfig({
  ...
  var size = _ref9.size;
  return size === 'sm' && css(["font-size:12px;padding:", ";height:32px;"], function (_ref10) {
    var theme = _ref10.theme;
    return theme.SPACING(2, 4);
  });
}, function (_ref11) {
  var size = _ref11.size;
  return size === 'lg' && css(["font-size:16px;padding:", ";height:56px;"], function (_ref12) {
  ...
  return noPadding && css(["padding:0;"]);
});
...
var Details2 = function Details2(_ref) {
  ...
  var _useState2 = useState(unmountContentOnClose ? open : true),
...
var CaretRight = styled.div.withConfig({
...
var ActionsDivider = styled.div.withConfig({
...
var OpenCloseWrapper = styled.div.withConfig({
...
var OpenIconAndTitleWrapper = styled.div.withConfig({
...
var DetailsText = function DetailsText(_ref) {
  var content = _ref.content,
      text = _ref.text;
  return __jsx$f(React.Fragment, null, __jsx$f(Space, {
    marginBottom: "sm"
  }), __jsx$f(Text, {
    content: content,
    context: "dark",
...
var Divider = styled.hr.withConfig({
  ...
  return css(["background-image:linear-gradient( ", "deg,", ",", " 60%,", " 60%,", " 100% );background-size:", ";border:none;"], vertical ? 0 : 90, theme.COLOUR[context], theme.COLOUR[context], dashed ? 'transparent' : theme.COLOUR[context], dashed ? 'transparent' : theme.COLOUR[context], vertical ? '1px 11px' : ' 11px 1px');
}, function (_ref3) {
  var dashed = _ref3.dashed,
      vertical = _ref3.vertical,
      height = _ref3.height;
  return vertical && css(["width:", "px;height:", ";"], function (_ref4) {
...
var Link = function Link(_ref) {
  ...
  return !validatorUri(to) ? __jsx$n(NextLink, _extends({}, obj, {
    passHref: passHref,
    replace: replace,
    scroll: scroll,
    shallow: shallow
...
var placeholderShimmer = keyframes(["0%{background-position:-468px 0;}100%{background-position:468px 0;}"]);
...
var DatePickerCalendar = function DatePickerCalendar(_ref) {
  ...
  return __jsx$z(Controller$1, {
    render: function render(props) {
      return __jsx$z(ReactDatePicker, _extends({
...
var DatePickerInput = function DatePickerInput(_ref) {
  ...
  return __jsx$A(React.Fragment, null, __jsx$A(Space, {
    marginBottom: "0.5rem"
...
var Dropzone = function Dropzone(_ref) {
  ...
  return __jsx$D(React.Fragment, null, __jsx$D(StyledContainer, _extends({
    dragActive: isDragActive,
    dragAccept: isDragAccept,
    dragReject: isDragReject,
    disabled: disabled
  }, getRootProps()), __jsx$D("input", getInputProps()), isDragAccept && __jsx$D(Text, null, "Accepted"), isDragReject && __jsx$D(Text, null, "Rejected"), isDragActive ? __jsx$D(Text, null, "Drop here") : __jsx$D(React.Fragment, null, __jsx$D(Text, null, "Drop, or click to select"), accept && __jsx$D(Accept, {
    accept: accept
...
var DropzoneField = function DropzoneField(_ref) {
  ...
  return __jsx$F(Controller$1, _extends({
    as: Dropzone,
    control: control,
    name: name
  }, props));
...
var FieldHOC = function FieldHOC(_ref) {
  ...
  return __jsx$L(React.Fragment, null, __jsx$L(Component, _extends({
...
var Input = function Input(_ref) {
  ...
  }, label && __jsx$M(React.Fragment, null, __jsx$M(Space, {
    marginBottom: "xs"
...
var ReactSelectField = function ReactSelectField(_ref) {
  ...
  var Component = /*#__PURE__*/forwardRef(function (data, ref) {
    if (async) {
      return __jsx$U(AsyncSelect, _extends({
      ...
      return __jsx$U(Select, _extends({
        ref: ref
      }, data));
    }
  });
...
var Wrapper$2 = styled.div.withConfig({
  ...
  var error = _ref4.error;
  return error && css(["._,& > div:first-of-type > div:first-of-type{", "}"], function (props) {
    return ERROR_STYLE(props);
  });
}, function (_ref5) {
  var theme = _ref5.theme;
  return css(["", ""], theme.SELECT.MENU_BORDER_COLOUR);
}, function (_ref6) {
  var theme = _ref6.theme,
      size = _ref6.size;
  return css(["", ""], theme.SELECT.FONT_SIZE[size]);
});
...
var Header$1 = styled.header.withConfig({
...
var sizedStyles = function sizedStyles(size) {
  switch (size) {
    case SIZE.XXS:
      return css(["font-size:0.625rem;padding:0 0.25rem;"]);

    case SIZE.XS:
      return css(["font-size:0.75rem;padding:0 0.25rem;"]);

    case SIZE.SM:
      return css(["font-size:0.875rem;padding:0 0.25rem;"]);

    case SIZE.MD:
      return css(["font-size:1rem;padding:0 0.375rem;"]);

    case SIZE.LG:
      return css(["font-size:1.25rem;padding:0 0.375rem;"]);

    case SIZE.XL:
      return css(["font-size:1.5rem;padding:0 0.375rem;"]);

    case SIZE.XXL:
      return css(["font-size:2rem;padding:0 0.5rem;"]);

    case SIZE.XXXL:
      return css(["font-size:3rem;padding:0 0.5rem;"]);
...
var StyledTitle = styled.span.withConfig({
  ...
  var last = _ref4.last,
      theme = _ref4.theme;
  return last && css(["color:", ";"], theme.COLOUR.blackText);
});
...
var StyledIcon$3 = styled(Icon).attrs(function (props) {
  return {
...
var StyledSeperator = styled.span.withConfig({
...
var StyledLastTitle = styled.span.withConfig({
...
var Buttons = function Buttons(_ref) {
  ...
  return __jsx$13(React.Fragment, null, __jsx$13(Divider, {
    size: "sm"
  }), back && __jsx$13(Link, {
    to: pathBack
  }, __jsx$13(Button, {
...
var HighChart = function HighChart(_ref) {
  ...
  return __jsx$1b(HighchartsReact, {
...
var LineChart = withTheme(function (_ref) {
  ...
  return __jsx$1d(ResponsiveLine, {
...
var Stylednav = styled(Icon).withConfig({
...
var Carousel = function Carousel(_ref) {
  ...
  var _useState2 = useState(typeof numberOfItems === 'number' ? numberOfItems : 1),
  ...
  return __jsx$1i(React.Fragment, null, __jsx$1i(Wrapper$3, {
    width: width,
    height: height,
    fullWidth: fullWidth
...
var ItemWrapper = styled.div.withConfig({
  ...
  var gap = _ref3.gap,
      ...
      width = _ref3.width;
  return css(["margin-left:", "px;transform:", ";width:", ";"], gap / 2, transform, width);
});
var NavWrapper = styled.div.withConfig({
  ...
  return endNav === true && css(["right:0;"]);
});
...
var DogName = function DogName(_ref) {
  var _ref$row = _ref.row,
      ...
      name = _ref$row.name;
  return __jsx$1m(React.Fragment, null, __jsx$1m(Icon, {
    context: gender,
...
var Actions = function Actions(_ref) {
  ...
  return __jsx$1n(React.Fragment, null, __jsx$1n(ButtonToolbar, {
    className: "float-right"
...
})(["background:#fff;", " border-radius:0.25rem;left:0;margin-top:1px;min-width:8rem;padding:0.5rem 0;position:absolute;top:100%;z-index:2;box-shadow:0px 2px 8px rgba(0,0,0,0.15);", " ", ""], function (_ref2) {
  var theme = _ref2.theme;
...
var InputWrapper$1 = styled.div.withConfig({
...
var LoadingWrapper = styled.div.withConfig({
  ...
  switch (size) {
    case SIZE.SM:
      return css(["top:2.1rem;height:0.8rem;"]);

    case SIZE.MD:
      return css(["height:1.125rem;"]);

    case SIZE.LG:
      return css(["height:1.45rem;"]);
...
var StyledTitle$2 = styled(Heading).withConfig({
...
var ImageLocationFormElement = function ImageLocationFormElement(_ref) {
  ...
  }, __jsx$1B(Controller$1, _extends({
    as: ImageLocation,
    control: control,
...
var DynamicLocation = DynamicLocationHOC(withScriptjs(withGoogleMap(function (props) {
  return props.defaultCenter.lat && props.defaultCenter.lng ? __jsx$1C(GoogleMap, props) : null;
})));
...
var Navbar = function Navbar(_ref) {
  ...
  var Content = function Content() {
    return __jsx$1H(React.Fragment, null, brand && __jsx$1H(Brand, {
      brand: brand
    }), __jsx$1H(Toggler, {
  ...
  return __jsx$1H(React.Fragment, null, __jsx$1H(StyledNav, {
    style: style
...
var Notification = function Notification(_ref) {
  ...
  var body = __jsx$1O(React.Fragment, null, __jsx$1O(StyledNotificationBody, null, content), date && __jsx$1O(StyledDate, null, formatRelativeTime(date)));
...
var OffCanvasHeader = function OffCanvasHeader(_ref) {
  ...
  return __jsx$1P(StyledHeader$2, {
    ...
    sm: 4
  }, __jsx$1P(StyledContainer$6, null, submit && __jsx$1P(React.Fragment, null, __jsx$1P(Button, {
    content: "Submit",
    context: "primary",
    form: "offCanvasForm",
    size: "sm",
...
var OffCanvasComponent = function OffCanvasComponent(_ref) {
  ...
  return __jsx$1Q(React.Fragment, null, overlay && __jsx$1Q(OffCanvasOverlay, {
...
var OffCanvas = function OffCanvas(props) {
  ...
  return mounted ? /*#__PURE__*/createPortal(__jsx$1R(OffCanvasComponent, props), container) : null;
};
OffCanvas.propTypes = {
  closeOnOverlayClick: propTypes.bool,
  container: propTypes.any,
...
var Pagination = function Pagination(_ref) {
  ...
  var renderContent = function renderContent() {
    return __jsx$1Y(React.Fragment, null, showPrevButton && __jsx$1Y(PaginationItem, {
      context: context,
...
var Table = function Table(_ref) {
  ...
  return __jsx$28(React.Fragment, null, __jsx$28(StyledWrapper$1, {
...
var TableActions = function TableActions(_ref, data) {
  ...
  return __jsx$29(React.Fragment, null, __jsx$29(ButtonToolbar, {
    align: "flex-start",
    style: {
      zIndex: '100000000'
    }
...
var TableLink = function TableLink(path, key, value, dynamicUrl) {
  return function (_ref) {
    ...
    var item = row[value];
    return useLink ? __jsx$2a(React.Fragment, null, item === '-' && '-', item !== '-' && __jsx$2a(StyleLink, {
      border: false,
      href: getPath(),
      onClick: handleClick
    }, item)) : item;
...
var StyledTab = styled.li.withConfig({
  ...
  var disabled = _ref5.disabled,
      theme = _ref5.theme;
  return disabled && css(["background-color:", ";cursor:not-allowed;"], theme.TABS.disabledColour);
}, function (_ref6) {
...
var handleScroll = function handleScroll(el, grabWalkSpeed, grabTimeout) {
  var slider = el;
  var clickTime;
  var isDown = false;
...
var Tabs = function Tabs(_ref) {
  ...
  return __jsx$2c(React.Fragment, null, __jsx$2c(StyledTabs, {
    className: className,
    grabbable: grabbable,
    ref: wrapperRef
...
var StyledTabs = styled.ol.withConfig({
  ...
  return grabbable && css(["&.active{cursor:grabbing;li{cursor:grabbing;pointer-events:none;}}"]);
});
Tabs.propTypes = {
...
var Design = function Design(_ref) {
  ...
  return __jsx$2d(React.Fragment, null, __jsx$2d("div", {
    className: "text-center",
    style: {
      background: '#000',
...
var Bar$1 = function Bar(_ref) {
  ...
  return __jsx$2f(React.Fragment, null, __jsx$2f(StyledBarWrapper, {
    background: background,
    flat: flat,
    open: IsOpen,
    placement: placement,
 ...
 */
var ForgotDetailsSchema = object().shape({
  email: string().required('Please Enter an email').matches(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, 'Email must be valid')
});
 ...
 */
var ForgotDetailsResetSchema = object().shape({
  password: string().required('Please Enter a password').min(8, 'Password is too short - should be 8 chars minimum.').matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*])(?=.{8,})/, 'Must Contain 8 Characters, One Uppercase, One Lowercase, One Number and one special case Character')
});
...
var Login = function Login(_ref) {
  ...
  return __jsx$2p(React.Fragment, null, __jsx$2p(PageHeading, {
    center: true,
    heading: heading,
    divider: false
    ...
    to: pathForgot
  }, "Forgot password?")))), pathSignUp && __jsx$2p(React.Fragment, null, __jsx$2p("p", {
    className: "text-center"
...
var StyledSvg = styled.svg.withConfig({
  displayName: "replyIcon__StyledSvg",
  componentId: "ayx3l5-0"
})(["", ""], function (_ref2) {
  var context = _ref2.context,
      theme = _ref2.theme;
  return context && css(["path{fill:", ";}"], theme.COLOUR[context]);
});
...
var Canonical = 'https://industryui.com';
...
var Sidebar$1 = function Sidebar$1() {
  return __jsx$2z(Sidebar, {
    brand: "/drykiss.svg",
    data: sidebarData
  });
};
var Config = {
  ...
  GetAddressConfig: GetAddressConfig,
  Google: Google,
  Icons: Icons,
  jwtConfig: jwtConfig,
...
var Message = /*#__PURE__*/memo(function (_ref) {
  ...
  var avatar = message.avatar ? __jsx$2A(Avatar, {
    size: "xxs",
    src: message.avatar
  }) : __jsx$2A(Avatar, {
    size: "xxs",
  ...
  var sideActions = __jsx$2A(SideActionsWrapper, null, __jsx$2A(AvatarWrapper, null, avatar), config.hasReply && __jsx$2A(IconWrapper, {
    onClick: handleReplyClick,
    title: "reply"
  }, __jsx$2A(ReplyIcon, null)), config.hasForward && __jsx$2A(IconWrapper, {
    title: "share"
  }, __jsx$2A(ShareIcon, null)));
  ...
  return __jsx$2A(RowWrapper, {
    hasTimeHeader: message.headerTime,
    onMouseOver: handleMouseOver,
    onMouseLeave: handleMouseLeave
  }, message.headerTime && __jsx$2A(TimeHeader, null, __jsx$2A("span", null, message.headerTime)), type === 'in' && sideActions, __jsx$2A(MessageBase, _extends({
    hovered: hovered,
    prevType: prevType,
    hasText: hasText(),
...
var TimeHeader = styled.p.withConfig({
  displayName: "message__TimeHeader",
  componentId: "sc-5iqhvt-0"
})(["position:absolute;margin-top:-0.1rem;text-align:center;width:100%;background:#000;height:1px;span{background:", ";padding:0.25rem 0.5rem;position:relative;top:-0.75rem;font-size:0.75rem;border:1px solid;border-radius:100px;}"], function (_ref2) {
...
})(["cursor:pointer;padding:0.25rem 0;text-align:center;width:100%;path{fill:", ";}"], function (_ref3) {
  var MESSAGING = _ref3.theme.MESSAGING;
  return MESSAGING.forwardAndReplyIconsColour;
});
var SideActionsWrapper = styled.div.withConfig({
...
})(["display:flex;position:relative;", ""], function (_ref4) {
  var hasTimeHeader = _ref4.hasTimeHeader;
  return hasTimeHeader && css(["margin-top:1rem;"]);
});
var AvatarWrapper = styled.div.withConfig({
  displayName: "message__AvatarWrapper",
  componentId: "sc-5iqhvt-4"
})(["margin:0 0.5rem;margin-bottom:0.5rem;div{background:", ";}"], function (_ref5) {
  var MESSAGING = _ref5.theme.MESSAGING;
...
var MessageTo = function MessageTo(_ref) {
  ...
  return icon && __jsx$2C(StyledImage$3, {
    alt: "audience",
    src: icon
  });
};
...
var Loadingspinner = function Loadingspinner() {
  return __jsx$2E(Loading, null);
};
var Loading = styled.div.withConfig({
  displayName: "loadingSpinner__Loading",
  componentId: "giig2u-0"
})(["border:2px solid rgba(0,168,232,0.1);border-top-color:", ";border-radius:100%;height:10px;width:10px;margin:0 0.24rem;animation:rotate 0.8s infinite linear;@keyframes rotate{from{transform:rotate(0deg);}to{transform:rotate(359deg);}}"], function (_ref) {
...
var mentionPlugin = createMentionPlugin({
  mentionComponent: function mentionComponent(mentionProps) {
    return __jsx$2F(MentionComponent, {
...
var MessageBase = function MessageBase(_ref) {
  ...
  var _useState2 = useState(false),
      showingTranslation = _useState2[0],
      setShowingTranslation = _useState2[1];

  var _useState3 = useState(false),
      loadingTranslation = _useState3[0],
      setloadingTranslation = _useState3[1];
  ...
  return __jsx$2F(MessageWrapper, {
    type: type,
    hovered: hovered
  }, __jsx$2F(StyledHead, {
    type: type
  }, __jsx$2F(StyledHeadText, {
    type: type
  }, from, " ", __jsx$2F(Dot, null), time.split(' ')[time.split(' ').length - 1]), hasMenu && __jsx$2F(MenuWrapper, null, __jsx$2F(Dropdown, {
    caret: false,
    items: [{
      name: 'Star Message',
      id: 'star'
  ...
  }, __jsx$2F(MenuIcon, null)))), __jsx$2F(StyledCard$2, {
    type: type
  }, __jsx$2F(Row, null, __jsx$2F(Column, {
    sm: 6,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, __jsx$2F(MessageIcon, {
    icon: icon
  }), to && __jsx$2F(MessageTo, {
    to: to
  }), __jsx$2F(StyledReply, null, reply))), __jsx$2F(Row, null, pictureId && __jsx$2F(Column, {
    sm: 2
  }, __jsx$2F(Image$1, {
    alt: "Image",
    src: pictureId
  ...
  }, replyTo && __jsx$2F(ReplyContainer, {
    message: replyTo,
    inMessage: true,
    onClose: null
  }), __jsx$2F(StyledContent$4, null, voice && __jsx$2F(AudioWrapper, null, __jsx$2F(MessagingAudioPlayer, {
    src: voice,
    inMessage: true
  })), hasText && __jsx$2F(MessagingEditor, {
    ...
    editorState: editorState,
    readOnly: true
  }))), !type && __jsx$2F(Column, {
    sm: 1
  }, __jsx$2F(Icon, {
    color: statusText === 'Delivered' ? 'green' : '#bbb',
    icon: "check-circle"
  }))), type === 'in' && hasText && __jsx$2F(TranslatorWrapper, {
    onClick: toggleTranslation
  }, showingTranslation ? 'See Original' : 'See Translation', loadingTranslation && __jsx$2F(Loadingspinner, null)), attachments && attachments.length > 0 && __jsx$2F(AttachmentsContainer, null, Array.from(attachments).map(function (item, index) {
    return __jsx$2F(SingleAttachment, {
      key: index
    }, __jsx$2F(Preview, {
      imageStyles: {
        minHeight: '10rem',
...
var StyledHeadText = styled.div.withConfig({
  displayName: "base__StyledHeadText",
  componentId: "qjqs0v-0"
})(["display:flex;", ""], function (_ref3) {
  var type = _ref3.type;
  return type === 'out' && css(["flex-direction:row-reverse;"]);
});
var TranslatorWrapper = styled.div.withConfig({
  displayName: "base__TranslatorWrapper",
  componentId: "qjqs0v-1"
})(["align-items:center;color:", ";cursor:pointer;display:flex;font-size:0.625rem;font-weight:600;width:fit-content;"], function (_ref4) {
  var MESSAGING = _ref4.theme.MESSAGING;
  return MESSAGING.translatorTextColour;
});
...
})(["cursor:pointer;display:flex;margin-top:-1rem;margin-bottom:-1rem;opacity:0;pointer-events:none;transition:opacity 0.3s;"]);
var SingleAttachment = styled.div.withConfig({
  displayName: "base__SingleAttachment",
  componentId: "qjqs0v-3"
})([""]);
var AttachmentsContainer = styled.div.withConfig({
...
})(["flex:1;margin-top:1.5rem;max-width:80%;", " ", ""], function (_ref5) {
  var type = _ref5.type;
  return type === 'out' && css(["margin-left:20%;"]);
}, function (_ref6) {
  var hovered = _ref6.hovered;
  return hovered && css(["", "{opacity:1;pointer-events:inherit;}"], MenuWrapper);
});
var StyledCard$2 = styled(Card).withConfig({
  displayName: "base__StyledCard",
  componentId: "qjqs0v-6"
})(["background-color:", ";border:1px solid ", ";border-radius:", ";margin-bottom:0.5rem;padding:1.25rem 1rem;"], function (_ref7) {
  var type = _ref7.type,
...
})(["color:", ";font-size:", ";"], function (_ref10) {
...
})(["color:", ";font-size:0.75rem;"], function (_ref12) {
  var MESSAGING = _ref12.theme.MESSAGING;
  return MESSAGING.messageReplyTextColour;
});
var StyledHead = styled.span.withConfig({
  displayName: "base__StyledHead",
  componentId: "qjqs0v-9"
})(["align-items:center;color:", ";display:flex;font-size:0.75rem;font-weight:600;justify-content:space-between;position:absolute;text-align:right;top:0.25rem;", ""], function (_ref13) {
  var MESSAGING = _ref13.theme.MESSAGING;
  return MESSAGING.fromTextColour;
}, function (_ref14) {
  var type = _ref14.type;
  return type === 'out' ? css(["flex-direction:row-reverse;right:3.25rem;width:73%;"]) : css(["left:3.25rem;width:80%;"]);
});
var Dot = styled.div.withConfig({
  displayName: "base__Dot",
  componentId: "qjqs0v-10"
})(["background-color:", ";border-radius:1rem;height:0.25rem;margin:0.25rem;width:0.25rem;"], function (_ref15) {
...
var DragAndDropable = function DragAndDropable(_ref) {
  ...
  return __jsx$2G(Container$2, getRootProps({
...
var MessagingDragHover = function MessagingDragHover(_ref) {
  ...
  return __jsx$2H(Wrapper$6, {
    open: isOpen
  }, __jsx$2H(ContentWrapper$1, null, __jsx$2H(Head, null, __jsx$2H(Close, {
    click: onClose,
    context: "white"
  }), __jsx$2H(Space, {
    marginLeft: "sm"
    ...
    context: "white"
  }, "Preview"))), __jsx$2H(LastFilePreviewContainer, {
    visible: files.length > 0
  }, selectedFile && __jsx$2H(Preview, {
    file: selectedFile,
    showName: true,
    showPagesNumber: true
  })), documentInfo.pagesNumber > 0 && files.length > 0 && __jsx$2H(DocumentInfoWrapper, null, __jsx$2H(DocumentNameWrapper, null, __jsx$2H(DocumentFileIcon, {
    pdf: true
  }), __jsx$2H(DocumentName, null, documentInfo.name)), __jsx$2H(DucumentPagesNumber, null, "".concat(documentInfo.pagesNumber, " Page").concat(documentInfo.pagesNumber > 1 && 's'))), !files[0] && __jsx$2H(DragFilesHereContainer, null, __jsx$2H(Text, {
    size: "xl",
    context: "dark"
  }, "Drag File Here")), __jsx$2H(PreviewContainer, null, selectedFile && files.map(function (item, index) {
    return __jsx$2H(BottomPreviewContainer, {
      key: index
    }, __jsx$2H(RemoveContainer, null, __jsx$2H(Close, {
...
var DocumentNameWrapper = styled.div.withConfig({
  displayName: "dragHover__DocumentNameWrapper",
  componentId: "sc-1hidmkd-0"
})(["align-items:center;display:flex;"]);
var DocumentFileIcon = styled.div.withConfig({
  displayName: "dragHover__DocumentFileIcon",
  componentId: "sc-1hidmkd-1"
})(["background-repeat:no-repeat;height:1.5rem;margin-right:1rem;width:1rem;", ""], function (_ref2) {
  var pdf = _ref2.pdf;
  return pdf === true && css(["background-image:url('data:image/png;base64,');"]);
});
var DocumentName = styled.p.withConfig({
  displayName: "dragHover__DocumentName",
  componentId: "sc-1hidmkd-2"
})([""]);
var DucumentPagesNumber = styled.p.withConfig({
  displayName: "dragHover__DucumentPagesNumber",
  componentId: "sc-1hidmkd-3"
})([""]);
var DocumentInfoWrapper = styled.div.withConfig({
  displayName: "dragHover__DocumentInfoWrapper",
  componentId: "sc-1hidmkd-4"
})(["display:flex;justify-content:space-between;padding:0 3.5rem;position:absolute;top:27rem;width:100%;p{color:", ";font-size:1.25rem;margin:0;}"], function (_ref3) {
  var theme = _ref3.theme;
  return theme.COLOUR.blackText;
});
var RemoveContainer = styled.div.withConfig({
  displayName: "dragHover__RemoveContainer",
  componentId: "sc-1hidmkd-5"
})(["align-items:center;background:", ";border:2px solid ", ";border-radius:50px;display:flex;height:26px;justify-content:center;opacity:0;position:absolute;right:-15px;transition:opacity 0.3s;top:-12px;width:26px;z-index:1;"], function (_ref4) {
  var theme = _ref4.theme;
...
})(["align-items:center;bottom:0;display:flex;height:9rem;justify-content:center;position:absolute;width:100%;", ""], function (_ref6) {
  var theme = _ref6.theme;
  return css(["background-color:", ";"], theme.COLOUR.grey);
});
var BottomPreviewContainer = styled.div.withConfig({
  displayName: "dragHover__BottomPreviewContainer",
  componentId: "sc-1hidmkd-7"
})(["border:2px solid ", ";box-sizing:content-box;margin:0 0.25rem;position:relative;width:4rem;transition-property:border-color;transition-duration:0.3s;&:hover{border:2px solid ", ";", "{opacity:1;}}"], function (_ref7) {
  var theme = _ref7.theme;
  return theme.COLOUR.blackGrey;
}, function (_ref8) {
  var theme = _ref8.theme;
...
})(["background-color:", ";height:100%;position:relative;width:100%;"], function (_ref9) {
  var theme = _ref9.theme;
  return theme.COLOUR.white;
});
var CenterContainer = styled.div.withConfig({
  displayName: "dragHover__CenterContainer",
  componentId: "sc-1hidmkd-9"
})(["display:grid;height:calc(100% - 17rem);left:3.5rem;place-content:center;position:absolute;top:4rem;width:calc(100% - 7rem);"]);
var DragFilesHereContainer = styled(CenterContainer).withConfig({
  displayName: "dragHover__DragFilesHereContainer",
  componentId: "sc-1hidmkd-10"
})(["border:0.25rem dashed;"]);
var LastFilePreviewContainer = styled(CenterContainer).withConfig({
  displayName: "dragHover__LastFilePreviewContainer",
  componentId: "sc-1hidmkd-11"
})(["border-radius:9px;border:1px solid;opacity:0;overflow:hidden;transform:scale(0.5);transition-property:opacity,transform;transition-duration:0.3s;", ""], function (_ref10) {
  var visible = _ref10.visible;
  return visible === true && css(["opacity:1;transform:scale(1);"]);
});
var Head = styled.div.withConfig({
  displayName: "dragHover__Head",
  componentId: "sc-1hidmkd-12"
})(["align-items:center;display:flex;height:3rem;padding:0 1.25rem;background-color:", ";"], function (_ref11) {
  var MESSAGING = _ref11.theme.MESSAGING;
  return MESSAGING.dropableHeaderBackground;
});
var Wrapper$6 = styled.div.withConfig({
  displayName: "dragHover__Wrapper",
  componentId: "sc-1hidmkd-13"
})(["height:calc(100% - 5.3rem);position:absolute;top:0;transform:translateY(calc(100% + 5.3rem));width:100%;transition:transform 0.3s cubic-bezier(0.4,0,0.2,1);", ""], function (_ref12) {
...
var MessagingInput = function MessagingInput(_ref) {
  ...
  }, mentions && __jsx$2I(MentionSuggestions, {
    onAddMention: onAddMention,
    onSearchChange: onSearchChange,
    suggestions: suggestions
  }), __jsx$2I(MessagingEditor, {
    editorState: editorState,
    onChange: handleChange,
...
var renderMessage = function renderMessage(_ref, messages, cache, config) {
  var index = _ref.index,
      ...
      key = _ref.key,
      style = _ref.style;
  return __jsx$2J(CellMeasurer, {
    cache: cache,
    key: index,
    parent: parent,
    columnIndex: 0,
    rowIndex: index
  }, __jsx$2J(MessageContainer, {
...
var MessageList = /*#__PURE__*/memo(function (_ref2) {
  ...
  var _useState2 = useState(new CellMeasurerCache(cacheConfig)),
      cache = _useState2[0],
  ...
  return __jsx$2J(AutoSizer, null, function (_ref3) {
...
var MessageContainer = styled.div.withConfig({
  ...
  var type = _ref4.type;
  return type === 'in' ? css(["padding-right:0.5rem;"]) : css(["padding-left:0.5rem;"]);
});
...
var isImage = function isImage(src) {
  ...
  var _iterator = _createForOfIteratorHelper$1(imageFormats),
      _step;
...
var checkFileType = function checkFileType(file, type) {
  if (file !== null && file !== void 0 && file.type.includes(type) || fileType(file === null || file === void 0 ? void 0 : file.src) === type) return true;
  return false;
};
...
var Preview = /*#__PURE__*/memo(function (_ref) {
  ...
  var onDocumentLoadSuccess = function onDocumentLoadSuccess(_ref2) {
    ...
    showPagesNumber && MessagingCommunicationService.send({
      name: MessageNames.Messaging.MESSAGING_ACTION,
      payload: {
  ...
  var src = source(file);
  return checkFileType(file, 'image') ? __jsx$2K(PreviewImage, {
    src: src,
    onClick: onClick,
    style: imageStyles
  }) : checkFileType(file, 'pdf') ? __jsx$2K(PdfWrapper, {
    onClick: onClick,
    small: small,
    message: message
  }, __jsx$2K(Document, {
    ...
    pageNumber: 1
  }))) : __jsx$2K(PlaceHolder, null, __jsx$2K(FilePlaceHolder, {
    placeHolderImageUrl: placeHolderImageUrl
  }), showName && (file === null || file === void 0 ? void 0 : file.name));
}, function (_ref3, _ref4) {
  var prevFile = _ref3.file;
  var nextFile = _ref4.file;
...
var PreviewImage = styled.img.withConfig({
  displayName: "preview__PreviewImage",
  componentId: "sc-1ex96ka-0"
})(["width:100%;", ""], function (_ref5) {
  var onClick = _ref5.onClick;
  return onClick && css(["cursor:pointer;"]);
});
var PdfWrapper = styled.div.withConfig({
  displayName: "preview__PdfWrapper",
  ...
  if (message || small) {
    ...
    return css(["width:", ";height:", ";overflow:hidden;.react-pdf__Page__canvas,.react-pdf__Page__textContent{width:", " !important;height:auto !important;}"], size, size, size);
  }
});
var FilePlaceHolder = styled.div.withConfig({
  displayName: "preview__FilePlaceHolder",
  componentId: "sc-1ex96ka-2"
})(["background-image:url(", ");background-repeat:no-repeat;background-size:contain;height:3rem;margin-bottom:0.5rem;width:3rem;"], function (_ref8) {
  var placeHolderImageUrl = _ref8.placeHolderImageUrl;
...
var PlaceHolder = styled.div.withConfig({
  ...
  componentId: "sc-1ex96ka-3"
})(["align-items:center;display:flex;flex-direction:column;"]);

var __jsx$2L = React.createElement;
var ReplyContainer = function ReplyContainer(_ref) {
  var message = _ref.message,
      onClose = _ref.onClose,
  ...
  return __jsx$2L(Container$3, {
    inMessage: inMessage
  }, !inMessage && __jsx$2L(ReplyIconWrapper, null, __jsx$2L(ReplyIcon, {
    context: "info"
  })), __jsx$2L(Divider, {
    context: "info",
    height: "1.5rem",
    vertical: true
  }), __jsx$2L(MessageWrapper$1, null, __jsx$2L(FromWrapper, null, message.from), __jsx$2L(MessagingEditor, {
    onChange: function onChange(e) {
      return setEditorState(e);
    },
    editorState: editorState,
    readOnly: true
  })), onClose && __jsx$2L(Close, {
    click: handleCloseClick,
    context: "darkGrey"
  }));
};
var FromWrapper = styled.div.withConfig({
  displayName: "reply__FromWrapper",
  componentId: "wc5ouf-0"
})(["color:", ";font-size:0.75rem;line-height:initial;margin-bottom:-0.3rem;margin-top:0.3rem;"], function (_ref2) {
  var MESSAGING = _ref2.theme.MESSAGING;
  return MESSAGING.replyFromColour;
});
var MessageWrapper$1 = styled.div.withConfig({
  displayName: "reply__MessageWrapper",
  componentId: "wc5ouf-1"
})(["color:", ";flex:1;line-height:2rem;"], function (_ref3) {
  var MESSAGING = _ref3.theme.MESSAGING;
  return MESSAGING.replyTextColour;
});
var ReplyIconWrapper = styled.div.withConfig({
  displayName: "reply__ReplyIconWrapper",
  componentId: "wc5ouf-2"
})(["height:100%;"]);
var Container$3 = styled.div.withConfig({
  displayName: "reply__Container",
  componentId: "wc5ouf-3"
})(["background:", ";display:flex;height:", ";left:-4px;overflow:hidden;padding:0.5rem 1rem;position:absolute;", " ", " width:100%;"], function (_ref4) {
  var MESSAGING = _ref4.theme.MESSAGING;
  ...
  var MESSAGING = _ref6.theme.MESSAGING;
  return css(["top:calc(-", " - 0.05rem);"], MESSAGING.replyContainerHeight);
}, function (_ref7) {
  var inMessage = _ref7.inMessage;
  return inMessage && css(["background:", ";border-radius:0.5rem;position:relative;top:0.5rem;margin-bottom:0.5rem;hr{margin-left:0;}"], function (_ref8) {
    var MESSAGING = _ref8.theme.MESSAGING;
...
var MessagingSearch = function MessagingSearch(_ref) {
  ...
  return __jsx$2M(StyledContainer$7, null, __jsx$2M(Form, {
    handleSubmit: handleSubmit(onSubmit)
  }, __jsx$2M(Row, null, __jsx$2M(Column, {
    md: 6
  }, __jsx$2M(StyledSearch, _extends({}, defaultOptions, {
    prependSearchIcon: true,
    placeholder: placeholder
  }))), __jsx$2M(Column, {
    md: 6
  }, __jsx$2M(StyledSelect$1, _extends({}, defaultOptions, {
...
var PaperPlane = function PaperPlane(props) {
  return __jsx$2N(StyledSvg$1, _extends({}, props, {
    "aria-hidden": "true",
    width: 25,
    focusable: "false",
    viewBox: "0 0 512 512"
...
var MessagingSend = function MessagingSend(_ref) {
  ...
  var _useState5 = useState(null),
      replyMessage = _useState5[0],
      setreplyMessage = _useState5[1];
  ...
  var submit = function submit() {
    ...
    var data = _objectSpread$e(_objectSpread$e({
      attachments: attachments,
  ...
  return __jsx$2O(React.Fragment, null, __jsx$2O(StyledContainer$8, {
    audience: audience
  }, replyMessage && __jsx$2O(ReplyContainer, {
    message: replyMessage,
    onClose: function onClose() {
      return setreplyMessage(null);
    }
  }, replyMessage.id), __jsx$2O(StyledWrapper$3, null, audience && __jsx$2O(StyledDropDown, {
    items: audienceItems,
    onChange: function onChange(item) {
      return setAudience(item);
    },
    position: "top"
  }, audience.name), __jsx$2O(StyledElements, null, __jsx$2O(EmojiSelectWrapper, null, __jsx$2O(EmojiSuggestions, null), __jsx$2O(EmojiSelect, null)), __jsx$2O(StyledIcon$9, {
    fixedWidth: false,
    icon: "paperclip",
    onClick: openFileDialog,
    size: "lg"
  })), voiceMessage && __jsx$2O(AudioWrapper, {
    preview: true
  }, __jsx$2O(MessagingAudioPlayer, {
    src: URL.createObjectURL(voiceMessage)
  }), __jsx$2O(DeleteIconWrapper, {
    ...
    type: "file"
  }), __jsx$2O(StyledElements, null, isSendDisabled() ? __jsx$2O(VoiceRecorder, null) : __jsx$2O(Button, {
    context: "transparent",
    disabled: isSendDisabled(),
    noPadding: true,
    onClick: submit,
    size: "xs"
  }, __jsx$2O(PaperPlane, null))))));
};
...
var EmojiSelectWrapper = styled.div.withConfig({
...
var StyledWrapper$3 = styled.div.withConfig({
...
var StyledSvg$2 = styled.svg.withConfig({
...
var toHHMMSS = function toHHMMSS(_ref) {
  var sec = _ref.sec,
...
var VoiceRecorder = function VoiceRecorder(props) {
  ...
  var showRecorder = function showRecorder(props) {
    if (!recorderLoaded) return __jsx$2Q(Microphone, {
      isLoading: true
    });
    return __jsx$2Q(React.Fragment, null, __jsx$2Q(OverLay, {
      isRecording: isRecording
    }, isRecording && __jsx$2Q(OverlayRecorderIconWrapper, null, __jsx$2Q(Microphone, {
      isRecording: true
    })), __jsx$2Q(Text, {
      content: "Recording",
      context: "blackText"
    }), __jsx$2Q(Loader, null, __jsx$2Q(Dot$1, null, "."), __jsx$2Q(Dot$1, null, "."), __jsx$2Q(Dot$1, null, ".")), __jsx$2Q(TimerWrapper, null, toHHMMSS({
      sec: timer + '',
      hasMinute: true,
      hasSecond: true
    })), __jsx$2Q(Close, {
    ...
    }, isRecording ? __jsx$2Q(StopIcon, null) : __jsx$2Q(Microphone, null)));
  };

  return __jsx$2Q("div", null, showRecorder());
};
var StopIcon = styled.div.withConfig({
  displayName: "voiceRecorder__StopIcon",
  componentId: "sc-8nxb0v-0"
})(["background-color:", ";border-radius:3px;height:1rem;margin-top:-0.5rem;width:1rem;"], function (_ref3) {
  var theme = _ref3.theme;
  return theme.COLOUR.danger;
});
var Dot$1 = styled.span.withConfig({
  displayName: "voiceRecorder__Dot",
  componentId: "sc-8nxb0v-1"
})([""]);
var Loader = styled.div.withConfig({
  displayName: "voiceRecorder__Loader",
  componentId: "sc-8nxb0v-2"
})(["margin-top:-0.25rem;@keyframes blink{50%{color:transparent;}}", "{animation:1s blink infinite;font-size:1.5rem;}", ":nth-child(2){animation-delay:250ms;}", ":nth-child(3){animation-delay:500ms;}"], Dot$1, Dot$1, Dot$1);
var OverlayRecorderIconWrapper = styled.div.withConfig({
  displayName: "voiceRecorder__OverlayRecorderIconWrapper",
  componentId: "sc-8nxb0v-3"
})(["margin-right:1rem;margin-top:0.5rem;"]);
var TimerWrapper = styled.div.withConfig({
  displayName: "voiceRecorder__TimerWrapper",
  componentId: "sc-8nxb0v-4"
})(["color:", ";flex:1;text-align:end;padding-right:1rem;"], function (_ref4) {
  var MESSAGING = _ref4.theme.MESSAGING;
  return MESSAGING.timerColour;
});
var Wrapper$8 = styled.div.withConfig({
  displayName: "voiceRecorder__Wrapper",
  componentId: "sc-8nxb0v-5"
})(["cursor:pointer;padding-top:0.25rem;"]);
var OverLay = styled.div.withConfig({
  displayName: "voiceRecorder__OverLay",
  componentId: "sc-8nxb0v-6"
})(["align-items:center;background-color:", ";display:flex;height:45px;left:4rem;overflow:hidden;position:absolute;top:-2px;transition-property:padding-left,padding-right,width,opacity;transition-duration:0.3s;transition-timing-function:cubic-bezier(0.4,0,0.2,1);z-index:1;", ""], function (_ref5) {
  var MESSAGING = _ref5.theme.MESSAGING;
  return MESSAGING.inputSectionBackground;
}, function (_ref6) {
  var isRecording = _ref6.isRecording;
...
var MessagingContainer = function MessagingContainer(_ref) {
  ...
  var messagesConfig = _objectSpread$f(_objectSpread$f(_objectSpread$f({}, forwardForMessages && {
    hasForward: true
  }), menuForMessages && {
    hasMenu: true
  }), replyForMessages && {
  ...
  var _useState2 = useState(messages && messages.length > 0),
      hasMessage = _useState2[0],
      sethasMessage = _useState2[1];

  var _useState3 = useState(false),
      IsDragHoverOpen = _useState3[0],
      setIsDragHoverOpen = _useState3[1];
  ...
  return __jsx$2R(DragAndDropable, {
    onFileDrop: onDrop,
    onHover: onHover,
    onLeave: onLeave
  }, __jsx$2R(MessagingSearch, {
    onFilter: onFilter,
    onSearch: onSearch
  }), __jsx$2R(StyledContainer$9, {
    messagesContainerHeight: hasMessage ? messagesContainerHeight : 0,
    className: className,
    style: style
  }, __jsx$2R(MessageList, {
    config: messagesConfig,
    initialMessages: messages,
    onMessageRecieved: handleMessageRecieved
  })), __jsx$2R(MessagingSend, {
    audienceItems: audienceItems,
    onSubmit: handleSubmit,
    maxLength: maxLength,
    mentions: mentions
  }), __jsx$2R(MessagingDragHover, {
    files: Files,
...
function Hashtag(props) {
  ...
  return __jsx$2S(StyledHashtag, _extends({
    onClick: function onClick() {
...
var StyledHashtag = styled.span.withConfig({
...
var linkifyPlugin = createLinkifyPlugin({
  ...
  component: function component(props) {
    return __jsx$2U(LinkPluginComponent, props);
  }
}); //  plugins configuration

var mentionPlugin$1 = createMentionPlugin();
var hashtagPlugin = createHashtagPlugin();
var emojiPlugin$1 = createEmojiPlugin();
...
var StyledMention = styled.span.withConfig({
...
var LinkPluginComponent = function LinkPluginComponent(props) {
  return __jsx$2W(StyledA$1, _extends({}, props, {
    onClick: function onClick() {}
  }));
};
var StyledA$1 = styled.a.withConfig({
...
var Pricing = function Pricing(_ref) {
  ...
  return __jsx$2Y(Wrapper$9, {
    ref: WrapperRef
  }, __jsx$2Y(ResizeDetector, {
    onResize: function onResize(_ref2) {
      var width = _ref2.width;
      return resetLayout();
    }
  }), __jsx$2Y(PricesWrapper, null, __jsx$2Y(React.Fragment, null, Layout.includes(LAYOUTS.DESKTOP) ? pricingInfo.map(function (item, index) {
    return __jsx$2Y(PricingCard, {
      layout: Layout,
      onCardSelect: handlePlanSelect,
      data: item,
      key: index
    });
  }) : __jsx$2Y(DropDownAndFeatues, null, __jsx$2Y(PricingDropdown, {
    onPlanChange: handlePlanChange,
    pricingInfo: pricingInfo,
    selectedPlan: SelectedPlan
  }), __jsx$2Y(FeaturesAndAdd, null, __jsx$2Y(FeaturesWrapper, null, pricingInfo[SelectedPlan].checkList.map(function (item, index) {
    return __jsx$2Y(ListItem$1, {
      key: index
    }, __jsx$2Y(Icon, {
      color: "rgb(69, 186, 190)",
      icon: "check",
      prefix: "fas"
    }), __jsx$2Y(StyledFeature, {
      content: item.title,
      context: "blackText",
      size: "sm"
    }));
  })), __jsx$2Y(AddToCartWrapper, {
    fullWidth: Layout === LAYOUTS.MOBILE
  }, __jsx$2Y(StyledButton$8, {
    block: true,
    context: "deepBlue",
    onClick: function onClick() {
    ...
    outline: true
  }, "Add To Cart")))))), __jsx$2Y(PriceMatrix, {
    pricingInfo: pricingInfo,
    layout: Layout,
    selectedPlan: SelectedPlan
  }));
...
var AddToCartWrapper = styled.div.withConfig({
...
var DropDownAndFeatues = styled.div.withConfig({
...
var PricesWrapper = styled.div.withConfig({
...
var PricingCard = function PricingCard(_ref) {
  ...
  var checkList = data.checkList,
      ...
      price = data.price;
  return __jsx$2Z(Wrapper$a, {
    layout: layout,
    recommended: recommended
  }, __jsx$2Z(Title, {
    recommended: recommended
  }, data.title), __jsx$2Z(ChecklistWrapper, null, checkList.map(function (item, index) {
    return __jsx$2Z(ListItem$2, {
      key: index
    }, __jsx$2Z(Icon, {
      color: recommended ? 'rgb(255, 202, 16)' : 'rgb(69, 186, 190)',
      icon: "check",
      prefix: "fas"
    }), __jsx$2Z(StyledText$6, {
      content: item.title,
      context: recommended ? 'white' : 'blackText',
      size: priceLayoutSizes(layout).featuresTextSize
    }));
  })), __jsx$2Z(FlexSpacer, null), __jsx$2Z(Fee, {
    align: "center",
    content: price,
    context: recommended ? 'white' : 'deepBlue',
    recommended: recommended,
    size: "xl"
  }), __jsx$2Z(AddButtonWrapper, {
    onClick: function onClick() {
      return onCardSelect(data);
    }
  }, __jsx$2Z(AddToCartText, {
    align: "center",
    content: "Add To Cart",
    context: recommended ? 'white' : 'deepBlue',
    size: "sm"
...
var StyledText$6 = styled(Text).withConfig({
  displayName: "pricingCard__StyledText",
  componentId: "fq5pyi-4"
})(["line-height:1.25rem;padding-left:0.375rem;"]);
var ListItem$2 = styled.div.withConfig({
  displayName: "pricingCard__ListItem",
  componentId: "fq5pyi-5"
})(["align-items:center;display:flex;"]);
var ChecklistWrapper = styled.div.withConfig({
...
var PricingDropdown = function PricingDropdown(_ref) {
  ...
  return __jsx$2_(Wrapper$b, {
    onClick: handleClickOnWrapper,
    onClickAway: handleClickAway
  }, __jsx$2_(TitleWrapper, null, __jsx$2_(StyledTitle$3, {
    content: selected.title,
    context: "blackText",
    size: "xl"
  })), __jsx$2_(PriceAndDropIconWrapper, null, __jsx$2_(StyledPrice, {
    content: selected.price,
    size: "lg",
    context: "deepBlue"
  }), __jsx$2_(StyledDownIcon, {
    icon: "caret-down",
    prefix: "fas"
  })), __jsx$2_(PlansWrapper, {
    open: IsOpen
  }, pricingInfo.map(function (item, index) {
    return __jsx$2_(PriceElement, {
      key: index,
      isLast: index === pricingInfo.length - 1,
      onClick: function onClick() {
        return handlePlanClick(index);
      }
    }, __jsx$2_(ElementTitleAndDescriptionsWrapper, null, __jsx$2_(StyledElementTitle, {
      content: item.title,
      context: item.recommended ? 'deepBlue' : 'blackText',
      size: "sm"
    }), __jsx$2_(StyledElementDescription, {
      content: item.description,
      context: item.recommended ? 'deepBlue' : 'blackText',
      size: "xs"
    })), __jsx$2_(PriceAndDropIconWrapper, null, item.recommended && __jsx$2_(StyledRecomendedText, {
      content: "Recommend by IUI",
      context: "gold40",
      size: "xs"
    }), __jsx$2_(StyledPrice, {
      content: item.price,
      size: "lg",
      context: "deepBlue"
    })));
...
var PriceElement = styled.div.withConfig({
  ...
  var theme = _ref2.theme,
      isLast = _ref2.isLast;
  return css(["border-bottom:", "px solid ", ";background-color:", ";"], isLast ? '0' : '1', theme.COLOUR.darkGrey, theme.COLOUR.white);
});
var PlansWrapper = styled(ClickAwayListener).withConfig({
  ...
  var open = _ref4.open;
  return open && css(["opacity:1;transform:translateY(0px);pointer-events:initial;"]);
});
...
var Wrapper$b = styled(ClickAwayListener).withConfig({
...
var PriceMatrix = function PriceMatrix(_ref) {
  ...
  return __jsx$2$(PriceMatrixWrapper, null, __jsx$2$(MatrixCol, {
    freeSize: true
  }, features.map(function (item, index) {
    return __jsx$2$(FeatureNameColumn, {
      key: index,
      odd: index % 2 !== 0
    }, __jsx$2$(Text, {
      content: item,
    ...
    return __jsx$2$(MatrixCol, {
      ...
      return __jsx$2$(FeatureCheckColumn, {
        odd: idx % 2 !== 0,
        key: idx
      }, featureExist(item, feature) ? __jsx$2$(StyledIcon$a, {
        prefix: "fas",
        icon: "check",
...
var StyledIcon$a = styled(Icon).attrs(function (props) {
  return {
...
var FeatureCheckColumn = styled.div.withConfig({
...
var FeatureNameColumn = styled.div.withConfig({
...
var MatrixCol = styled.div.withConfig({
  displayName: "priceMatrix__MatrixCol",
  componentId: "sc-3gg7mj-3"
})(["margin:0 0.375rem;", " ", ""], function (_ref6) {
  var freeSize = _ref6.freeSize;
  return freeSize && css(["flex:1;"]);
}, function (_ref7) {
  var flex = _ref7.flex,
      freeSize = _ref7.freeSize,
      layout = _ref7.layout,
      show = _ref7.show;
  return !freeSize && css(["display:", ";margin:0;", " min-width:calc(", " + 0.75rem );"], show ? 'block' : 'none', flex && 'flex:1;', priceLayoutSizes(layout).priceCardWidth);
});
var PriceMatrixWrapper = styled.div.withConfig({
...
var Register = function Register(_ref) {
  ...
  var renderBirthday = function renderBirthday() {
    return __jsx$30(React.Fragment, null, __jsx$30(DatePickerInput, {
      day: dayBirthday,
      id: "Birthday",
      label: "Birthdate",
      month: monthBirthday,
      year: yearBirthday
    }), __jsx$30(Text, null, "To sign up, you must be 18 or older. Other users will not see this."));
  };
  ...
  return __jsx$30(Form, {
    handleSubmit: handleSubmit(onSubmit)
  }, error && __jsx$30(Alert, {
    content: error.message,
    context: "warning"
  }), __jsx$30(FormLabel, {
    label: "First name"
  }, __jsx$30(FormField, _extends({}, defaultOptions, {
    autoFocus: true,
    name: "nameFirst",
    ...
    placeholder: showPlaceholder ? 'Password' : '',
    type: "password"
  }))), birthday && renderBirthday(), passwordError && __jsx$30(Alert, {
    content: passwordError.message,
    context: "warning"
  }), __jsx$30(CheckboxField, _extends({}, defaultOptions, {
    data: CHECKBOX_TERMS,
    stacked: true
  })), __jsx$30(Button, {
    align: "right",
    ...
    size: "lg",
    type: "submit"
  }), __jsx$30(StyledLink$a, null, "Already have an account? ", __jsx$30(Link, {
    to: pathLogin
  }, "Log in")));
};
...
var ArticleLayout = function ArticleLayout(_ref) {
  ...
  // }
  return __jsx$31(Container, null, __jsx$31(Row, null, __jsx$31(Column, {
    md: 12
  }, __jsx$31(Article, {
    article: frontMatter
  }))));
...
var Bootstrap = function Bootstrap(_ref) {
  ...
  return __jsx$32(React.Fragment, null, __jsx$32(Navigation, null), children, footer && __jsx$32(Footer, {
    columns: footer,
    fixed: fixed
  }), copyright && __jsx$32(Copyright, {
    brand: brand,
    icon: icon,
    links: copyright
  }));
...
var Dashboard = function Dashboard(_ref) {
  ...
  var mergedMeta = _objectSpread$g(_objectSpread$g({}, defaultMeta), meta);

  return __jsx$33(React.Fragment, null, __jsx$33(Suspense$1, {
    fallback: __jsx$33(PageLoading, {
      indicator: __jsx$33(LdsSpinner, null)
    })
  }, __jsx$33(React.Fragment, null, __jsx$33(Page, {
    children: View || children,
    fluid: true,
    meta: mergedMeta,
    pageHeading: pageHeading
  }), message && __jsx$33(Alert, {
    content: message,
    context: context
  }))));
};
...
var Page = function Page(_ref) {
  ...
  return __jsx$34(StyledPage, null, meta && __jsx$34(MetaHead, {
    canonical: Canonical,
    brand: Brand.name,
    meta: meta
  }), __jsx$34(Container, {
    fluid: fluid
  }, pageHeading && __jsx$34(PageHeading, pageHeading), children));
};
...
var SidebarLayout = function SidebarLayout(_ref) {
  ...
  return __jsx$35(Container, {
    fluid: true
  }, __jsx$35(Row, null, __jsx$35(Column, {
    md: 2
  }, __jsx$35(Sidebar, null)), __jsx$35(Column, {
    md: 10,
    style: {
      padding: 0
    }
...
var FacebookPagePlugin = function FacebookPagePlugin(_ref) {
  var appId = _ref.appId,
      ...
      to = _ref.to,
      width = _ref.width;
  return __jsx$36(React.Fragment, null, iFrame && __jsx$36("iframe", {
...
var FacebookShareButton = function FacebookShareButton(_ref) {
  var appId = _ref.appId,
      ...
      size = _ref.size,
      to = _ref.to;
  return __jsx$37(React.Fragment, null, iFrame && __jsx$37("iframe", {
    allow: "encrypted-media",
    frameBorder: "0",
    height: "29",
    scrolling: "no",
...
var Article = function Article(_ref) {
  ...
  return __jsx$39(StyledArticle, {
    ...
    role: "article",
    style: style
  }, __jsx$39("header", null, __jsx$39(StyledImage$4, {
    alt: article.heading,
    src: article.image || "/static/blog/".concat(article.slug, "/hero.jpg")
  }), article.category && __jsx$39(Breadcrumb, {
    category: article.category,
    page: article.title,
    path: article.category
  }), config && article.category && __jsx$39(BlogCategory, {
    config: config,
    to: article.category
  }), __jsx$39(StyledHeading$4, {
    content: article.heading
  }), facebook && __jsx$39(BlogDetails, {
    article: article,
    config: config,
    facebook: facebook
  })), __jsx$39("span", {
...
var Error404 = function Error404() {
  ...
  return __jsx$3a(Page, {
    heading: "404 ERROR PAGE \u2013 NOT FOUND",
    meta: meta
  }, __jsx$3a("p", null, "The page you were looking for no longer exists or never did. Please use the links at the top of your screen to get back in the game, or click here to go home and start again."));
};
...
var BlogCard = function BlogCard(_ref) {
  ...
  })), __jsx$3b(StyledCardBody, {
    type: type
  }, type === 'normal' && category && __jsx$3b(BlogCategory, {
    config: config,
    to: category,
    type: type
  }), __jsx$3b(StyledContent$5, {
    type: type
  }, __jsx$3b(Link, {
    to: articleLink
  }, __jsx$3b(StyledHeading$5, {
    content: heading,
    tag: "h1",
    noWrap: true,
    type: type
  })), type === 'normal' && __jsx$3b("p", {
    itemProp: "description"
  }, excerpt)), type === 'normal' && __jsx$3b(React.Fragment, null, article.tags && __jsx$3b(TagsContainer, null, __jsx$3b(BlogTags, {
    tags: article.tags
  })), __jsx$3b(Divider, {
    size: "sm"
  }), author && __jsx$3b(BlogCategory, {
    author: true,
    to: author,
    config: config,
    type: type
  }), article.readtime && __jsx$3b(StyledReadTime, null, article.readtime, "min read time.")), __jsx$3b(Link, {
    to: articleLink
  }, __jsx$3b(StyledButton$9, {
    content: "Read more",
...
var StyledButton$9 = styled(Button).withConfig({
...
var BlogCategories = function BlogCategories(_ref) {
  ...
  return __jsx$3c("section", null, _find().map(function (articles, index) {
    return __jsx$3c(Fragment$1, {
      key: index
    }, __jsx$3c(Link, {
      to: {
    ...
    }, __jsx$3c(StyledHeading$6, {
      content: articles[0].category,
      tag: "h2"
    })), __jsx$3c(Row, null, articles.map(function (article, index) {
...
var BlogCategory = function BlogCategory(_ref) {
  var author = _ref.author,
      ...
      style = _ref.style,
      to = _ref.to;
  return __jsx$3d(StyledCategory, {
    className: className,
    style: style
  }, __jsx$3d(Link, {
    to: {
...
var BlogDetails = function BlogDetails(_ref) {
  var article = _ref.article,
      config = _ref.config,
      facebook = _ref.facebook;
  return __jsx$3e(StyledArticleDetails, null, __jsx$3e(Divider, {
    size: "sm"
  }), __jsx$3e(List, {
    inline: true,
    unstyled: true,
    ...
    context: "dark",
    icon: "stopwatch"
  }), __jsx$3e(BlogReadTime, {
    time: article.readtime
  }))), article.tags && __jsx$3e(BlogTags, {
    tags: article.tags
  }), __jsx$3e(Divider, {
    size: "sm"
  }), __jsx$3e(StyledShare, null, __jsx$3e(StyledShareText, null, "Share this article"), __jsx$3e(FacebookShareButton, {
...
var StyledIcon$b = styled(Icon).withConfig({
...
var BlogHero = function BlogHero(_ref) {
  ...
  return __jsx$3f(Row, null, renderHero());
};
BlogHero.propTypes = {
  articles: propTypes.any.isRequired,
  config: propTypes.object.isRequired,
...
var BlogListing = function BlogListing(_ref) {
  ...
  return __jsx$3g(Row, null, _find().map(function (article, index) {
    return __jsx$3g(Column, {
      key: index,
      md: 6
    }, __jsx$3g(BlogCard, {
      article: article,
...
var BlogReadTime = function BlogReadTime(_ref) {
  var time = _ref.time;
  return __jsx$3h("span", null, "Read time: ", time, " min(s)");
};
...
var BlogList = function BlogList(_ref) {
  var author = _ref.author,
      config = _ref.config,
      list = _ref.list;
  return __jsx$3i(StyledDl, null, list.map(function (_ref2, index) {
    var badge = _ref2.badge,
        _ref2$category = _ref2.category,
        category = _ref2$category === void 0 ? '' : _ref2$category,
        name = _ref2.name,
        to = _ref2.to;
    return __jsx$3i(Fragment$1, {
      key: index
    }, __jsx$3i(StyledDt, null, __jsx$3i(Badge, {
      content: badge
    })), __jsx$3i(StyledDd, null, __jsx$3i(Link, {
      to: {
...
var BlogSection = function BlogSection(_ref) {
  var children = _ref.children,
      heading = _ref.heading;
  return __jsx$3j(StyledSection, null, heading && __jsx$3j(React.Fragment, null, __jsx$3j(StyledHeading$7, {
    content: heading,
    context: "primary",
    noMargin: true,
    tag: "h3"
...
var BlogFindFood = function BlogFindFood(_ref) {
  ...
  return __jsx$3m(BlogSection, null, __jsx$3m(StyledContainer$a, {
    colour: colour
  }, __jsx$3m(StyledForm$1, {
    handleSubmit: handleSubmit(submit)
  }, __jsx$3m(FormLabel, {
    text: "Your favourite restaurants, delivered."
  }, __jsx$3m(InputGroup, null, __jsx$3m(FormField, {
    errors: errors,
    register: register,
    name: "postCode",
    placeholder: "Enter your postcode"
  }), __jsx$3m(InputGroupAddon, null, __jsx$3m(Button, {
    content: "Find food",
    style: {
      background: '#440063',
      borderColor: '#32004a'
    ...
    type: "submit"
  })), errors.postCode && __jsx$3m(FormError, {
    ...
    passHref: true,
    target: "_blank"
  }, __jsx$3m(StyledA$3, null, "Deliveroo ", __jsx$3m(Icon, {
    icon: "external-link"
  })))));
};
...
var StyledA$3 = styled.span.withConfig({
...
var BlogSidebar = function BlogSidebar(_ref) {
  var articles = _ref.articles,
      ...
      promo = _ref.promo,
      tags = _ref.tags;
  return __jsx$3q(StyledAside$1, null, findFood && __jsx$3q(BlogFindFood, null), media && __jsx$3q(BlogMedia, {
    media: media
  }), __jsx$3q(BlogSocial, {
    facebook: facebook
  }), promo && __jsx$3q(BlogPromo, {
    src: promo.src,
    to: promo.to
  }), __jsx$3q(BlogRecent, {
    articles: articles,
    config: config
  }), tags && __jsx$3q(BlogTagCloud, {
    articles: articles
  }), __jsx$3q(BlogArchive, {
    articles: articles,
    config: config
  }), __jsx$3q(BlogAuthor, {
    articles: articles,
...
var BlogSocial = function BlogSocial(_ref) {
  ...
  return __jsx$3r(React.Fragment, null, facebook && __jsx$3r(BlogSection, {
    heading: "Facebook"
  }, __jsx$3r(FacebookPagePlugin, {
    appId: facebook.appId,
    to: facebook.appPath,
    width: 349
  })), instagram && __jsx$3r(BlogSection, {
    heading: "Instagram"
  }, __jsx$3r("iframe", {
...
var __jsx$3s = React.createElement;
...
var BlogTagCloud = function BlogTagCloud(_ref) {
  ...
  var _find = function _find() {
    ...
    articles.map(function (_ref2) {
      ...
      var _iterator = _createForOfIteratorHelper$2(tags),
          _step;
...
var __jsx$3t = React.createElement;
var BlogTags = function BlogTags(_ref) {
  ...
  return __jsx$3t("div", null, tagMap());
};
BlogTags.propTypes = {
  tags: propTypes.array.isRequired
};

var __jsx$3u = React.createElement;
...
var MyApp = /*#__PURE__*/function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function elements() {
      ...
      return __jsx$3u(React.Fragment, null, __jsx$3u(ThemeStyle, null), user && __jsx$3u(UserProvider, null, __jsx$3u(AuthorizationProvider, null, __jsx$3u(InternationalisationProvider, null, __jsx$3u(NotificationsProvider, null, offCanvas ? __jsx$3u(OffCanvasProvider, null, this.layout()) : this.layout())))), !user && this.layout());
    }
  }, {
    key: "data",
    value: function data() {
      ...
      return __jsx$3u(React.Fragment, null, __jsx$3u(ConfigProvider, {
        config: config
      }, apolloClient ? __jsx$3u(ApolloProvider, {
        client: apolloClient
    ...
    value: function layout() {
      ...
      return __jsx$3u(Layout, null, pageProgressBar && __jsx$3u(PageProgressBar, {
        router: router
      }), __jsx$3u(Component, pageProps));
    }
  }, {
    key: "render",
    value: function render() {
      return __jsx$3u(ThemeProvider, {
