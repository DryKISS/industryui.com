import React, { useContext, createContext, useState, useEffect, useRef, useMemo, useDebugValue, createElement, memo, forwardRef, Children, cloneElement, useImperativeHandle, Component, Fragment as Fragment$1, Suspense as Suspense$1 } from 'react';
...
import { LinePropTypes, LineDefaultProps, ResponsiveLine } from '@nivo/line';
import { PiePropTypes, PieDefaultProps, ResponsivePie } from '@nivo/pie';
...
var AuthorizationProvider = function AuthorizationProvider(_ref) {
  ...
  return !isLoading && __jsx$1(AuthorizationContext.Provider, {
    value: {
      hasAccess: hasAccess,
      hasRole: hasRole
    }
...
var ConfigProvider = function ConfigProvider(props) {
  return __jsx$2(ConfigContext.Provider, _extends({
    value: props.config
  }, props));
};
...
var InternationalisationProvider = function InternationalisationProvider(_ref) {
  ...
  return __jsx$3(InternationalisationContext.Provider, {
    value: {
...
var NotificationsProvider = function NotificationsProvider(_ref) {
  ...
  return __jsx$4(NotificationsContext.Provider, {
    value: {
      items: items,
      user: user
    }
...
var useNotifications = function useNotifications(url) {
  ...
  //   return { data }
  // }
  var GET_NOTIFICATIONS = src(_templateObject());
...
var OffCanvasProvider = function OffCanvasProvider(_ref) {
  ...
  return __jsx$5(OffCanvasContext.Provider, {
    value: {
      show: handleShow,
      close: handleClose
    }
  }, children, __jsx$5(OffCanvas, {
    ...
    return __jsx$5(StyledWrapper, {
      key: i,
      show: i + 1 === dataManager.length
    }, d.content);
  })));
};
var StyledWrapper = Ve.div.withConfig({
 ...
 * Hooks - useForm
 *
 * Imported from react-hook-form package
 *
 */
...
var ThemeStyle = ze(_templateObject$1(), MEDIA_QUERY.desktop(_templateObject2()), function (props) {
...
var MetaHead = function MetaHead(_ref) {
  ...
  var description = meta.description,
      path = meta.path,
      title = meta.title;
  return __jsx$8(Head, null, __jsx$8("title", null, title, " | ", brand), __jsx$8("meta", {
    name: "description",
    content: description,
    key: "description"
  }), __jsx$8("meta", {
...
var Address = function Address(_ref) {
  var county = _ref.county,
      ...
      town = _ref.town;
  return __jsx$9(StyledAddress, null, __jsx$9("div", null, line1), line2 && __jsx$9("div", null, line2), line3 && __jsx$9("div", null, line3), __jsx$9("div", null, town), county && __jsx$9("div", null, county), __jsx$9("div", null, postcode), __jsx$9("div", null, country));
};
...
var Avatar = function Avatar(_ref) {
  ...
  return __jsx$a(StyledAvatar, {
    className: className,
    context: context,
    onClick: click,
    style: style,
    size: size
  }, children || avatarSrc && __jsx$a(Image$1, {
    alt: "Avatar",
    src: avatarSrc
  }) || getAcronym(content), action && __jsx$a(StyledAction, _extends({
    onClick: actionClick
  }, actionProps), action));
};
...
var Icon = function Icon(_ref) {
  ...
  return __jsx$b(StyledIcon, _extends({
    icon: [prefix, icon]
  }, props));
};
var StyledIcon = Ve(FontAwesomeIcon).withConfig({
...
var Blockquote = function Blockquote(_ref) {
  var footer = _ref.footer,
      text = _ref.text;
  return __jsx$e(StyledBlockquote, null, __jsx$e(StyledText, null, text), footer && __jsx$e(StyledFooter, null, footer));
};
...
var Button = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return __jsx$f(StyledButton, _extends({
    context: context,
    outline: outline,
    textContext: textContext,
    ref: ref,
    role: "button"
  }, props), startIcon && __jsx$f(Icon, _extends({
    icon: startIcon
  }, startIconProps)), text && __jsx$f(StyledContent, null, text), endIcon && __jsx$f(Icon, _extends({
    icon: endIcon
  }, endIconProps)));
});
...
var Details = function Details(_ref) {
  ...
  return __jsx$j(StyledDetails, _extends({
    open: open
  }, props), __jsx$j(StyledSummary, null, summary, props.button && __jsx$j(StyledButton$2, {
    content: props.button || 'Add New',
    context: "secondary",
    onClick: props.handleClick,
    size: "sm"
  }), Toolbar && __jsx$j(Toolbar, null)), __jsx$j(StyledBody, {
    style: style
  }, children));
};
...
var DetailsText = function DetailsText(_ref) {
  var content = _ref.content,
      text = _ref.text;
  return __jsx$k(React.Fragment, null, __jsx$k(Space, {
    marginBottom: "sm"
  }), __jsx$k(Text, {
    content: content,
    context: "dark",
    size: "sm"
  }), __jsx$k(Text, null, text));
};
...
var FigureImage = function FigureImage(_ref) {
  ...
  return __jsx$m(StyledImage, _extends({
    className: className,
    style: style
  }, props));
};
...
var Heading = function Heading(_ref) {
  ...
  return __jsx$r(StyledHeading, {
    ...
    rel: "bookmark",
    style: style
  }, content && content.__html ? __jsx$r("span", {
...
var Link = function Link(_ref) {
  ...
  return !validatorUri(to) ? __jsx$s(NextLink, _extends({}, obj, {
    passHref: passHref,
    replace: replace,
    scroll: scroll,
    shallow: shallow
...
var ListItem = function ListItem(_ref) {
  var border = _ref.border,
      ...
      prefix = _ref.prefix,
      style = _ref.style;
  return __jsx$u(StyledItem, {
    border: border,
    className: className,
    flush: flush,
    group: group,
    style: style
  }, icon && __jsx$u(StyledIcon$2, {
    "aria-hidden": "true",
    icon: icon,
    prefix: prefix,
    size: "2x"
...
var ProgressBar = function ProgressBar(props) {
  return __jsx$v(ProgressBarDiv, _extends({
...
var StyledSpace = Ve.div.withConfig({
  ...
  return margin === 'xs' && de(["margin:0.25rem;", ""], MEDIA_QUERY.desktop(_templateObject$2()));
}, function (_ref3) {
...
var Text = function Text(_ref) {
  ...
  return __jsx$x(StyledText$1, _extends({
    align: align,
    className: className,
    colour: colour,
    context: context,
...
var StyledText$1 = Ve.p.withConfig({
  ...
  var size = _ref9.size;
  return size === 'xxl' && de(["font-family:'JetBrains Mono ExtraBold';font-size:1.25rem;line-height:1.25;", " ", " ", " ", ""], MEDIA_QUERY.phone(_templateObject$3()), MEDIA_QUERY.tablet(_templateObject2$2()), MEDIA_QUERY.desktop(_templateObject3$1()), MEDIA_QUERY.giant(_templateObject4$1()));
}, function (_ref10) {
  var size = _ref10.size;
...
var Switch = function Switch(_ref) {
  ...
  return __jsx$y(StyledSwitchContainer, {
    context: context,
    disabled: disabled,
    onClick: handleToggle,
    size: size,
    toggled: toggled
  }, __jsx$y(StyledSwitch, {
    size: size,
    toggled: toggled
  }));
};
...
var Toggle = function Toggle(_ref) {
  ...
  return __jsx$z(StyledToggle, null, __jsx$z(Switch, {
    context: context,
    disabled: disabled,
...
var Tooltip = function Tooltip(_ref) {
  ...
  return __jsx$A(StyledTippy, _extends({
    content: content,
    context: context
  }, props), children);
};
var StyledTippy = Ve(Tippy).withConfig({
...
var CheckboxComponent = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return __jsx$B(StyledCheckbox, _extends({
...
var StyledCheckbox = Ve.input.withConfig({
...
var CheckboxField = function CheckboxField(_ref) {
  ...
  return __jsx$C(StyledFieldset, {
    error: errors[props.name]
  }, legend && __jsx$C("legend", null, legend), data.map(function (_ref2) {
    var disabled = _ref2.disabled,
        label = _ref2.label,
        data = _objectWithoutProperties(_ref2, ["disabled", "label"]);

    return __jsx$C(StyledLabel, {
      htmlFor: data.id,
      key: data.id,
      stacked: stacked
    }, __jsx$C(FieldHOC, _extends({
...
var StyledLabel = Ve.label.withConfig({
  ...
  return stacked && de(["display:block;margin:0.5rem 0;"]);
});
...
var DatePickerCalendar = function DatePickerCalendar(_ref) {
  ...
  return __jsx$D(Controller$1, {
    render: function render(props) {
      return __jsx$D(ReactDatePicker, _extends({
        customInput: __jsx$D(StyledInput, {
          errors: errors[name]
        }),
...
var DatePickerInput = function DatePickerInput(_ref) {
  ...
  return __jsx$E(React.Fragment, null, __jsx$E(Space, {
    marginBottom: "0.5rem"
  }, label), __jsx$E(Row, null, showDay && __jsx$E(Column, {
    md: 4
  }, __jsx$E(SelectField, _extends({}, defaultOptions, {
    data: {
      'data-index': index,
      'data-name': 'day'
    },
...
var Accept = function Accept(_ref) {
  ...
  return __jsx$F("em", null, "(Only ", files, " will be accepted)");
};
Accept.propTypes = {
...
var DropzonePreview = function DropzonePreview(_ref) {
  var file = _ref.file,
      ...
      index = _ref.index;
  return __jsx$G(StyledPreview, null, __jsx$G(Close, {
    click: handleRemove
  }), __jsx$G(Image$1, {
...
var StyledPreview = Ve.div.withConfig({
...
var Dropzone = function Dropzone(_ref) {
  ...
  var thumbs = function thumbs() {
    return __jsx$H(StyledContainer, {
      fluid: true
    }, __jsx$H(Row, null, files.map(function (file) {
      return __jsx$H(Column, {
        md: 3,
        key: file.name
      }, __jsx$H(DropzonePreview, {
        file: file,
  ...
  return __jsx$H(React.Fragment, null, __jsx$H(StyledContainer, _extends({
    dragActive: isDragActive,
    dragAccept: isDragAccept,
    dragReject: isDragReject,
    disabled: disabled
  }, getRootProps()), __jsx$H("input", getInputProps()), isDragAccept && __jsx$H(Text, null, "Accepted"), isDragReject && __jsx$H(Text, null, "Rejected"), isDragActive ? __jsx$H(Text, null, "Drop here") : __jsx$H(React.Fragment, null, __jsx$H(Text, null, "Drop, or click to select"), accept && __jsx$H(Accept, {
    accept: accept
  }), multiple ? __jsx$H(Text, null, "Accepts multiple files") : __jsx$H(Text, null, "Single file only"))), files.length > 0 && thumbs());
};
var StyledContainer = Ve.div.withConfig({
  ...
  return disabled && de(["cursor:not-allowed;opacity:0.5;"]);
});
Dropzone.propTypes = {
...
var DropzoneField = function DropzoneField(_ref) {
  ...
  return __jsx$J(Controller$1, _extends({
    as: Dropzone,
    control: control,
    name: name
  }, props));
...
var FormError = function FormError(_ref) {
  ...
  return __jsx$K(Space, {
    marginTop: SIZE.XS
  }, __jsx$K(StyledSmall, {
    color: colour
  }, message));
};
var StyledSmall = Ve.small.withConfig({
  displayName: "error__StyledSmall",
  componentId: "iamyx7-0"
...
var CurrencyInput = function CurrencyInput(_ref) {
  var currencySymbol = _ref.currencySymbol,
      ...
      theme = _ref.theme,
      vat = _ref.vat;
  return __jsx$L(FormLabel, {
    show: show,
    label: label
  }, __jsx$L(InputGroup, {
    theme: theme,
    error: errors[name]
  }, __jsx$L(InputGroupAddon, {
    addonType: "prepend",
    error: errors[name],
    text: true,
    theme: theme,
    size: size
  }, currencySymbol), __jsx$L(FormField, {
    errors: errors,
    min: min,
    name: name,
    register: register,
...
var FormField = function FormField(_ref) {
  ...
  return __jsx$M(FieldHOC, _extends({
    "aria-label": name,
...
var StyledInput = Ve.input.attrs(function (props) {
  return {
    autoComplete: 'off',
    autoFocus: false
  };
  ...
  return errors && de(["", ""], function (props) {
    return ERROR_STYLE(props);
  });
}, function (_ref3) {
  var size = _ref3.size;
  ...
  switch (size) {
    case SIZE.SM:
      return de(["height:1.5rem;font-size:0.625rem;"]);

    case SIZE.MD:
      return de(["height:1.875rem;"]);

    case SIZE.LG:
      return de(["height:2.25rem;"]);
...
var PercentInput = function PercentInput(_ref) {
  var errors = _ref.errors,
      ...
      show = _ref.show,
      symbol = _ref.symbol;
  return __jsx$N(FormLabel, {
    show: show,
    label: label
  }, __jsx$N(InputGroup, null, __jsx$N(FormField, {
    errors: errors,
    name: name,
    register: register,
    step: "any",
    type: "number"
  }), __jsx$N(InputGroupAddon, {
    addonType: "append",
    text: true
  }, symbol)));
};
...
var Form = function Form(_ref) {
  var children = _ref.children,
      ...
      id = _ref.id,
      style = _ref.style;
  return __jsx$O(StyledForm, {
    style: style,
    id: id,
    onSubmit: handleSubmit
  }, children);
};
var StyledForm = Ve.form.withConfig({
  displayName: "form__StyledForm",
  componentId: "sc-1xzfw2m-0"
})(["margin-bottom:1rem;"]);
Form.propTypes = {
  children: propTypes.node.isRequired,
...
var FieldHOC = function FieldHOC(_ref) {
  ...
  return __jsx$P(React.Fragment, null, __jsx$P(Component, _extends({
  ...
  }, props), children), helperMessage && __jsx$P(Space, {
    marginTop: SIZE.SM,
    marginBottom: SIZE.XS
  }, __jsx$P(Text, {
    size: SIZE.XS,
    context: "default"
  }, helperMessage)), showError && __jsx$P(FormError, {
...
var Input = function Input(_ref) {
  ...
  return __jsx$Q(Wrapper, {
    theme: props.theme,
    decoration: decoration,
    readOnly: props.readOnly
  }, label && __jsx$Q(React.Fragment, null, __jsx$Q(Space, {
    marginBottom: "xs"
  }, __jsx$Q(StyledLabel$1, {
    theme: props.theme,
    content: label
  }))), __jsx$Q(Space, {
    marginBottom: "xs"
  }, __jsx$Q(InputWrapper, {
    size: size
  }, (adornments === null || adornments === void 0 ? void 0 : adornments.startAdornment) && __jsx$Q(Adornment, {
    startAdornment: true,
    size: size
  }, adornments.startAdornment), __jsx$Q(StyledInput$1, _extends({
  ...
  }, props)), (adornments === null || adornments === void 0 ? void 0 : adornments.endAdornment) && __jsx$Q(Adornment, {
    size: size
  }, adornments.endAdornment))), message && __jsx$Q(StyledMessage, null, message));
};
var StyledLabel$1 = Ve(Text).withConfig({
...
var StyledMessage = Ve(Text).withConfig({
...
var InputWrapper = Ve.div.withConfig({
  ...
  switch (size) {
    case SIZE.SM:
      return de(["height:1.5rem;", "{padding:0.5rem 1rem;}"], Adornment);

    case SIZE.MD:
      return de(["height:1.875rem;._,", "{padding:0.75rem 1.25rem;}"], Adornment);

    case SIZE.LG:
      return de(["height:2.25rem;.__,", "{padding:0.875rem 1.625rem;}"], Adornment);

    default:
      return de(["height:1.875rem;.___,", "{padding:0.75rem 1.25rem;}"], Adornment);
  }
});
var withAdornmentStyles = de(["", ""], function (_ref5) {
  var adornments = _ref5.adornments;
  return adornments && de(["", " ", ""], adornments.startAdornment && de(["border-bottom-left-radius:0;border-top-left-radius:0;"]), adornments.endAdornment && de(["border-bottom-right-radius:0;border-top-right-radius:0;"]));
});
var StyledInput$1 = Ve.input.attrs(function (props) {
  return {
    'aria-label': props.name,
    autoComplete: 'off',
    autoFocus: false
...
var Wrapper = Ve.div.withConfig({
  ...
  var decoration = _ref9.decoration,
      ...
      theme = _ref9.theme;
  return de(["", "{color:", ";}", ",", "{border-color:", ";", "}", "{background-color:", ";}"], StyledMessage, decoration === InputDecorationTypes.DEFAULT || decoration === InputDecorationTypes.WARNING || decoration === InputDecorationTypes.READONLY ? colourProvider(theme, 'dark') : colourProvider(theme, decoration), StyledInput$1, Adornment, decoration !== InputDecorationTypes.DEFAULT ? colourProvider(theme, decoration) : colourProvider(theme, 'dark'), decoration === InputDecorationTypes.READONLY || readOnly === true && de(["background:transparent;pointer-events:none;"]), Adornment, colourProvider(theme, decoration));
});
Input.propTypes = {
...
var Adornment = Ve.div.withConfig({
  ...
  return startAdornment ? de(["border-bottom-left-radius:'0.25rem';border-right:none;border-top-left-radius:'0.25rem';"]) : de(["border-bottom-right-radius:'0.25rem';border-left:none;border-top-right-radius:'0.25rem';"]);
});
...
var InputGroupAddon = function InputGroupAddon(_ref) {
  var addonType = _ref.addonType,
      ...
      text = _ref.text,
      theme = _ref.theme;
  return __jsx$R(StyledInputGroupAddon, {
    addonType: addonType,
    className: addonType,
    children: children,
    context: context,
...
var StyledInputGroupAddon = Ve.div.withConfig({
  displayName: "addon__StyledInputGroupAddon",
  componentId: "sc-143wx32-0"
})(["align-items:center;display:flex;& > *{height:100%;padding:0 1.5rem;}", " ", " &,button{", " ", "}"], function (_ref2) {
  var text = _ref2.text;
  return text && de(["transition:background-color 0.15s linear;background-color:", ";border:1px solid ", ";border-radius:", ";color:", ";display:flex;font-size:0.75rem;font-weight:400;line-height:1;margin-bottom:0;padding:0.375rem 1.25rem;text-align:center;white-space:nowrap;"], function (_ref3) {
    var theme = _ref3.theme,
        error = _ref3.error;
  ...
  var size = _ref7.size;
  return size === SIZE.SM && de(["font-size:0.625rem;padding:0 0.75rem;"]);
}, function (_ref8) {
  var addonType = _ref8.addonType;
  return addonType === 'prepend' && de(["border-top-right-radius:0;border-bottom-right-radius:0;"]);
}, function (_ref9) {
  var addonType = _ref9.addonType;
  return addonType === 'append' && de(["border-top-left-radius:0;border-bottom-left-radius:0;"]);
});
...
var InputGroup = function InputGroup(_ref) {
  var children = _ref.children,
      ...
      size = _ref.size,
      theme = _ref.theme;
  return __jsx$S(StyledInputGroup, {
    children: children,
    error: error,
    size: size,
    theme: theme
...
var StyledInputGroup = Ve.div.withConfig({
  ...
  var error = _ref2.error,
      theme = _ref2.theme;
  return error && theme && de(["&:hover{.prepend,.append{background:", ";border-color:", ";}}"], theme.COLOUR.lightRed, theme.COLOUR.lightRed);
});
...
var StyledLabel$2 = Ve.label.withConfig({
  displayName: "label__StyledLabel",
  componentId: "sc-1im4g6b-0"
...
var RadioComponent = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return __jsx$U(StyledInput$2, _extends({
    className: "Form-control",
    disabled: disabled,
    type: "radio",
    ref: ref
...
var StyledInput$2 = Ve.input.withConfig({
...
var RadioField = function RadioField(_ref) {
  ...
  return __jsx$V(StyledFieldset$1, {
    error: errors[props.name]
  }, legend && __jsx$V(StyledLegend, {
    error: errors[props.name]
    ...
    return __jsx$V(StyledLabel$3, {
      htmlFor: data.id,
      key: data.id,
      stacked: stacked
    }, __jsx$V(FieldHOC, _extends({
...
var StyledFieldset$1 = Ve.fieldset.withConfig({
...
var StyledLegend = Ve.legend.withConfig({
  displayName: "radio__StyledLegend",
  componentId: "wmvn6q-1"
})(["", ""], function (_ref4) {
  var error = _ref4.error;
  return error && de(["padding:0 0.5rem;"]);
});
var StyledLabel$3 = Ve.label.withConfig({
...
var ReactSelectField = function ReactSelectField(_ref) {
  ...
  var Component = /*#__PURE__*/forwardRef(function (data, ref) {
    if (async) {
      return __jsx$W(AsyncSelect, _extends({
      ...
      return __jsx$W(Select, _extends({
        ref: ref
      }, data));
    }
  });
  return __jsx$W(Wrapper$1, {
    size: size,
    error: error || errors[name]
  }, __jsx$W(Controller$1, {
    render: function render(props) {
      return __jsx$W(Component, _extends({
        options: options,
...
var Wrapper$1 = Ve.div.withConfig({
  ...
  switch (size) {
    case SIZE.SM:
      return de(["height:1.5rem;"]);

    case SIZE.MD:
      return de(["height:1.875rem;"]);

    case SIZE.LG:
      return de(["height:2.25rem !important;"]);
  ...
  var error = _ref4.error;
  return error && de(["[class*='control']{", "}"], function (props) {
    return ERROR_STYLE(props);
  });
});
...
var Search = function Search(_ref) {
  var appendSearchButton = _ref.appendSearchButton,
      ...
      register = _ref.register,
      type = _ref.type;
  return __jsx$X(InputGroup, null, prependSearchIcon && __jsx$X(InputGroupAddon, {
    addonType: "prepend",
    text: true
  }, __jsx$X(Icon, {
    icon: "search",
    ...
    register: register,
    type: type
  }), appendSearchIcon && __jsx$X(InputGroupAddon, {
    addonType: "append",
    text: true
  }, __jsx$X(Icon, {
    icon: "search",
    prefix: prefix
  })), appendSearchButton && __jsx$X(InputGroupAddon, {
    addonType: "append"
  }, __jsx$X(Button, {
...
var SelectCountryField = function SelectCountryField(_ref) {
  ...
  return __jsx$Y(SelectField, _extends({
    errors: errors,
    name: name,
    options: COUNTRY,
    register: register
...
var SelectField = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var renderRange = function renderRange() {
    ...
    _range(range[1], range[0]).map(function (i) {
      return options.push(__jsx$Z("option", {
        key: "range".concat(i),
        value: i
      }, i));
    });
  ...
  var renderOptions = function renderOptions(items) {
    ...
    return options.map(function (_ref2) {
      ...
      if (group) {
        return __jsx$Z("optgroup", {
          key: "option".concat(group),
          label: group
        }, renderOptions(items));
      }

      return __jsx$Z("option", {
        children: text,
        disabled: disabled,
  ...
  return __jsx$Z(FieldHOC, _extends({
...
var StyledSelect = Ve.select.withConfig({
...
var TextareaField = function TextareaField(_ref) {
  var autoFocus = _ref.autoFocus,
      ...
      wrap = _ref.wrap,
      props = _objectWithoutProperties(_ref, ["autoFocus", "className", "cols", "dir", "disabled", "errors", "maxLength", "name", "placeholder", "readOnly", "rows", "size", "spellCheck", "tabIndex", "wrap"]);

  return __jsx$_(FieldHOC, _extends({
    component: StyledTextarea,
    autoFocus: autoFocus,
    className: "".concat(className, " Form-control Textarea"),
    cols: cols,
    dir: dir,
    disabled: disabled,
    errors: errors[name],
...
var StyledTextarea = Ve.textarea.withConfig({
  displayName: "textarea__StyledTextarea",
  componentId: "sc-1if6n1n-0"
  ...
  var size = _ref4.size;
  return size === SIZE.SM && de(["font-size:0.625rem;"]);
});
...
var StyledAccordion = Ve.div.withConfig({
...
var AccordionItem = /*#__PURE__*/memo(function (_ref) {
  var children = _ref.children,
      ...
      open = _ref.open,
      title = _ref.title;
  return __jsx$10(StyledAccordionItem, {
    className: className
  }, __jsx$10(Header, {
...
var HeaderIcon = Ve(Icon).withConfig({
  displayName: "accordionItem__HeaderIcon",
  componentId: "sc-8aj890-2"
})(["float:right;"]);
var Content = Ve.div.withConfig({
...
var Alert = function Alert(_ref) {
  ...
  return visible && __jsx$11(StyledAlert, {
    className: className,
    context: context,
    style: style
  }, close && __jsx$11(StyledClose, {
    click: handleClose,
    context: "white",
    header: header,
    icon: "times"
  }), header && __jsx$11(AlertHeader, {
    context: context,
    header: header,
    icon: icon,
    iconPrefix: iconPrefix
  }), __jsx$11(AlertContent, {
    content: content,
    icon: header ? null : icon,
    iconPrefix: iconPrefix
  }));
};
var StyledAlert = Ve.div.withConfig({
...
var StyledClose = Ve(Close).withConfig({
...
var AlertContent = function AlertContent(_ref) {
  var content = _ref.content,
      icon = _ref.icon,
      iconPrefix = _ref.iconPrefix;
  return __jsx$12(StyledAlertContent, null, icon && __jsx$12(Icon, {
    "aria-hidden": "true",
    context: "help",
    icon: icon,
    prefix: iconPrefix
...
var StyledAlertContent = Ve.div.withConfig({
...
var StyledHeader = Ve.div.withConfig({
...
var Breadcrumb = function Breadcrumb(_ref) {
  ...
  return __jsx$14("nav", {
    ...
    itemScope: "itemscope",
    itemType: "http://schema.org/Thing"
  }, categoryFormatted)), __jsx$14("meta", {
    itemProp: "position",
    content: "2"
  })), __jsx$14(StyledLi, {
    "aria-current": "page",
...
var StyledA = Ve.span.withConfig({
  displayName: "breadcrumb__StyledA",
  componentId: "asbyh2-0"
})(["color:#fff;&:hover{color:#00ccbc;}"]);
var StyledOl = Ve.ol.withConfig({
  displayName: "breadcrumb__StyledOl",
  componentId: "asbyh2-1"
...
var StyledLi = Ve.li.withConfig({
  displayName: "breadcrumb__StyledLi",
  componentId: "asbyh2-2"
...
var Buttons = function Buttons(_ref) {
  ...
  return __jsx$15(React.Fragment, null, __jsx$15(Divider, {
    size: "sm"
  }), back && __jsx$15(Link, {
    to: pathBack
  }, __jsx$15(Button, {
    context: "secondary",
    size: "lg"
  }, backText)), next && __jsx$15("div", {
    className: "float-right"
  }, pathNext && __jsx$15(Link, {
    to: pathNext
  }, __jsx$15(Button, {
    context: "primary",
    size: "lg"
  }, nextText)), !pathNext && __jsx$15(Button, {
    context: "primary",
    disabled: nextDisabled,
    size: "lg",
    type: "submit"
  }, nextText)), __jsx$15("div", {
    style: {
      clear: 'both',
      marginBottom: '1rem'
    }
...
var CardCTA = function CardCTA(_ref) {
  ...
  var CtaButton = function CtaButton(props) {
    return __jsx$16(StyledButton$3, _extends({
      content: title,
      context: "secondary"
    }, props));
  };

  return link ? __jsx$16(Link, {
    border: false,
    passHref: true,
    to: link
  }, __jsx$16(CtaButton, null)) : __jsx$16(CtaButton, {
    onClick: func
  });
};
var StyledButton$3 = Ve(Button).withConfig({
...
var CardBody = function CardBody(_ref) {
  ...
  return __jsx$17(StyledBody$1, {
    className: className,
    center: center
  }, title && __jsx$17(StyledWrapper$1, null, __jsx$17(StyledTitle, {
    content: title,
    noWrap: titleNoWrap,
    tag: "h2"
  })), (children || showCta) && __jsx$17(StyledContent$1, {
    context: context
  }, children, showCta && __jsx$17(CardCTA, {
    func: ctaFunc,
    link: ctaLink,
    title: ctaTitle
  })));
};
var StyledBody$1 = Ve.div.withConfig({
...
var Card = function Card(_ref) {
  ...
  var card = function card() {
    return __jsx$18(StyledCard, {
      ...
      shadow: shadow,
      style: style
    }, close && __jsx$18(Close, {
      click: close
    }), image && __jsx$18(CardImage, {
      alt: alt,
      src: image
    }), header && __jsx$18(CardHeader, {
      content: header,
      context: footerContext
    }), icon && __jsx$18(StyledIcon$3, {
      icon: icon,
      size: "4x"
    }), (title || body) && __jsx$18(CardBody, {
      center: center,
      children: body,
      context: context,
      ctaFunc: ctaFunc,
    ...
    }), children, footer && __jsx$18(CardFooter, {
      children: footer,
      context: footerContext
    }));
  };
...
var StyledCard = Ve.div.withConfig({
  ...
  var deck = _ref7.deck;
  return deck && MEDIA_QUERY.desktop(_templateObject$4());
});
var StyledIcon$3 = Ve(Icon).withConfig({
...
var CardDecks = function CardDecks(_ref) {
  var children = _ref.children;
  return __jsx$19(StyledDecks, null, children);
};
var StyledDecks = Ve.div.withConfig({
  displayName: "decks__StyledDecks",
  componentId: "sc-1or8ba2-0"
})(["display:flex;flex-direction:column;", ""], MEDIA_QUERY.desktop(_templateObject$5()));
CardDecks.propTypes = {
  children: propTypes.node.isRequired
};
...
var CardFooter = function CardFooter(_ref) {
  var children = _ref.children,
      context = _ref.context;
  return __jsx$1a(StyledFooter$1, {
    context: context
  }, children);
};
var StyledFooter$1 = Ve.div.withConfig({
...
var CardHeader = function CardHeader(_ref) {
  var content = _ref.content,
      context = _ref.context;
  return __jsx$1b(StyledHeader$1, {
    context: context
  }, content);
};
var StyledHeader$1 = Ve.h2.withConfig({
  displayName: "header__StyledHeader",
...
var CardImage = function CardImage(_ref) {
  var alt = _ref.alt,
      header = _ref.header,
      src = _ref.src;
  return __jsx$1c(StyledContainer$1, null, __jsx$1c(StyledImage$1, {
    alt: alt,
    fluid: false,
...
var StyledContainer$1 = Ve.div.withConfig({
...
var StyledImage$1 = Ve(Image$1).withConfig({
  displayName: "image__StyledImage",
...
var BarChart = qe(BarComponent); // override 'withTheme(BarComponent)'
...
var LineChart = qe(function (_ref) {
  var theme = _ref.theme,
      props = _objectWithoutProperties(_ref, ["theme"]);
  ...
  var colorScheme = props.colorScheme,
      ...
      showLegend = props.showLegend;
  return __jsx$1e(ResponsiveLine, {
...
var CarouselArrow = function CarouselArrow(_ref) {
  ...
  return __jsx$1g(StyledContainer$2, {
    direction: direction,
    onClick: clickFunction
  }, __jsx$1g(StyledArrow, {
    context: context,
    icon: icon,
    position: position
  }));
};
var StyledContainer$2 = Ve.div.withConfig({
...
var StyledArrow = Ve(Icon).withConfig({
  ...
  return position === 'top' && de(["align-self:flex-start;"]);
}, function (_ref7) {
  var position = _ref7.position;
  return position === 'bottom' && de(["align-self:flex-end;"]);
});
...
var CarouselSlide = function CarouselSlide(_ref) {
  var children = _ref.children,
      onClick = _ref.onClick,
      style = _ref.style;
  return __jsx$1h(StyledSlide, {
    onClick: onClick,
    style: style
  }, children);
};
var StyledSlide = Ve.div.withConfig({
...
var CarouselSampleSlide = function CarouselSampleSlide(_ref) {
  ...
  return __jsx$1i(CarouselSlide, null, node, text && __jsx$1i(StyledText$2, {
    content: text,
    context: context,
    size: "xl"
  }), img && __jsx$1i(Image$1, {
    src: img
  }));
};
var StyledText$2 = Ve(Text).withConfig({
...
var Carousel = function Carousel(_ref) {
  ...
  var renderPagination = function renderPagination() {
    return __jsx$1j(PaginationWrapper, null, __jsx$1j(Pagination, _extends({
      ...
      prevLabel: __jsx$1j(Icon, {
        icon: "chevron-left"
      }),
      nextLabel: __jsx$1j(Icon, {
        icon: "chevron-right"
      }),
      size: "xs"
    }, paginationProps)));
  ...
  return __jsx$1j(React.Fragment, null, __jsx$1j(Wrapper$2, {
    width: width,
    height: height,
    fullWidth: fullWidth
  }, hasNavigation && showArrows && __jsx$1j(CarouselArrow, {
    context: arrowContext,
    clickFunction: previousSlide,
    direction: "left",
    icon: leftArrowIcon,
    position: arrowPosition
  }), slides ? __jsx$1j(CarouselSampleSlide, current) : current || children, hasNavigation && showPagination && paginationPosition === 'inside' && renderPagination(), hasNavigation && showArrows && __jsx$1j(CarouselArrow, {
    context: arrowContext,
...
var Wrapper$2 = Ve.div.withConfig({
...
var PaginationWrapper = Ve.div.withConfig({
  ...
  var renderLinks = function renderLinks() {
    return links.map(function (_ref2, index) {
      ...
      return __jsx$1k(Link, {
        ...
        passHref: true,
        to: to
      }, __jsx$1k(StyledLink$1, null, name));
    });
  };

  return __jsx$1k(StyledCopyright, {
    fixed: fixed,
    "data-cy": "copyright"
  }, __jsx$1k(StyledContainer$3, null, __jsx$1k(Row, null, __jsx$1k(Column, {
    md: links.length > 0 ? 3 : 12
  }, __jsx$1k(StyledBrand, null, __jsx$1k(StyledIcon$4, icon), year, " \u2014 ", brand)), links.length > 0 && __jsx$1k(Column, {
    md: 9
  }, renderLinks()))));
};
var StyledCopyright = Ve.section.withConfig({
  ...
  return fixed && de(["bottom:0;position:fixed;left:0;width:100%;z-index:1;"]);
});
var StyledContainer$3 = Ve(Container).withConfig({
  displayName: "copyright__StyledContainer",
  componentId: "yqlm33-1"
})(["height:3.5rem;"]);
var StyledBrand = Ve.div.withConfig({
  displayName: "copyright__StyledBrand",
  componentId: "yqlm33-2"
})(["display:flex;justify-content:center;"]);
var StyledIcon$4 = Ve(Icon).withConfig({
  displayName: "copyright__StyledIcon",
  componentId: "yqlm33-3"
})(["margin:auto 0;padding-right:0.25rem;"]);
var StyledLink$1 = Ve.span.withConfig({
...
var DogCard = function DogCard(_ref) {
  ...
  }, __jsx$1l(CardBody, null, __jsx$1l(DogName, {
    row: {
      gender: gender,
      name: name
    }
...
var DogName = function DogName(_ref) {
  var _ref$row = _ref.row,
      ...
      name = _ref$row.name;
  return __jsx$1n(React.Fragment, null, __jsx$1n(Icon, {
    context: gender,
...
var Actions = function Actions(_ref) {
  ...
  return __jsx$1o(React.Fragment, null, __jsx$1o(ButtonToolbar, {
    className: "float-right"
...
var TableDogs = function TableDogs(_ref) {
  var dogs = _ref.dogs,
      path = _ref.path;
  return __jsx$1p(Table, {
    columns: Columns(function (row) {
      return __jsx$1p(Actions, {
        path: path,
        row: row
      });
    }, function (row) {
      return __jsx$1p(DogName, {
        row: row
      });
    }),
    rows: dogs
...
var Dropdown = function Dropdown(_ref) {
  ...
  return __jsx$1q(StyledDropdown, {
    className: className,
    ref: node
  }, __jsx$1q(StyledToggle$1, {
    className: "".concat(open ? 'dropdown--active' : '', " dropdown--toggle"),
    onClick: function onClick() {
      return setOpen(!open);
    }
  }, children, caret && __jsx$1q(Icon, {
    "aria-hidden": "true",
    className: "dropdown--caret",
    icon: position === Position.Top ? 'carat-up' : 'caret-down',
    prefix: "fas"
  }), items && open && __jsx$1q(DropdownMenu, {
...
var StyledDropdown = Ve.div.withConfig({
  displayName: "dropdown__StyledDropdown",
  componentId: "tcetc7-0"
})(["display:inline-block;position:relative;"]);
var StyledToggle$1 = Ve.div.withConfig({
...
var DropdownMenu = function DropdownMenu(_ref) {
  ...
  return __jsx$1r(StyledDropdownMenu, {
    elementType: elementType,
    className: "dropdown--menu",
    position: position
  }, __jsx$1r(TooltipRectangle, {
    position: position
  }), items.map(function (item) {
    return __jsx$1r(DropdownItem, {
...
var StyledDropdownMenu = Ve.div.withConfig({
  displayName: "menu__StyledDropdownMenu",
  componentId: "sc-11f1boj-0"
})(["background:#fff;border:1px solid rgba(0,0,0,0.15);border-radius:0.25rem;left:0;margin-top:1px;min-width:8rem;padding:0.5rem 0;position:absolute;top:100%;z-index:1;", " ", ""], function (_ref2) {
  var position = _ref2.position;
  return position && de(["left:", ";right:", ";", ""], position === Position.Right ? 'auto' : '0', position === Position.Right ? '0' : 'auto', position === Position.Top && de(["bottom:100%;top:unset;"]));
}, function (_ref3) {
  var elementType = _ref3.elementType;
  return (elementType === elementTypes.Colour || elementType === elementTypes.Icon) && de(["box-shadow:rgba(0,0,0,0.15) 0px 3px 12px;display:grid;padding:5px;grid-template-columns:repeat(8,2rem);grid-template-rows:repeat(3,2rem);"]);
});
var dist = '0.625rem';
var size = '0.875rem';
var TooltipRectangle = Ve.div.withConfig({
  displayName: "menu__TooltipRectangle",
  componentId: "sc-11f1boj-1"
})(["border-color:transparent transparent rgb(255,255,255);border-image:initial;border-style:solid;border-width:0.438rem;position:absolute;", ""], function (_ref4) {
  var position = _ref4.position;

  switch (position) {
    case Position.Bottom:
      return de(["top:-", ";left:", ";"], size, dist);

    case Position.Top:
      return de(["bottom:-", ";left:", ";transform:rotateX(180deg);"], size, dist);

    case Position.Left:
      return de(["display:none;bottom:", ";right:-", ";transform:rotateZ(90deg);"], size, size);

    case Position.Right:
      return de(["display:none;bottom:", ";left:-", ";transform:rotateZ(-90deg);"], size, size);
  }
});
...
var DropdownItem = function DropdownItem(_ref2) {
  ...
  switch (elementType) {
    case elementTypes.List:
      return __jsx$1s(StyledDropdownItem, {
        divider: item.divider
      }, item.divider ? __jsx$1s(StyledDivider, null) : renderItem$1(item, closeDropdown, _onClick));

    case elementTypes.Colour:
      return __jsx$1s(StyledColourItem, {
        colour: item.colour,
        onClick: function onClick() {
          _onClick(item);
        }
    ...
    case elementTypes.Icon:
      return __jsx$1s(StyledIconItem, {
        onClick: _onClick
      }, __jsx$1s(Icon, {
        fixedWidth: false,
...
var StyledIconItem = Ve.div.withConfig({
...
var _parser = _interopRequireDefault(parser$2);
...
var GetAddress = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var postcodeAddresses = function postcodeAddresses() {
    if (loading) {
      if (addresses.data.length > 0) {
        ...
        return __jsx$1u(React.Fragment, null, __jsx$1u("p", null), __jsx$1u(FormLabel, {
          label: "Select your address"
        }, __jsx$1u(SelectField, {
  ...
  return __jsx$1u(React.Fragment, null, input(), button(), renderError(), postcodeAddresses(), addressDetails());
});
...
var HeroButtons = function HeroButtons(_ref) {
  ...
  return buttons.map(function (_ref2, index) {
    var content = _ref2.content,
        context = _ref2.context,
        to = _ref2.to;
    return __jsx$1v(StyledLink$3, {
      border: false,
      to: to,
      key: index
    }, __jsx$1v(StyledButton$4, {
      content: content,
      context: context,
      size: "lg"
    }));
...
var StyledButton$4 = Ve(Button).withConfig({
  displayName: "buttons__StyledButton",
  componentId: "sc-5e7u5g-0"
})(["margin-right:1rem;"]);
var StyledLink$3 = Ve(Link).withConfig({
...
var HeroImage = function HeroImage(_ref) {
  var alt = _ref.alt,
      ...
      image = _ref.image,
      width = _ref.width;
  return __jsx$1w(StyledColumn$1, {
    align: align,
    md: 6
  }, __jsx$1w(StyledImageContainer, null, __jsx$1w(StyledImage$2, {
    alt: alt,
    src: image,
    width: width
  })));
};
var StyledColumn$1 = Ve(Column).withConfig({
...
var bl = de(["left:6rem;bottom:0;"]);
var br = de(["right:6rem;bottom:0;"]);
var tl = de(["left:6rem;top:0;"]);
var tr = de(["right:6rem;top:0;"]);
var StyledCard$1 = Ve(Card).withConfig({
  ...
  return offset;
}, MEDIA_QUERY.desktop(_templateObject$6()), function (_ref3) {
...
var Hero = function Hero(_ref) {
  ...
  var renderLeft = function renderLeft() {
    return __jsx$1y(StyledColumn$2, {
      md: 6
    }, title && __jsx$1y(StyledTitle$1, {
      tag: "h1",
      content: title
    }), strapline && __jsx$1y(StyledStrapline, {
      tag: "h2",
      content: strapline
    }), buttons && __jsx$1y(HeroButtons, {
      buttons: buttons
    }), message && __jsx$1y("p", {
      children: message
    }));
  ...
  return __jsx$1y(StyledHero, {
    background: background,
    backgroundSize: backgroundSize,
    className: className,
    height: height
  }, children && children, !children && __jsx$1y(Container, null, __jsx$1y(Row, null, title && renderLeft(), image && __jsx$1y(HeroImage, {
    alt: alt,
    align: align,
    image: image,
    width: width
...
var StyledHero = Ve.header.withConfig({
...
var StyledColumn$2 = Ve(Column).withConfig({
  displayName: "hero__StyledColumn",
  componentId: "rxajoc-1"
})(["margin:0 auto;text-align:center;", ""], MEDIA_QUERY.desktop(_templateObject$7()));
var StyledTitle$1 = Ve(Heading).withConfig({
  displayName: "hero__StyledTitle",
  componentId: "rxajoc-2"
})(["line-height:2.75rem;", ""], MEDIA_QUERY.desktop(_templateObject2$3()));
var StyledStrapline = Ve(Heading).withConfig({
...
var ImageMarker = function ImageMarker(_ref) {
  ...
  var coordinates = _ref.coordinates,
      styles = _ref.styles;
  return (styles === null || styles === void 0 ? void 0 : styles.shape) ? __jsx$1z(StyledIcon$5, {
    ...
    styles: styles,
    size: "lg"
  }) : __jsx$1z(StyledMarker, {
    coordinates: coordinates,
    styles: styles
  });
};
var blinker = Ge(["50%{opacity:0;}"]);
var commonMarkerCss = de(["animation:", ";margin-left:", ";margin-top:", ";pointer-events:none;position:absolute;transition-duration:0.2s;transition-property:left,top;", ""], function (_ref2) {
  var styles = _ref2.styles;
  return (styles === null || styles === void 0 ? void 0 : styles.animation) === 'blinker' ? de(["", " 1s ease-in-out infinite forwards"], blinker) : '';
}, function (_ref3) {
  ...
  return coordinates && de(["display:block;left:", "%;top:", "%;"], coordinates.x, coordinates.y);
});
var StyledIcon$5 = Ve(Icon).withConfig({
...
var StyledMarker = Ve.div.withConfig({
...
var ImageLocation = function ImageLocation(_ref) {
  ...
  return __jsx$1A(StyledImageLocation, {
    show: show
  }, (item === null || item === void 0 ? void 0 : item.filename) && __jsx$1A(ImageWrapper, {
    coordinates: coordinates,
...
var StyledImageLocation = Ve.div.withConfig({
...
var ImageWrapper = function ImageWrapper(_ref) {
  ...
  return __jsx$1B(StyledImageWrapper, null, __jsx$1B(Image$1, {
    ref: imageRef,
    onClick: handleImageClick,
    alt: item.name,
    fluid: true,
    src: item.filename
  }), (MarkerCoordinates === null || MarkerCoordinates === void 0 ? void 0 : MarkerCoordinates.x) && __jsx$1B(ImageMarker, {
    coordinates: MarkerCoordinates,
    key: item.id,
    styles: markerStyles
  }));
};
var StyledImageWrapper = Ve.div.withConfig({
...
var ImageLocationFormElement = function ImageLocationFormElement(_ref) {
  ...
  return __jsx$1C(ControllerWrapper, {
    className: "".concat(errors && errors[elementName] && 'hasError')
  }, __jsx$1C(Controller$1, _extends({
    as: ImageLocation,
    control: control,
...
var imageAllert = Ge(["from{filter:invert(0);}to{filter:invert(1);}"]);
var ControllerWrapper = Ve.div.withConfig({
...
var DynamicLocationHOC = function DynamicLocationHOC(Component) {
  return function (props) {
    ...
    var containerElement = props.containerElement || __jsx$1D("div", {
      style: {
    ...
    return __jsx$1D(Component, _extends({}, props, {
...
var DynamicLocation = DynamicLocationHOC(withScriptjs(withGoogleMap(function (props) {
  return props.defaultCenter.lat && props.defaultCenter.lng ? __jsx$1D(GoogleMap, props) : null;
})));
...
var Brand = function Brand(_ref) {
  ...
  var ImageInDiv = function ImageInDiv() {
    return __jsx$1F(Link, {
      border: false,
      to: "/",
      passHref: true
    }, __jsx$1F(StyledDiv, null, __jsx$1F(Image$1, {
      alt: "Logo",
      draggable: "false",
      src: brand,
      "data-cy": "navBrand"
  ...
  if (animational) {
    return __jsx$1F(ImageInDiv, null);
  } else {
    return __jsx$1F(SingleImage, null);
  }
};
var StyledLink$4 = Ve(Link).withConfig({
  displayName: "brand__StyledLink",
  componentId: "senape-0"
})(["display:flex;"]);
var BorderAnimation = Ge(["0%{width:102px;height:40px;}100%{width:120px;height:40px;}"]);
var StyledDiv = Ve.div.withConfig({
...
var Contained = function Contained(_ref) {
  var content = _ref.content;
  return __jsx$1G(StyledContainer$4, null, content());
};
var StyledContainer$4 = Ve(Container).withConfig({
...
var Toggler = function Toggler(_ref) {
  ...
  var CustomTogglerIconOpen = function CustomTogglerIconOpen() {
    return __jsx$1H(StyledIcon$6, null, __jsx$1H("div", null), __jsx$1H("div", null));
  };

  var CustomToggler = function CustomToggler() {
    return __jsx$1H(StyledToggler, {
      "aria-expanded": visible ? 'false' : 'true',
      "aria-label": "Toggle navigation",
      onClick: handleMenuClick
    }, !visible ? __jsx$1H(CustomTogglerIconOpen, null) : __jsx$1H(CustomTogglerIconOpen, null));
  };
  ...
  var DefaultToggler = function DefaultToggler() {
    return __jsx$1H(StyledToggler, {
      ...
      size: "lg",
      prefix: "fas"
    }), __jsx$1H(StyledText$3, null, "Menu"));
  };

  if (custom) {
    return __jsx$1H(CustomToggler, null);
  } else {
    return __jsx$1H(DefaultToggler, null);
  }
};
var StyledIcon$6 = Ve.div.withConfig({
...
var StyledToggler = Ve.a.withConfig({
...
}, MEDIA_QUERY.desktop(_templateObject$8()));
var StyledText$3 = Ve.span.withConfig({
...
var Navbar = function Navbar(_ref) {
  ...
  var Content = function Content() {
    return __jsx$1I(React.Fragment, null, brand && __jsx$1I(Brand, {
  ...
  return __jsx$1I(React.Fragment, null, __jsx$1I(StyledNav, {
    style: style
  }, contained ? __jsx$1I(Contained, {
    content: Content
  }) : __jsx$1I(Content, null)), __jsx$1I(StyledOverlay, {
    hidden: !visible
  }));
};
var StyledNav = Ve.nav.withConfig({
...
}, MEDIA_QUERY.tablet(_templateObject$9(), function (_ref8) {
  var theme = _ref8.theme;
...
var StyledOverlay = Ve.div.withConfig({
...
var NavButton = function NavButton(_ref) {
  var closeMenu = _ref.closeMenu,
      ...
      type = _ref.type,
      visible = _ref.visible;
  return __jsx$1J(StyledLink$5, {
    border: false,
    passHref: true,
    to: to
  }, __jsx$1J(StyledButton$5, {
    id: id,
...
var StyledLink$5 = Ve(Link).withConfig({
  displayName: "button__StyledLink",
  componentId: "sc-16rzl3u-0"
})(["padding:0rem 0.75rem;"]);
var StyledButton$5 = Ve(Button).withConfig({
  displayName: "button__StyledButton",
  componentId: "sc-16rzl3u-1"
})(["", ""], MEDIA_QUERY_MAX.desktop(_templateObject$a(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.NAVBAR.colourActive;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var NavCollapse = Ve.div.withConfig({
...
var NavDropdown = function NavDropdown(_ref) {
  var closeMenu = _ref.closeMenu,
      ...
      prefix = _ref.prefix,
      type = _ref.type;
  return __jsx$1K(StyledContainer$5, null, __jsx$1K(StyledDropdown$1, {
    items: type.items,
    onChange: closeMenu,
    position: position
  }, icon && __jsx$1K(Icon, {
    ...
    icon: icon,
    prefix: prefix
  }), __jsx$1K(StyledContent$2, null, name)));
};
var StyledContainer$5 = Ve.div.withConfig({
...
var StyledDropdown$1 = Ve(Dropdown).withConfig({
  displayName: "dropdown__StyledDropdown",
  ...
  var theme = _ref3.theme;
  return theme.COLOUR.primary;
}, MEDIA_QUERY.desktop(_templateObject$c()));
var StyledContent$2 = Ve.span.withConfig({
...
var NavLink = function NavLink(_ref) {
  ...
  return __jsx$1M(Link, {
    ...
    passHref: true,
    to: to
  }, __jsx$1M(StyledLink$6, {
    id: id
  }, name));
};
var StyledLink$6 = Ve.span.withConfig({
  displayName: "link__StyledLink",
...
}, MEDIA_QUERY.desktop(_templateObject$d(), function (_ref4) {
  var theme = _ref4.theme;
...
var NavNotification = function NavNotification(_ref) {
  ...
  var link = function link() {
    return __jsx$1N(Link, {
      ...
      passHref: true,
      to: to
    }, __jsx$1N(Notification, null));
  };

  var Notification = function Notification() {
    return __jsx$1N(StyledNotifications, null, type && !!type.count && __jsx$1N(StyledCount, null, type.count), __jsx$1N(Icon, {
      icon: "bell",
      prefix: "fad"
    }));
  };
  ...
  if (to) {
    ...
    return __jsx$1N(Notification, null);
  }
};
var StyledNotifications = Ve.div.withConfig({
...
var StyledCount = Ve.div.withConfig({
  ...
  return __jsx$1O(NavCollapse, {
    ...
    return __jsx$1O(StyledList$1, {
      ...
      var active = _ref4.active,
          ...
          to = _ref4.to,
          type = _ref4.type;
      return __jsx$1O(StyledListItem, {
        brand: brand,
        key: id
      }, Component && __jsx$1O(Component, null), type && type.as === 'button' && NavButton({
        closeMenu: closeMenu,
        id: id,
        name: name,
        to: to,
...
var StyledList$1 = Ve.ul.withConfig({
...
}, MEDIA_QUERY.desktop(_templateObject$e(), function (_ref7) {
  var direction = _ref7.direction;
  return direction === 'left' ? 'flex-start' : 'flex-end';
}));
var StyledListItem = Ve.li.withConfig({
  ...
  return !props.brand && de(["&:first-child{margin-left:0;}"]);
...
var Notification = function Notification(_ref) {
  ...
  var body = __jsx$1P(React.Fragment, null, __jsx$1P(StyledNotificationBody, null, content), date && __jsx$1P(StyledDate, null, formatRelativeTime(date)));
  ...
  return __jsx$1P(StyledNotificationWrapper, null, __jsx$1P(Alert, {
    close: close,
    content: body,
    context: context,
    header: title,
...
var StyledNotificationWrapper = Ve.div.withConfig({
...
var StyledNotificationBody = Ve.div.withConfig({
  displayName: "notification__StyledNotificationBody",
  componentId: "sc-1h0hzg8-1"
})(["color:#fff;"]);
var StyledDate = Ve.time.withConfig({
...
var OffCanvasDiv = Ve.div.withConfig({
  ...
  return placement === 'top' && de(["height:", ";left:0;right:0;top:0;width:100vw;"], function (_ref5) {
    var height = _ref5.height;
    return height || '50%';
  });
}, function (_ref6) {
  var placement = _ref6.placement;
  return placement === 'right' && de(["height:100vh;right:0;top:0;width:90%;", ""], MEDIA_QUERY.desktop(_templateObject$f(), function (_ref7) {
    var width = _ref7.width;
    return width;
  }));
}, function (_ref8) {
  var placement = _ref8.placement;
  return placement === 'bottom' && de(["bottom:0;height:", ";left:0;right:0;width:100vw;"], function (_ref9) {
    var height = _ref9.height;
    return height || '50%';
  });
}, function (_ref10) {
  var placement = _ref10.placement;
  return placement === 'left' && de(["height:100vh;left:0;top:0;width:90%;", ""], MEDIA_QUERY.desktop(_templateObject2$6(), function (_ref11) {
 ...
 */
var OffCanvasContent = Ve.div.withConfig({
...
var OffCanvasHeader = function OffCanvasHeader(_ref) {
  ...
  return __jsx$1Q(StyledHeader$2, {
    context: context,
    variant: variant
  }, __jsx$1Q(Row, {
    align: "center"
    ...
    md: 4
  }, __jsx$1Q(StyledContainer$6, null, submit && __jsx$1Q(React.Fragment, null, __jsx$1Q(Button, {
    content: "Submit",
    context: "primary",
    form: "offCanvasForm",
    size: "sm",
  ...
  })))), __jsx$1Q(StyledBodyContainer, null, hasAvatar && __jsx$1Q(StyledAvatarContainer, {
    context: context
  }, __jsx$1Q(Avatar, {
    content: "Avatar",
    context: context,
    size: "lg"
  })), headerContent && __jsx$1Q(StyledText$4, {
...
var StyledHeader$2 = Ve.div.withConfig({
  displayName: "header__StyledHeader",
...
var StyledHeading$1 = Ve(Heading).withConfig({
...
var StyledText$4 = Ve(Text).withConfig({
 ...
 */
var OffCanvasOverlay = Ve.div.withConfig({
...
var OffCanvasComponent = function OffCanvasComponent(_ref) {
  ...
  return __jsx$1R(React.Fragment, null, overlay && __jsx$1R(OffCanvasOverlay, {
    duration: transitionDuration,
    onClick: handleOverlayClick,
    opacity: overlayOpacity,
    show: initialState
  }), __jsx$1R(OffCanvasDiv, {
    "data-cy": "offCanvas",
    duration: transitionDuration,
    height: height,
    placement: placement,
    ...
    title: headerText,
    variant: variant
  }), __jsx$1R(OffCanvasContent, null, children)));
};
...
var OffCanvas = function OffCanvas(props) {
  ...
  return mounted ? /*#__PURE__*/createPortal(__jsx$1S(OffCanvasComponent, props), container) : null;
};
OffCanvas.propTypes = {
  closeOnOverlayClick: propTypes.bool,
  container: propTypes.any,
...
var PageHeading = function PageHeading(_ref) {
  var center = _ref.center,
      ...
      strapline = _ref.strapline;
  return __jsx$1T(StyledPageHeader, {
    center: center,
    divider: divider
  }, __jsx$1T(StyledLeft, null, __jsx$1T(StyledHeading$2, {
    content: heading,
    context: context,
    pageHeading: true
  }), strapline && __jsx$1T("div", null, strapline)), (children || help) && __jsx$1T(StyledRight, null, children || helpContent), divider && __jsx$1T(StyledDivider$1, {
    size: "md"
  }));
};
var StyledPageHeader = Ve.header.withConfig({
...
var StyledDivider$1 = Ve(Divider).withConfig({
...
var PageLoading = function PageLoading(_ref) {
  ...
  return __jsx$1U(StyledLoading, _extends({
    "data-cy": dataCy
  }, props), indicator || children);
};
var StyledLoading = Ve.div.withConfig({
...
var LdsSpinnerWrapper = Ve.div.withConfig({
...
var LdsSpinner = function LdsSpinner(props) {
  return __jsx$1V(LdsSpinnerWrapper, _extends({}, props, {
    spinner: SPINNER
...
var StyledBar = Ve.div.withConfig({
...
var Pagination = function Pagination(_ref) {
  ...
  var renderContent = function renderContent() {
    return __jsx$1Z(React.Fragment, null, showPrevButton && __jsx$1Z(PaginationItem, {
      context: context,
      ...
      size: size
    }), showPrevDots && __jsx$1Z(PaginationItem, {
      onClick: function onClick() {
      ...
      return __jsx$1Z(PaginationItem, {
    ...
    }), showNextDots && __jsx$1Z(PaginationItem, {
      onClick: function onClick() {
      ...
      label: "...",
      size: size
    }), showNextButton && __jsx$1Z(PaginationItem, {
      context: context,
  ...
  return __jsx$1Z(StyledPagination, _extends({
    "aria-label": "Pagination"
  }, props), children || renderContent());
};
var StyledPagination = Ve.ul.withConfig({
...
var PaginationItem = function PaginationItem(_ref) {
  ...
  return __jsx$1_(StyledLi$1, null, __jsx$1_(StyledButton$6, _extends({
    active: active,
    context: context,
    onClick: onClick,
    disabled: disabled,
...
var StyledLi$1 = Ve.li.withConfig({
...
var StyledButton$6 = Ve(Button).withConfig({
...
var Rating = function Rating(_ref) {
  ...
  for (var i = 0; i < size; i++) {
    rating.push(__jsx$1$(StyledRating, {
      active: i + 1 <= value,
      className: className,
      context: context,
      key: i
...
var StyledRating = Ve.div.withConfig({
...
var Section = function Section(_ref) {
  var children = _ref.children,
      ...
      row = _ref.row,
      style = _ref.style;
  return __jsx$20(StyleSection, null, __jsx$20(Container, null, heading && __jsx$20(Heading, {
    className: "text-center",
    content: heading,
    context: "primary",
    tag: "h2"
  }), row ? __jsx$20(Row, null, children) : children));
};
var StyleSection = Ve.section.withConfig({
...
var Sidebar = function Sidebar(_ref) {
  ...
  var link = function link(icon, name, to) {
    ...
    return __jsx$21(Link, {
      to: to,
      passHref: true
    }, __jsx$21(StyledLink$7, null, icon && __jsx$21(Icon, {
      icon: icon ? iconArray ? icon[1] : icon : null,
      prefix: icon && iconArray && icon[0]
    }), name));
  };

  return __jsx$21(StyledAside, null, __jsx$21(StyledBrand$1, null, __jsx$21(Image$1, {
    alt: "Logo",
    src: brand
  })), __jsx$21(List, {
    group: true
    ...
    var Component = _ref2.Component,
        ...
        name = _ref2.name,
        to = _ref2.to;
    return __jsx$21(StyledLi$2, {
      key: index
    }, divider ? __jsx$21(StyledDivider$2, {
      size: "sm"
    }) : Component ? __jsx$21(Component, null) : to ? link(icon, name, to) : name);
  })));
};
var StyledAside = Ve.aside.withConfig({
...
var StyledLi$2 = Ve(ListItem).withConfig({
  ...
  var theme = _ref5.theme;
  return de(["background-color:", ";border-right:2px solid ", ";a{color:", ";}"], theme.SIDEBAR.linkHover, theme.SIDEBAR.highlight, theme.SIDEBAR.highlight);
});
var StyledLink$7 = Ve.span.withConfig({
...
var Stepper = function Stepper(_ref) {
  var className = _ref.className,
      items = _ref.items,
      summary = _ref.summary;
  return __jsx$22(StyledStepper, null, __jsx$22("ul", null, items.map(function (item) {
    return item.active !== false && __jsx$22(StepperItem, {
      item: item,
      key: item.id
    });
  })), summary && __jsx$22(StepperSummary, {
    summary: summary
  }));
};
var StyledStepper = Ve.div.withConfig({
...
var StepperItem = function StepperItem(_ref) {
  ...
  var renderActions = function renderActions(actions) {
    return actions.map(function (_ref3) {
      ...
      return active && __jsx$23("li", {
        key: id
      }, type === 'button' && __jsx$23(Button, _extends({
        onClick: handleClick,
        content: content,
        context: context,
        size: "xs"
  ...
  return __jsx$23(StyledStepperItem, null, __jsx$23(StyledIconContainer, {
    active: item.date
  }, item.date && __jsx$23(Icon, {
    "aria-hidden": "true",
    color: STEPPER.colourCheckmark,
    fixedWidth: false,
    icon: "check",
    prefix: "fas"
  })), __jsx$23(StyledLabel$4, {
    active: item.date
  }, item.label), (item.date || item.info) && __jsx$23(StyledInfo, null, item.date || item.info), item.content && item.content.length > 0 && __jsx$23(StyledContent$3, null, renderContent(item.content)), item.actions && item.actions.length > 0 && __jsx$23(StyledContent$3, null, renderActions(item.actions)), item.label !== 'Closed' && __jsx$23(Divider, {
    size: "sm"
  }));
};
var StyledStepperItem = Ve.li.withConfig({
...
var StyledIconContainer = Ve.div.withConfig({
...
var StyledContent$3 = Ve.ul.withConfig({
...
var StyledLabel$4 = Ve.span.withConfig({
...
var StyledInfo = Ve.span.withConfig({
...
var StepperSummary = function StepperSummary(_ref) {
  ...
  var renderItems = function renderItems(summary) {
    return summary.map(function (_ref2, i) {
      ...
      return __jsx$24("li", {
        key: i
      }, __jsx$24(StyledLabel$5, null, label, " "), __jsx$24(StyledValue, null, value));
    });
  };

  return __jsx$24(StyledStepperSummary, null, __jsx$24("ul", null, renderItems(summary)));
};
var StyledStepperSummary = Ve.div.withConfig({
...
var StyledLabel$5 = Ve.span.withConfig({
  displayName: "summary__StyledLabel",
  componentId: "sc-1nk57mg-1"
})(["font-size:0.85rem;"]);
var StyledValue = Ve.span.withConfig({
...
var TableData = function TableData(props) {
  return __jsx$25(StyledTd, props);
};
TableData.propTypes = {};
var StyledTd = Ve.td.withConfig({
...
var TableHead = function TableHead(props) {
  return __jsx$26(StyledTh, props);
};
TableHead.propTypes = {};
var StyledTh = Ve.th.withConfig({
...
var TableLoading = function TableLoading(_ref) {
  ...
  return __jsx$27(PageLoading, {
    backgroundColor: "#fff",
    indicator: __jsx$27(LdsSpinner, {
      color: "#000",
      size: 50
    }),
    opacity: 0.7,
...
var TableRow = function TableRow(props) {
  return __jsx$28(StyledTr, props);
};
TableRow.propTypes = {};
var StyledTr = Ve.tr.withConfig({
  ...
  var context = _ref2.context,
      ...
      theme = _ref2.theme;
  return !context && striped && de([":nth-child(odd){background-color:", ";}"], theme.COLOUR.light);
}, function (props) {
  return props.context && de(["", " color:white;"], BACKGROUND(props));
}, function (_ref3) {
  var hover = _ref3.hover;
  return hover && de([":hover{background-color:#eee;}"]);
});
...
var Table = function Table(_ref) {
  ...
  var renderColumns = function renderColumns() {
    return columns.map(function (_ref2, index) {
      ...
      return __jsx$29(TableHead, {
        align: align,
        key: index,
        onClick: handleSort,
        sortable: sortable
      }, text, sortable && hasSort && __jsx$29(Icon, {
  ...
  var renderRows = function renderRows() {
    ...
    return temp.map(function (row, index) {
      ...
      return __jsx$29(TableRow, {
        ...
        return __jsx$29(TableData, {
          align: align,
          key: index
        }, length > 0 && column.formatter ? column.formatter({
          row: row
        }, column.formatterData) : value && value.__html ? __jsx$29("span", {
  ...
  var renderTable = function renderTable() {
    return __jsx$29(StyledTable, {
      className: className
    }, caption && __jsx$29(StyledCaption$1, null, caption), __jsx$29("thead", null, __jsx$29("tr", null, columns && renderColumns())), __jsx$29("tbody", null, noData && !loading && !rows.length ? __jsx$29(TableRow, null, __jsx$29(TableData, {
      align: "center",
      colSpan: tableSpan
    }, "No data available")) : renderRows()));
  };

  return __jsx$29(React.Fragment, null, __jsx$29(StyledWrapper$2, {
    fullHeight: fullHeight,
    isLoading: loading
  }, __jsx$29(TableLoading, {
    colsLength: tableSpan,
    show: loading
  }), responsive ? __jsx$29(StyledResponsive, null, renderTable()) : renderTable()), pagination && rows.length > 0 && __jsx$29(Pagination, _extends({
...
var StyledWrapper$2 = Ve.div.withConfig({
...
var StyledCaption$1 = Ve.caption.withConfig({
...
var TableActions = function TableActions(_ref, data) {
  ...
  return __jsx$2a(React.Fragment, null, __jsx$2a(ButtonToolbar, {
    align: "flex-start",
    style: {
      zIndex: '100000000'
    }
    ...
    var iconArray = Array.isArray(icon);
    return __jsx$2a(Tooltip, {
      content: tooltip,
      key: index
    }, __jsx$2a(StyledButton$7, {
      forwardedAs: "a",
      disabled: disabled,
      context: context,
    ...
    }), row[numberOverlay] > 0 && __jsx$2a(StyledNumberOverlay, null, row[numberOverlay])));
  })));
};
var StyledButton$7 = Ve(Button).withConfig({
  displayName: "actions__StyledButton",
  componentId: "sc-1rwzgo8-0"
})(["font-size:16px;padding:0.3rem;position:relative;"]);
var StyledNumberOverlay = Ve.span.withConfig({
...
var TableLink = function TableLink(path, key, value, dynamicUrl) {
  return function (_ref) {
    ...
    var item = row[value];
    return useLink ? __jsx$2b(React.Fragment, null, item === '-' && '-', item !== '-' && __jsx$2b(StyleLink, {
      border: false,
      href: getPath(),
      onClick: handleClick
    }, item)) : item;
...
var StyleLink = Ve(StyledLink).withConfig({
...
var StyledTab = Ve.li.withConfig({
  ...
  var context = _ref2.context,
      theme = _ref2.theme;
  return de(["background-color:", ";border-left:1px solid ", ";border-bottom:1px solid ", ";border-top:1px solid ", ";"], theme.TABS.colour, theme.TABS.borderColour, context ? theme.COLOUR[context] : theme.TABS.borderColour, theme.TABS.borderColour);
}, function (_ref3) {
  var active = _ref3.active,
      context = _ref3.context,
      theme = _ref3.theme;
  return active && de(["background-color:", ";border-bottom:1px solid ", ";"], theme.TABS.activeColour, theme.COLOUR.primary);
}, function (_ref4) {
  var active = _ref4.active,
      theme = _ref4.theme;
  return !active && de(["cursor:pointer;"]);
}, function (_ref5) {
  var disabled = _ref5.disabled,
      theme = _ref5.theme;
  return disabled && de(["background-color:", ";cursor:no-drop;"], theme.TABS.disabledColour);
}, function (_ref6) {
  var active = _ref6.active,
      theme = _ref6.theme;
  return !active && de(["background-color:", ";"], theme.TABS.hoverColour);
}, function (_ref7) {
  var disabled = _ref7.disabled,
      theme = _ref7.theme;
  return disabled && de(["background-color:", ";"], theme.TABS.disabledColour);
}, function (_ref8) {
  var theme = _ref8.theme;
...
var Tabs = function Tabs(_ref) {
  ...
  return __jsx$2d(React.Fragment, null, __jsx$2d(StyledTabs, {
    className: className
  }, children.map(function (_ref2) {
    var props = _ref2.props;
    return __jsx$2d(Tab, _extends({
      activeTab: activeTab,
      key: props.label,
...
var StyledTabs = Ve.ol.withConfig({
...
var Design = function Design(_ref) {
  ...
  return __jsx$2e(React.Fragment, null, __jsx$2e("div", {
    className: "text-center",
    style: {
      background: '#000',
  ...
  }, !screenshot && __jsx$2e(Webcam, {
    ref: refProp,
    screenshotFormat: "image/jpeg",
    videoConstraints: videoConstraints
  }), screenshot && __jsx$2e("img", {
    alt: "user photo",
    src: screenshot,
    style: {
      borderRadius: '.5rem .5rem 0 0'
...
var Webcam = qe((_temp = _class = /*#__PURE__*/function (_Component) {
...
var BigCalendar = function BigCalendar() {
  ...
  return __jsx$2g("div", null, __jsx$2g(Calendar$1, {
    localizer: localizer,
...
var Calendar = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return __jsx$2i(Wrapper$3, null, props.hasLoading && loading && __jsx$2i(PageLoading, {
...
var Wrapper$3 = Ve.div.withConfig({
...
var ColorPicker = function ColorPicker(_ref) {
  ...
  switch (type) {
    case 'circle':
      return __jsx$2j(CirclePicker, _extends({
        onChangeComplete: onChangeComplete
      }, props));

    case 'sketch':
      return __jsx$2j(SketchPicker, _extends({
        onChangeComplete: onChangeComplete
      }, props));

    case 'github':
      return __jsx$2j(GithubPicker, _extends({
        onChangeComplete: onChangeComplete
      }, props));

    case 'twitter':
      return __jsx$2j(TwitterPicker, _extends({
        onChangeComplete: onChangeComplete
      }, props));
...
var EmailChange = function EmailChange(_ref) {
  ...
  return __jsx$2k(React.Fragment, null, __jsx$2k(PageHeading, {
    center: true,
...
var DraftJs = function DraftJs(_ref) {
  ...
  return __jsx$2l(React.Fragment, null, __jsx$2l("input", {
    type: "button",
    value: "B",
    "data-style": "BOLD",
    ...
    onMouseDown: toggleInlineStyle
  }), __jsx$2l(Controller$1, {
    name: name,
    control: control,
    render: function render(props) {
      return __jsx$2l(Editor, {
...
var StyledFooter$2 = Ve.div.withConfig({
  displayName: "footer__StyledFooter",
  ...
  return de(["background:", ";color:", ";"], FOOTER.background, FOOTER.colour);
}, function (_ref10) {
  var fixed = _ref10.fixed;
  return fixed && de(["bottom:0;position:fixed;left:0;width:100%;z-index:1;"]);
});
var StyledHeading$3 = Ve(Heading).withConfig({
...
var StyledList$2 = Ve(List).withConfig({
...
var StyledLink$8 = Ve.span.withConfig({
...
var StyledLink$9 = Ve.span.withConfig({
...
var MessageIcon = function MessageIcon(_ref) {
  ...
  return __jsx$2q(StyledIcon$8, {
    fixedWidth: false,
    icon: useIcon,
    prefix: "fad"
  });
};
var StyledIcon$8 = Ve(Icon).withConfig({
  displayName: "icon__StyledIcon",
...
var StyledImage$3 = Ve(Image$1).withConfig({
...
var MessageBase = function MessageBase(_ref) {
  ...
  return __jsx$2s(Column, {
    ...
    to: to
  }), __jsx$2s(StyledTime, null, time)), __jsx$2s(Column, {
    sm: 6
...
var StyledCard$2 = Ve(Card).withConfig({
...
var StyledContent$4 = Ve.div.withConfig({
...
var StyledTime = Ve.span.withConfig({
...
var StyledFrom = Ve(StyledTime).withConfig({
 ...
 */
var MessageBackground = Ve.div.withConfig({
...
var StyledContainer$7 = Ve.div.withConfig({
...
var MessagingSend = function MessagingSend(_ref) {
  ...
  }), __jsx$2w(StyledElements, null, __jsx$2w(StyledIcon$9, {
    fixedWidth: false,
    icon: "paperclip",
    onClick: openFileDialog,
    size: "2x"
  }), __jsx$2w(StyledIcon$9, {
    fixedWidth: false,
    icon: "smile",
    onClick: function onClick() {
      return setOpen(!open);
...
var StyledContainer$9 = Ve.div.withConfig({
...
var StyledPickerContainer = Ve(StyledContainer$9).withConfig({
...
var StyledElements = Ve.div.withConfig({
  displayName: "send__StyledElements",
  componentId: "sc-18pp565-4"
})(["align-items:center;display:flex;"]);
var StyledIcon$9 = Ve(Icon).withConfig({
...
var StyledDropDown = Ve(Dropdown).withConfig({
...
var StyledLink$a = Ve.div.withConfig({
...
var StyledPage = Ve.div.withConfig({
...
var FacebookPagePlugin = function FacebookPagePlugin(_ref) {
  var appId = _ref.appId,
      ...
      to = _ref.to,
      width = _ref.width;
  return __jsx$2C(React.Fragment, null, iFrame && __jsx$2C("iframe", {
...
var Article = function Article(_ref) {
  ...
  return __jsx$2F(StyledArticle, {
    itemProp: "blogPost",
    itemScope: true,
    itemType: "http://schema.org/BlogPosting",
    role: "article"
  }, __jsx$2F("header", null, __jsx$2F(StyledImage$4, {
    alt: article.heading,
    slant: true,
  ...
  }), config && __jsx$2F(BlogCategory, {
    config: config,
    to: article.category
  }), __jsx$2F(StyledHeading$4, {
    content: article.heading
  }), facebook && __jsx$2F(BlogDetails, {
    article: article,
    config: config,
    facebook: facebook
  })), __jsx$2F("span", {
...
var StyledArticle = Ve.article.withConfig({
...
var StyledImage$4 = Ve(Image$1).withConfig({
  displayName: "article__StyledImage",
  componentId: "ooxnmr-1"
})(["position:relative;"]);
var StyledHeading$4 = Ve(Heading).withConfig({
...
var BlogCard = function BlogCard(_ref) {
  ...
  })), __jsx$2G(StyledCardBody, {
    type: type
  }, type === 'normal' && __jsx$2G(BlogCategory, {
    config: config,
    to: category,
    type: type
  }), __jsx$2G(StyledContent$5, {
    type: type
  }, __jsx$2G(Link, {
    to: articleLink
  }, __jsx$2G(StyledHeading$5, {
    content: heading,
    tag: "h1",
    type: type
  })), type === 'normal' && __jsx$2G("p", {
    itemProp: "description"
  }, excerpt)), type === 'normal' && __jsx$2G(React.Fragment, null, article.tags && __jsx$2G(TagsContainer, null, __jsx$2G(BlogTags, {
    tags: article.tags
  })), __jsx$2G(Divider, {
    size: "sm"
  }), __jsx$2G(BlogCategory, {
    author: true,
    to: author,
    config: config,
    type: type
  }), __jsx$2G(StyledReadTime, null, article.readtime, "min read time.")), __jsx$2G(Link, {
    to: articleLink
  }, __jsx$2G(StyledButton$8, {
    content: "Read more",
...
var TagsContainer = Ve.div.withConfig({
  displayName: "card__TagsContainer",
  componentId: "jk3gp-0"
})(["height:1.75rem;margin-top:0.25rem;overflow:hidden;"]);
var StyledButton$8 = Ve(Button).withConfig({
  displayName: "card__StyledButton",
  componentId: "jk3gp-1"
})(["bottom:1.25rem;position:absolute;right:1rem;z-index:2;", ""], function (_ref2) {
  var position = _ref2.position;
  return position === 'hero' && de(["bottom:1.25rem;"]);
});
var StyledCardBody = Ve(CardBody).withConfig({
  displayName: "card__StyledCardBody",
  componentId: "jk3gp-2"
})(["min-height:303px;position:relative;z-index:0;", ""], function (_ref3) {
  var COLOUR = _ref3.theme.COLOUR,
      type = _ref3.type;
  return type === 'hero' && de(["background-color:", ";min-height:80px;&:after{background:", ";content:'';display:block;height:120px;left:0;position:absolute;right:0;top:0;transform:skewy(6deg);transform-origin:100% 0;z-index:-1;}"], COLOUR.primary, COLOUR.primary);
});
var StyledContent$5 = Ve.div.withConfig({
  displayName: "card__StyledContent",
  componentId: "jk3gp-3"
})(["height:128px;margin-bottom:1rem;overflow:hidden;", ""], function (_ref4) {
  var type = _ref4.type;
  return type === 'hero' && de(["height:122px;margin-bottom:0;"]);
});
var StyledHeading$5 = Ve(Heading).withConfig({
  ...
  var type = _ref6.type;
  return type === 'hero' && de(["color:#fff;font-size:2rem;line-height:2rem;max-height:115px;"]);
});
var StyledReadTime = Ve.p.withConfig({
...
var BlogCategories = function BlogCategories(_ref) {
  ...
  return __jsx$2H("section", null, _find().map(function (articles, index) {
    ...
    }, __jsx$2H(StyledHeading$6, {
      content: articles[0].category,
      tag: "h2"
    })), __jsx$2H(Row, null, articles.map(function (article, index) {
      return __jsx$2H(Column, {
        key: index,
        md: 6
      }, __jsx$2H(BlogCard, {
        article: article,
...
var StyledHeading$6 = Ve(Heading).withConfig({
...
var BlogCategory = function BlogCategory(_ref) {
  var author = _ref.author,
      ...
      style = _ref.style,
      to = _ref.to;
  return __jsx$2I(StyledCategory, {
    className: className,
    style: style
  }, __jsx$2I(Link, {
    to: {
...
var StyledCategory = Ve.div.withConfig({
...
var BlogDetails = function BlogDetails(_ref) {
  var article = _ref.article,
      config = _ref.config,
      facebook = _ref.facebook;
  return __jsx$2J(StyledArticleDetails, null, __jsx$2J(Divider, {
    size: "sm"
  }), __jsx$2J(List, {
    inline: true,
    unstyled: true,
    ...
    context: "dark",
    icon: "stopwatch"
  }), __jsx$2J(BlogReadTime, {
    time: article.readtime
  }))), article.tags && __jsx$2J(BlogTags, {
    tags: article.tags
  }), __jsx$2J(Divider, {
    size: "sm"
  }), __jsx$2J(StyledShare, null, __jsx$2J(StyledShareText, null, "Share this article"), __jsx$2J(FacebookShareButton, {
...
var BlogHero = function BlogHero(_ref) {
  ...
  return __jsx$2K(Row, null, renderHero());
};
BlogHero.propTypes = {
  articles: propTypes.any.isRequired,
  config: propTypes.object.isRequired,
...
var BlogListing = function BlogListing(_ref) {
  ...
  return __jsx$2L(Row, null, _find().map(function (article, index) {
...
var BlogReadTime = function BlogReadTime(_ref) {
  var time = _ref.time;
  return __jsx$2M("span", null, "Read time: ", time, " min(s)");
};
...
var BlogList = function BlogList(_ref) {
  var author = _ref.author,
      config = _ref.config,
      list = _ref.list;
  return __jsx$2N(StyledDl, null, list.map(function (_ref2, index) {
    var badge = _ref2.badge,
        _ref2$category = _ref2.category,
        category = _ref2$category === void 0 ? '' : _ref2$category,
        name = _ref2.name,
        to = _ref2.to;
    return __jsx$2N(Fragment$1, {
      key: index
    }, __jsx$2N(StyledDt, null, __jsx$2N(Badge, {
      content: badge
    })), __jsx$2N(StyledDd, null, __jsx$2N(Link, {
      to: {
...
var StyledA$1 = Ve.span.withConfig({
...
var BlogSection = function BlogSection(_ref) {
  var children = _ref.children,
      heading = _ref.heading;
  return __jsx$2O(StyledSection, null, heading && __jsx$2O(React.Fragment, null, __jsx$2O(StyledHeading$7, {
    content: heading,
    context: "primary",
    noMargin: true,
    tag: "h3"
...
var StyledSection = Ve.dl.withConfig({
  displayName: "section__StyledSection",
  componentId: "sc-13a5bvc-0"
})(["margin-top:0;margin-bottom:1rem;"]);
var StyledHeading$7 = Ve(Heading).withConfig({
...
var BlogFindFood = function BlogFindFood(_ref) {
  ...
  return __jsx$2R(BlogSection, null, __jsx$2R(StyledContainer$a, {
    colour: colour
  }, __jsx$2R(StyledForm$2, {
    handleSubmit: handleSubmit(submit)
  }, __jsx$2R(FormLabel, {
    text: "Your favourite restaurants, delivered."
  }, __jsx$2R(InputGroup, null, __jsx$2R(FormField, {
    errors: errors,
    register: register,
    name: "postCode",
    placeholder: "Enter your postcode"
  }), __jsx$2R(InputGroupAddon, null, __jsx$2R(Button, {
    content: "Find food",
    style: {
      background: '#440063',
      borderColor: '#32004a'
    ...
    type: "submit"
  })), errors.postCode && __jsx$2R(FormError, {
    ...
    passHref: true,
    target: "_blank"
  }, __jsx$2R(StyledA$2, null, "Deliveroo ", __jsx$2R(Icon, {
    icon: "external-link"
  })))));
};
var StyledContainer$a = Ve.div.withConfig({
...
var BlogSidebar = function BlogSidebar(_ref) {
  var articles = _ref.articles,
      ...
      promo = _ref.promo,
      tags = _ref.tags;
  return __jsx$2V(StyledAside$1, null, findFood && __jsx$2V(BlogFindFood, null), media && __jsx$2V(BlogMedia, {
    media: media
  }), __jsx$2V(BlogSocial, {
    facebook: facebook
  }), promo && __jsx$2V(BlogPromo, {
    src: promo.src,
    to: promo.to
  }), __jsx$2V(BlogRecent, {
    articles: articles,
    config: config
  }), tags && __jsx$2V(BlogTagCloud, {
    articles: articles
  }), __jsx$2V(BlogArchive, {
    articles: articles,
    config: config
  }), __jsx$2V(BlogAuthor, {
    articles: articles,
...
var StyledAside$1 = Ve.aside.withConfig({
  displayName: "sidebar__StyledAside",
...
var BlogSocial = function BlogSocial(_ref) {
  ...
  return __jsx$2W(React.Fragment, null, facebook && __jsx$2W(BlogSection, {
    heading: "Facebook"
  }, __jsx$2W(FacebookPagePlugin, {
    appId: facebook.appId,
    to: facebook.appPath,
    width: 349
  })), instagram && __jsx$2W(BlogSection, {
    heading: "Instagram"
  }, __jsx$2W("iframe", {
...
var BlogTags = function BlogTags(_ref) {
  ...
  return __jsx$2Y("div", null, tagMap());
};
BlogTags.propTypes = {
