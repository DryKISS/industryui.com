import React, { useContext, useState, useEffect, useRef, memo, forwardRef, Children, cloneElement, Component, Fragment as Fragment$1, Suspense as Suspense$1, createContext } from 'react';
...
})(["", " direction:", ";display:block;line-height:1.25rem;", " ", ""], function (props) {
  return COMMON_INPUT_STYLES(props);
}, function (_ref2) {
  var dir = _ref2.dir;
  return dir;
...
})(["position:absolute;transition:all 0.5s ease;", ""], function (_ref2) {
  var gap = _ref2.gap,
...
})(["align-items:", ";display:flex;height:100%;position:absolute;top:0;z-index:1;cursor:pointer;", ""], function (_ref3) {
  var componentPosition = _ref3.componentPosition;
  return componentPosition === 'top' ? 'flex-start' : componentPosition === 'bottom' ? 'flex-end' : 'center';
}, function (_ref4) {
  var endNav = _ref4.endNav;
  return endNav === true && css(["right:0;"]);
});
var Wrapper$2 = styled.div.withConfig({
  displayName: "carousel__Wrapper",
  componentId: "sc-1656prh-2"
})(["overflow:hidden;height:", ";min-height:", ";margin:0;position:relative;width:", ";"], function (_ref5) {
...
var Article = function Article(_ref) {
  ...
  }), article.category && __jsx$2H(Breadcrumb, {
    category: article.category,
    page: article.title,
    path: article.category
  }), config && article.category && __jsx$2H(BlogCategory, {
    config: config,
    to: article.category
...
var BlogCard = function BlogCard(_ref) {
  ...
  return __jsx$2J("article", {
    ...
    type: type
  }, type === 'normal' && category && __jsx$2J(BlogCategory, {
    config: config,
    to: category,
    type: type
    ...
    size: "sm"
  }), author && __jsx$2J(BlogCategory, {
    author: true,
    to: author,
    config: config,
    type: type
  }), article.readtime && __jsx$2J(StyledReadTime, null, article.readtime, "min read time.")), __jsx$2J(Link, {
    to: articleLink
