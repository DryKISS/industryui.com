...
var EmailChange = function EmailChange(_ref) {
  ...
  return __jsx$2k(React.Fragment, null, __jsx$2k(PageHeading, {
    ...
    label: "Email"
  }, __jsx$2k(FormField, _extends({}, defaultOptions, {
    autoFocus: true,
    name: "email",
    ...
    type: "submit"
  }), __jsx$2k(Space, null), __jsx$2k(Text, null, "We will send you a re-validation email after this. Please also check your spam folder.")));
};
...
var MessageBase = function MessageBase(_ref) {
  ...
  return __jsx$2x(MessageWrapper, null, __jsx$2x(StyledCard$2, {
    ...
    icon: "check-circle"
  }))), __jsx$2x(TranslatorWrapper, {
    onClick: toggleTranslation
  }, showingTranslation ? 'Show Original' : 'Show Translation'), attachments && attachments.length > 0 && __jsx$2x(AttachmentsContainer, null, Array.from(attachments).map(function (item, index) {
...
var MessagingSearch = function MessagingSearch(_ref) {
  ...
  return __jsx$2K(StyledContainer$7, null, __jsx$2K(Form, {
    handleSubmit: handleSubmit(onSubmit)
  }, __jsx$2K(Row, null, __jsx$2K(Column, {
    md: 6
  }, __jsx$2K(StyledSearch, _extends({}, defaultOptions, {
    prependSearchIcon: true,
    placeholder: placeholder
  }))), __jsx$2K(Column, {
    md: 6
  }, __jsx$2K(StyledSelect$1, _extends({}, defaultOptions, {
...
var PaperPlane = function PaperPlane(props) {
  return __jsx$2L(StyledSvg, _extends({}, props, {
    "aria-hidden": "true",
    width: 25,
    focusable: "false",
    viewBox: "0 0 512 512"
...
var MessagingSend = function MessagingSend(_ref) {
  ...
  return __jsx$2M(React.Fragment, null, __jsx$2M(StyledContainer$8, {
    audience: audience
  }, __jsx$2M(StyledWrapper$3, null, audience && __jsx$2M(StyledDropDown, {
    items: audienceItems,
    onChange: function onChange(item) {
      return setAudience(item);
    },
    position: "top"
  }, audience.name), __jsx$2M(StyledElements, null, __jsx$2M(EmojiSelectWrapper, null, __jsx$2M(EmojiSuggestions, null), __jsx$2M(EmojiSelect, null)), __jsx$2M(StyledIcon$9, {
    fixedWidth: false,
    icon: "paperclip",
    onClick: openFileDialog,
    size: "lg"
  })), voiceMessage && __jsx$2M(AudioWrapper, {
    preview: true
  }, __jsx$2M(MessagingAudioPlayer, {
    src: URL.createObjectURL(voiceMessage)
  }), __jsx$2M(DeleteIconWrapper, {
    ...
    type: "file"
  }), __jsx$2M(StyledElements, null, isSendDisabled() ? __jsx$2M(VoiceRecorder, null) : __jsx$2M(Button, {
    context: "transparent",
    disabled: isSendDisabled(),
    noPadding: true,
    onClick: submit,
    size: "xs"
  }, __jsx$2M(PaperPlane, null))))));
};
...
var VoiceRecorder = function VoiceRecorder(props) {
  ...
  var showRecorder = function showRecorder(props) {
    if (!recorderLoaded) return __jsx$2O(Microphone, {
      isLoading: true
    });
    return __jsx$2O(React.Fragment, null, __jsx$2O(OverLay, {
      isRecording: isRecording
    }, __jsx$2O(Text, {
      content: "Recording... ",
      context: "blackText"
  ...
  return __jsx$2O("div", null, showRecorder());
};
...
var MessagingContainer = function MessagingContainer(_ref) {
  ...
  return __jsx$2P(DragAndDropable, {
    onFileDrop: onDrop,
    onHover: onHover,
    onLeave: onLeave
  }, __jsx$2P(MessagingSearch, {
    onFilter: onFilter,
    onSearch: onSearch
...
function Hashtag(props) {
  ...
  return __jsx$2Q(StyledHashtag, _extends({
    onClick: function onClick() {
...
var linkifyPlugin = createLinkifyPlugin({
  ...
  component: function component(props) {
    return __jsx$2S(LinkPluginComponent, props);
  }
...
var LinkPluginComponent = function LinkPluginComponent(props) {
  return __jsx$2U(StyledA$1, _extends({}, props, {
    onClick: function onClick() {}
  }));
};
...
var PasswordChange = function PasswordChange(_ref) {
  ...
  return __jsx$2V(React.Fragment, null, __jsx$2V(PageHeading, {
    center: true,
    heading: "Password Change",
    divider: false
  }), error && __jsx$2V(Alert, {
    content: error.message,
    context: "warning"
  }), __jsx$2V(Form, {
    handleSubmit: handleSubmit(submit)
    ...
    label: "Old password"
  }, __jsx$2V(FormField, _extends({}, defaultOptions, {
    name: "passwordOld",
...
var Pricing = function Pricing(_ref) {
  ...
  return __jsx$2W(Wrapper$9, {
    ref: WrapperRef
  }, __jsx$2W(ResizeDetector, {
    onResize: function onResize(_ref2) {
      var width = _ref2.width;
      return resetLayout();
    }
  }), __jsx$2W(PricesWrapper, null, __jsx$2W(React.Fragment, null, Layout.includes(LAYOUTS.DESKTOP) ? pricingInfo.map(function (item, index) {
    return __jsx$2W(PricingCard, {
      layout: Layout,
      onCardSelect: handlePlanSelect,
      data: item,
      key: index
    });
  }) : __jsx$2W(DropDownAndFeatues, null, __jsx$2W(PricingDropdown, {
    onPlanChange: handlePlanChange,
    pricingInfo: pricingInfo,
    selectedPlan: SelectedPlan
  }), __jsx$2W(FeaturesAndAdd, null, __jsx$2W(FeaturesWrapper, null, pricingInfo[SelectedPlan].checkList.map(function (item, index) {
    return __jsx$2W(ListItem$1, {
      key: index
    }, __jsx$2W(Icon, {
      color: "rgb(69, 186, 190)",
      icon: "check",
      prefix: "fas"
    }), __jsx$2W(StyledFeature, {
      content: item.title,
      context: "blackText",
      size: "sm"
    }));
  })), __jsx$2W(AddToCartWrapper, {
    fullWidth: Layout === LAYOUTS.MOBILE
  }, __jsx$2W(StyledButton$8, {
    block: true,
    context: "deepBlue",
    onClick: function onClick() {
    ...
    outline: true
  }, "Add To Cart")))))), __jsx$2W(PriceMatrix, {
    pricingInfo: pricingInfo,
    layout: Layout,
    selectedPlan: SelectedPlan
  }));
...
var PricingCard = function PricingCard(_ref) {
  ...
  var checkList = data.checkList,
      ...
      price = data.price;
  return __jsx$2X(Wrapper$a, {
    layout: layout,
    recommended: recommended
  }, __jsx$2X(Title, {
    recommended: recommended
  }, data.title), __jsx$2X(ChecklistWrapper, null, checkList.map(function (item, index) {
    return __jsx$2X(ListItem$2, {
      key: index
    }, __jsx$2X(Icon, {
      color: recommended ? 'rgb(255, 202, 16)' : 'rgb(69, 186, 190)',
      icon: "check",
      prefix: "fas"
    }), __jsx$2X(StyledText$6, {
      content: item.title,
      context: recommended ? 'white' : 'blackText',
      size: priceLayoutSizes(layout).featuresTextSize
    }));
  })), __jsx$2X(FlexSpacer, null), __jsx$2X(Fee, {
    align: "center",
    content: price,
    context: recommended ? 'white' : 'deepBlue',
    recommended: recommended,
    size: "xl"
  }), __jsx$2X(AddButtonWrapper, {
    onClick: function onClick() {
      return onCardSelect(data);
    }
  }, __jsx$2X(AddToCartText, {
    align: "center",
    content: "Add To Cart",
    context: recommended ? 'white' : 'deepBlue',
    size: "sm"
...
var PricingDropdown = function PricingDropdown(_ref) {
  ...
  return __jsx$2Y(Wrapper$b, {
    onClick: handleClickOnWrapper,
    onClickAway: handleClickAway
  }, __jsx$2Y(TitleWrapper, null, __jsx$2Y(StyledTitle$3, {
    content: selected.title,
    context: "blackText",
    size: "xl"
  })), __jsx$2Y(PriceAndDropIconWrapper, null, __jsx$2Y(StyledPrice, {
    content: selected.price,
    size: "lg",
    context: "deepBlue"
  }), __jsx$2Y(StyledDownIcon, {
    icon: "caret-down",
    prefix: "fas"
  })), __jsx$2Y(PlansWrapper, {
    open: IsOpen
  }, pricingInfo.map(function (item, index) {
    return __jsx$2Y(PriceElement, {
      key: index,
      isLast: index === pricingInfo.length - 1,
      onClick: function onClick() {
        return handlePlanClick(index);
      }
    }, __jsx$2Y(ElementTitleAndDescriptionsWrapper, null, __jsx$2Y(StyledElementTitle, {
      content: item.title,
      context: item.recommended ? 'deepBlue' : 'blackText',
      size: "sm"
    }), __jsx$2Y(StyledElementDescription, {
      content: item.description,
      context: item.recommended ? 'deepBlue' : 'blackText',
      size: "xs"
    })), __jsx$2Y(PriceAndDropIconWrapper, null, item.recommended && __jsx$2Y(StyledRecomendedText, {
      content: "Recommend by IUI",
      context: "gold40",
      size: "xs"
    }), __jsx$2Y(StyledPrice, {
      content: item.price,
      size: "lg",
      context: "deepBlue"
    })));
...
var PriceMatrix = function PriceMatrix(_ref) {
  ...
  return __jsx$2Z(PriceMatrixWrapper, null, __jsx$2Z(MatrixCol, {
    freeSize: true
  }, features.map(function (item, index) {
    return __jsx$2Z(FeatureNameColumn, {
      key: index,
      odd: index % 2 !== 0
    }, __jsx$2Z(Text, {
      content: item,
    ...
    return __jsx$2Z(MatrixCol, {
      ...
      return __jsx$2Z(FeatureCheckColumn, {
        odd: idx % 2 !== 0,
        key: idx
      }, featureExist(item, feature) ? __jsx$2Z(StyledIcon$a, {
        prefix: "fas",
        icon: "check",
...
var Register = function Register(_ref) {
  ...
  var renderBirthday = function renderBirthday() {
    return __jsx$2_(React.Fragment, null, __jsx$2_(DatePickerInput, {
      day: dayBirthday,
      id: "Birthday",
      label: "Birthdate",
      month: monthBirthday,
      year: yearBirthday
    }), __jsx$2_(Text, null, "To sign up, you must be 18 or older. Other users will not see this."));
  };
  ...
  return __jsx$2_(Form, {
    handleSubmit: handleSubmit(onSubmit)
  }, error && __jsx$2_(Alert, {
    content: error.message,
    context: "warning"
  }), __jsx$2_(FormLabel, {
    label: "First name"
  }, __jsx$2_(FormField, _extends({}, defaultOptions, {
    autoFocus: true,
    name: "nameFirst",
    ...
    placeholder: showPlaceholder ? 'Password' : '',
    type: "password"
  }))), birthday && renderBirthday(), passwordError && __jsx$2_(Alert, {
    content: passwordError.message,
    context: "warning"
  }), __jsx$2_(CheckboxField, _extends({}, defaultOptions, {
    data: CHECKBOX_TERMS,
    stacked: true
  })), __jsx$2_(Button, {
    align: "right",
    ...
    size: "lg",
    type: "submit"
  }), __jsx$2_(StyledLink$a, null, "Already have an account? ", __jsx$2_(Link, {
    to: pathLogin
  }, "Log in")));
};
...
var ArticleLayout = function ArticleLayout(_ref) {
  ...
  // }
  return __jsx$2$(Container, null, __jsx$2$(Row, null, __jsx$2$(Column, {
    md: 12
  }, __jsx$2$(Article, {
    article: frontMatter
  }))));
...
var Bootstrap = function Bootstrap(_ref) {
  ...
  return __jsx$30(React.Fragment, null, __jsx$30(Navigation, null), children, footer && __jsx$30(Footer, {
    columns: footer,
    fixed: fixed
  }), copyright && __jsx$30(Copyright, {
    brand: brand,
    icon: icon,
    links: copyright
  }));
...
var Dashboard = function Dashboard(_ref) {
  ...
  return __jsx$31(React.Fragment, null, __jsx$31(Suspense$1, {
    fallback: __jsx$31(PageLoading, {
      indicator: __jsx$31(LdsSpinner, null)
    })
  }, __jsx$31(React.Fragment, null, __jsx$31(Page, {
    children: View || children,
    fluid: true,
    meta: mergedMeta,
    pageHeading: pageHeading
  }), message && __jsx$31(Alert, {
    content: message,
    context: context
  }))));
};
...
var Page = function Page(_ref) {
  ...
  return __jsx$32(StyledPage, null, meta && __jsx$32(MetaHead, {
    canonical: Canonical,
    brand: Brand.name,
    meta: meta
  }), __jsx$32(Container, {
    fluid: fluid
  }, pageHeading && __jsx$32(PageHeading, pageHeading), children));
};
...
var SidebarLayout = function SidebarLayout(_ref) {
  ...
  return __jsx$33(Container, {
    fluid: true
  }, __jsx$33(Row, null, __jsx$33(Column, {
    md: 2
  }, __jsx$33(Sidebar, null)), __jsx$33(Column, {
    md: 10,
    style: {
      padding: 0
    }
...
var FacebookPagePlugin = function FacebookPagePlugin(_ref) {
  var appId = _ref.appId,
      ...
      to = _ref.to,
      width = _ref.width;
  return __jsx$34(React.Fragment, null, iFrame && __jsx$34("iframe", {
...
var Article = function Article(_ref) {
  ...
  return __jsx$37(StyledArticle, {
    ...
    role: "article",
    style: style
  }, __jsx$37("header", null, __jsx$37(StyledImage$4, {
    alt: article.heading,
    src: article.image || "/static/blog/".concat(article.slug, "/hero.jpg")
  }), article.category && __jsx$37(Breadcrumb, {
    category: article.category,
    page: article.title,
    path: article.category
  }), config && article.category && __jsx$37(BlogCategory, {
    config: config,
    to: article.category
  }), __jsx$37(StyledHeading$4, {
    content: article.heading
  }), facebook && __jsx$37(BlogDetails, {
    article: article,
    config: config,
    facebook: facebook
  })), __jsx$37("span", {
...
var Error404 = function Error404() {
  ...
  return __jsx$38(Page, {
    heading: "404 ERROR PAGE \u2013 NOT FOUND",
    meta: meta
  }, __jsx$38("p", null, "The page you were looking for no longer exists or never did. Please use the links at the top of your screen to get back in the game, or click here to go home and start again."));
};
...
var BlogCard = function BlogCard(_ref) {
  ...
  })), __jsx$39(StyledCardBody, {
    type: type
  }, type === 'normal' && category && __jsx$39(BlogCategory, {
    config: config,
    to: category,
    type: type
  }), __jsx$39(StyledContent$5, {
    type: type
  }, __jsx$39(Link, {
    to: articleLink
  }, __jsx$39(StyledHeading$5, {
    content: heading,
    tag: "h1",
    noWrap: true,
    type: type
  })), type === 'normal' && __jsx$39("p", {
    itemProp: "description"
  }, excerpt)), type === 'normal' && __jsx$39(React.Fragment, null, article.tags && __jsx$39(TagsContainer, null, __jsx$39(BlogTags, {
    tags: article.tags
  })), __jsx$39(Divider, {
    size: "sm"
  }), author && __jsx$39(BlogCategory, {
    author: true,
    to: author,
    config: config,
    type: type
  }), article.readtime && __jsx$39(StyledReadTime, null, article.readtime, "min read time.")), __jsx$39(Link, {
    to: articleLink
  }, __jsx$39(StyledButton$9, {
    content: "Read more",
...
var BlogCategories = function BlogCategories(_ref) {
  ...
  return __jsx$3a("section", null, _find().map(function (articles, index) {
    return __jsx$3a(Fragment$1, {
      key: index
    }, __jsx$3a(Link, {
      to: {
    ...
    }, __jsx$3a(StyledHeading$6, {
      content: articles[0].category,
      tag: "h2"
    })), __jsx$3a(Row, null, articles.map(function (article, index) {
...
var BlogCategory = function BlogCategory(_ref) {
  var author = _ref.author,
      ...
      style = _ref.style,
      to = _ref.to;
  return __jsx$3b(StyledCategory, {
    className: className,
    style: style
  }, __jsx$3b(Link, {
    to: {
...
var BlogDetails = function BlogDetails(_ref) {
  var article = _ref.article,
      config = _ref.config,
      facebook = _ref.facebook;
  return __jsx$3c(StyledArticleDetails, null, __jsx$3c(Divider, {
    size: "sm"
  }), __jsx$3c(List, {
    inline: true,
    unstyled: true,
    ...
    context: "dark",
    icon: "stopwatch"
  }), __jsx$3c(BlogReadTime, {
    time: article.readtime
  }))), article.tags && __jsx$3c(BlogTags, {
    tags: article.tags
  }), __jsx$3c(Divider, {
    size: "sm"
  }), __jsx$3c(StyledShare, null, __jsx$3c(StyledShareText, null, "Share this article"), __jsx$3c(FacebookShareButton, {
...
var BlogHero = function BlogHero(_ref) {
  ...
  return __jsx$3d(Row, null, renderHero());
};
BlogHero.propTypes = {
  articles: propTypes.any.isRequired,
  config: propTypes.object.isRequired,
...
var BlogListing = function BlogListing(_ref) {
  ...
  return __jsx$3e(Row, null, _find().map(function (article, index) {
...
var BlogReadTime = function BlogReadTime(_ref) {
  var time = _ref.time;
  return __jsx$3f("span", null, "Read time: ", time, " min(s)");
};
...
var BlogList = function BlogList(_ref) {
  var author = _ref.author,
      config = _ref.config,
      list = _ref.list;
  return __jsx$3g(StyledDl, null, list.map(function (_ref2, index) {
    var badge = _ref2.badge,
        _ref2$category = _ref2.category,
        category = _ref2$category === void 0 ? '' : _ref2$category,
        name = _ref2.name,
        to = _ref2.to;
    return __jsx$3g(Fragment$1, {
      key: index
    }, __jsx$3g(StyledDt, null, __jsx$3g(Badge, {
      content: badge
    })), __jsx$3g(StyledDd, null, __jsx$3g(Link, {
      to: {
...
var BlogSection = function BlogSection(_ref) {
  var children = _ref.children,
      heading = _ref.heading;
  return __jsx$3h(StyledSection, null, heading && __jsx$3h(React.Fragment, null, __jsx$3h(StyledHeading$7, {
    content: heading,
    context: "primary",
    noMargin: true,
    tag: "h3"
...
var BlogFindFood = function BlogFindFood(_ref) {
  ...
  return __jsx$3k(BlogSection, null, __jsx$3k(StyledContainer$a, {
    colour: colour
  }, __jsx$3k(StyledForm$1, {
    handleSubmit: handleSubmit(submit)
  }, __jsx$3k(FormLabel, {
    text: "Your favourite restaurants, delivered."
  }, __jsx$3k(InputGroup, null, __jsx$3k(FormField, {
    errors: errors,
    register: register,
    name: "postCode",
    placeholder: "Enter your postcode"
  }), __jsx$3k(InputGroupAddon, null, __jsx$3k(Button, {
    content: "Find food",
    style: {
      background: '#440063',
      borderColor: '#32004a'
    ...
    type: "submit"
  })), errors.postCode && __jsx$3k(FormError, {
    ...
    passHref: true,
    target: "_blank"
  }, __jsx$3k(StyledA$3, null, "Deliveroo ", __jsx$3k(Icon, {
    icon: "external-link"
  })))));
};
...
var BlogSidebar = function BlogSidebar(_ref) {
  var articles = _ref.articles,
      ...
      promo = _ref.promo,
      tags = _ref.tags;
  return __jsx$3o(StyledAside$1, null, findFood && __jsx$3o(BlogFindFood, null), media && __jsx$3o(BlogMedia, {
    media: media
  }), __jsx$3o(BlogSocial, {
    facebook: facebook
  }), promo && __jsx$3o(BlogPromo, {
    src: promo.src,
    to: promo.to
  }), __jsx$3o(BlogRecent, {
    articles: articles,
    config: config
  }), tags && __jsx$3o(BlogTagCloud, {
    articles: articles
  }), __jsx$3o(BlogArchive, {
    articles: articles,
    config: config
  }), __jsx$3o(BlogAuthor, {
    articles: articles,
...
var BlogSocial = function BlogSocial(_ref) {
  ...
  return __jsx$3p(React.Fragment, null, facebook && __jsx$3p(BlogSection, {
    heading: "Facebook"
  }, __jsx$3p(FacebookPagePlugin, {
    appId: facebook.appId,
    to: facebook.appPath,
    width: 349
  })), instagram && __jsx$3p(BlogSection, {
    heading: "Instagram"
  }, __jsx$3p("iframe", {
...
var BlogTags = function BlogTags(_ref) {
  ...
  return __jsx$3r("div", null, tagMap());
};
BlogTags.propTypes = {
...
var MyApp = /*#__PURE__*/function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function elements() {
      ...
      return __jsx$3s(React.Fragment, null, __jsx$3s(ThemeStyle, null), user && __jsx$3s(UserProvider, null, __jsx$3s(AuthorizationProvider, null, __jsx$3s(InternationalisationProvider, null, __jsx$3s(NotificationsProvider, null, offCanvas ? __jsx$3s(OffCanvasProvider, null, this.layout()) : this.layout())))), !user && this.layout());
    }
  }, {
    key: "data",
    value: function data() {
      ...
      return __jsx$3s(React.Fragment, null, __jsx$3s(ConfigProvider, {
        config: config
      }, apolloClient ? __jsx$3s(ApolloProvider, {
        client: apolloClient
    ...
    value: function layout() {
      ...
      return __jsx$3s(Layout, null, pageProgressBar && __jsx$3s(PageProgressBar, {
        router: router
      }), __jsx$3s(Component, pageProps));
    }
  }, {
    key: "render",
    value: function render() {
      return __jsx$3s(ThemeProvider, {
