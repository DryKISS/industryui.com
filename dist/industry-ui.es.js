...
var IUIMessagingAudioPlayer = function IUIMessagingAudioPlayer(_ref) {
  var src = _ref.src,
  ...
  return __jsx$2p(Wrapper$4, null, showPlayer());
};
...
var IUIVoiceRecorder = function IUIVoiceRecorder(props) {
  ...
  useEffect(function () {
    mpegEncoder = dynamic(function () {
      return import('audio-recorder-polyfill/mpeg-encoder');
    }, {
      ssr: false,
      loadableGenerated: {
        webpack: function webpack() {
          return [require.resolveWeak('audio-recorder-polyfill/mpeg-encoder')];
        },
        modules: ['audio-recorder-polyfill/mpeg-encoder']
      }
    });
    AudioRecorder = dynamic(function () {
      return import('audio-recorder-polyfill').then(function (mod) {
      ...
      loadableGenerated: {
        webpack: function webpack() {
          return [require.resolveWeak('audio-recorder-polyfill')];
        },
        modules: ['audio-recorder-polyfill']
      }
    });
  ...
  return __jsx$2M("div", null, showRecorder());
};
...
var Wrapper$a = styled(ClickAwayListener).withConfig({
